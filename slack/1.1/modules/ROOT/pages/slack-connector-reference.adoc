= Slack Connector 1.1 Reference - Mule 4
...
NOTE: This method is deprecated and will stop functioning on March 11, 2025. For more information, refer to the https://api.slack.com/methods/files.upload[Slack API documentation].
