= Using Anypoint Studio to Configure Slack Connector 2.0 - Mule 4
...
After you configure a global element for Slack Connector, configure the other required fields for the connector. The required fields vary depending on which connector operation you use.
