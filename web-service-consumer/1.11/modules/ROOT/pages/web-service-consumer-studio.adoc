= Using Anypoint Studio to Configure Web Service Consumer 1.11 - Mule 4
...
* https://help.salesforce.com/s/articleView?id=001114743&type=1[How to set SOAP headers in Web Service Consumer in Mule 4]
