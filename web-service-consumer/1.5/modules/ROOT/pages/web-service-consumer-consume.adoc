...
For more information on setting SOAP headers, see https://help.salesforce.com/s/articleView?id=001114743&type=1[How to set SOAP headers in Web Service Consumer in Mule 4].
