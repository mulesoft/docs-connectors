...
This document assumes that you are familiar with Anypoint Studio; review the chapter on xref:6.x@studio::index.adoc[Anypoint Studio Essentials] to learn more about developing with Mule's graphical user interface. This document also assumes you are familiar with xref:3.8@mule-runtime::dataweave.adoc[DataWeave], xref:3.8@mule-runtime::global-elements.adoc[Global Elements], and xref:6.x@studio::datasense.adoc[DataSense].
...
For more information on best design-time practices with DataSense and DataWeave, consult the xref:6.x@studio::datasense.adoc[DataSense documentation].
