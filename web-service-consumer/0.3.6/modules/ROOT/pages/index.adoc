...
For more information on best design-time practices with DataSense and DataMapper, consult the xref:0.3.6@mule-runtime::datasense.adoc[DataSense documentation].
