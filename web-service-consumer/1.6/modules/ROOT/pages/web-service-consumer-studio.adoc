...
The following example shows how to configure the Global Element to gets a list of flights by airline:
...
. Select the name of the connector in the Studio canvas.
. In the *Body* field of the *General* tab, add the DataWeave expression.
