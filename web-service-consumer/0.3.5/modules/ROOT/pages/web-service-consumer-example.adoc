...
* Learn more about about the xref:web-service-consumer.adoc[Web Service Consumer].
* Learn more about the xref:http-response-builder.adoc[HTTP Response Builder].
