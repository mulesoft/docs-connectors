= Microsoft Dynamics CRM Connector 3.2 
...
image::ms-dynamics-crm-demo-01.png["Studio app flows for all accounts, query account by name, and create account"]
image::ms-dynamics-crm-demo-02.png["Studio app flows for deleting account, retrieving account, all contacts, and getting associated contacts"]
image::ms-dynamics-crm-demo-03.png["Studio app flows for associate contact to account, disassociate contact to account, get opportunities, and create opportunity"]
image::ms-dynamics-crm-demo-04.png["Studio app flows for execute and activate account, execute and deactivate account, create multiple contacts, and delete multiple contacts"]
image::ms-dynamics-crm-demo-05.png["Studio app flows for updating multiple contacts and retrieving and updating contacts"]
