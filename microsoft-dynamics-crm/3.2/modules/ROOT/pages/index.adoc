...
Any created or expired date in the web service header created by the Microsoft CRM instance must respect the constraints specified in the BasicSecurity Profile validation for Web Services, `http://www.ws-i.org/Profiles/BasicSecurityProfile-1.0.html`, as summarized below:
