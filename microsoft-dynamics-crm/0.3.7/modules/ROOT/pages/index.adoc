...
|Property |Usage
|*Query* a|
DataSense Query Language: The DSQL to run. The query is translated by the connector to a Fetch XML. For more information, see xref:5.x@studio::datasense-query-language.adoc[DataSense Query Language].
