...
:page-aliases: 3.8@mule-runtime::microsoft-dynamics-crm-connector.adoc
...
The Anypoint Platform Gateway Service runs as a Windows service. Install using the instructions in the xref:3.8@mule-runtime::windows-gateway-services-guide.adoc[Windows Gateway Service guide] on a machine that is joined to the same domain as the Dynamics CRM instance that you want to authenticate against.
...
. Relationships: This particular retriever that gets relationships information, and caches it, is just used for the following operations: Associate and Disassociate.
...
|Property |Usage
|*Query* a|
DataSense Query Language: The DSQL to run. The query is translated by the connector to a Fetch XML. For more information, see xref:6.x@studio::datasense-query-language.adoc[DataSense Query Language].
...
* xref:3.8@mule-runtime::mule-expression-language-mel.adoc[Mule Expression Language]
* xref:3.8@mule-runtime::endpoint-configuration-reference.adoc[Configuring Endpoints]
* xref:3.8@mule-runtime::transformers.adoc[Transformers]
* xref:3.8@mule-runtime::flow-reference-component-reference.adoc[Flow Reference Component Reference]
