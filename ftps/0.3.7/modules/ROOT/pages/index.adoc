...
In this example, the placeholder values refer to values saved in a `.properties` file, which exists by default in the `src/main/resources` folder of your project. See xref:3.7@mule-runtime::configuring-properties.adoc[Configuring Properties].
...
See xref:3.7@mule-runtime::deploying-to-multiple-environments.adoc[Deploying to Multiple Environments].
