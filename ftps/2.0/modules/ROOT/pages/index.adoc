...
* Changed the method for enabling SSL Session resumption. For more information about setting up the feature, see xref:ftps-studio-configuration.adoc[FTPS Studio Configuration] section.
