...
When you use the FTPS connector, connection issues can occur during session reuse, such as a `SocketTimeoutException` during data connection. To resolve this, include the following JVM system property in your runtime configuration:
