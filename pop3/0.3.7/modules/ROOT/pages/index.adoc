...
:page-aliases: 3.7@mule-runtime::pop3-connector.adoc
...
* See the xref:3.7@mule-runtime::pop3-transport-reference.adoc[POP3 Transport Reference] for details on setting the properties for a POP3 endpoint using an XML editor.
