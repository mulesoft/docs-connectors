= Salesforce Marketing Cloud REST Connector 1.0 - Mule 4
...
Salesforce Marketing Cloud REST connections use the OAuth Client Credentials authentication type, which permits a client to use its own credentials.
