...
[NOTE]
Starting with Java 17, for your script to execute JavaScript code, it must use GraalVm engine. Therefore, you must add in your `pom.xml` file the following library dependencies: +
[source,xml,linenums]
----
<sharedLibrary>
