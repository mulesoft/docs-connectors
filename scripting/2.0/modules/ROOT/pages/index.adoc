...
* New user, read:
** xref:scripting-module-studio.adoc[Use Studio to Configure the Connector] to create your Mule app
...
For a major or minor release, see xref:scripting-module-upgrade-migrate.adoc[Upgrade and Migrate].
