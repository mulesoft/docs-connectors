...
For example, see xref:scripting-module::scripting-module-examples.adoc[Examples] use cases.
...
* xref:scripting-module::scripting-module-studio.adoc[Studio Configuration]
* xref:scripting-module::scripting-module-examples.adoc[Examples], which provides one or more use cases for the connector
...
* xref:scripting-module::scripting-module-xml-maven.adoc[XML and Maven Support] +
* xref:scripting-module::scripting-module-examples.adoc[Examples] topics

For a major or minor release, see
xref:scripting-module::scripting-module-upgrade-migrate.adoc[Upgrade and Migrate].


== Next Step

After you complete the prerequisites and experiment with templates and examples, you are ready to create an app and configure the connector using xref:scripting-module::scripting-module-studio.adoc[Anypoint Studio].
