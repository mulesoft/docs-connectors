...
* SCRIPTING:COMPILATION
 ...
 The content of the property code had problems in the compilation stage. Check that your code is valid and export the classes used with the Scripting module. Refer to xref:mule-runtime::how-to-export-resources.adoc[How to Export Resources].
