...
* SCRIPTING:COMPILATION - The content of the property code had problems in the compilation stage. Be sure that your code is right and remember that you must export the classes used with the Scripting Module. See xref:mule-runtime::how-to-export-resources.adoc[how to export resources].
* SCRIPTING:UNKNOWN_ENGINE - The engine name provided in the engine parameter is unknown. 
* SCRIPTING:EXECUTION - An exception was thrown during execution stage. You can set the log level in DEBUG and find more information in the log file.
