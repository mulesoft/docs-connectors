...
[IMPORTANT]
This connector only supports Oracle EBS version 12.2.x. If you require integration with version 12.1.x, refer to https://www.anypoint.mulesoft.com/exchange/?search=oracle%20ebs[Oracle E-Business Suite (EBS) connector].
