= Oracle E-Business Suite 12.2 Connector 2.3 
...
+
image::oracle-ebs122-deploy-plsql-1.png["Deploy PL/SQL Search page"]
+
. Click *Go* to execute the search.
. Click the *Adjustments API* link to see the interface details.
+
image::oracle-ebs122-deploy-plsql-2.png["Deploy PL/SQL Adjustment API page"]
+
...
+
image::oracle-ebs122-config-studio11.png["Global elements properties window"]
+
[%header,cols="30s,70a"]
|===
|Field|Description
...
image::oracle-ebs122-flow.png["Studio flow with Listener, Transform Message, and Invoke PL/SQL REST Service"]
...
+
image::oracle-ebs122-operation1.png["Oracle Create Location operation properties window"]
+
...
* https://docs.oracle.com/cd/E26401_01/index.htm[Oracle E-Business Suite Documentation Web Library]
