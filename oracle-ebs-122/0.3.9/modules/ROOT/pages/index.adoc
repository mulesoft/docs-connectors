...
[IMPORTANT]
This connector *only* supports Oracle EBS version *12.2.x*. If you require integration with version *12.1.x*, refer to https://anypoint.mulesoft.com/exchange/?search=Oracle%20E-Business%20Suite%20Connector&type=connector[Oracle E-Business Suite (EBS) connector].
