...
:page-aliases: 3.8@mule-runtime::file-connector.adoc
...
*Reference*: xref:3.8@mule-runtime::file-transport-reference.adoc[File Transport Reference]
...
|*Response Timeout* |Specify how long in milliseconds the endpoint waits for a response from the connected file system.
...
* See the xref:3.8@mule-runtime::file-transport-reference.adoc[File Transport Reference] for details on setting the properties for a File endpoint using an XML editor.
* Review xref:3.8@mule-runtime::dataweave-flat-file-schemas.adoc[DataWeave FlatFile Schemas] doc for information on how to define the file format.
