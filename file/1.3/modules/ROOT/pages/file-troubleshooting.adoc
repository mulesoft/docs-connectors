...
This error occurs if the *createParentDirectories* property is set to false and the target path doesn’t exist nor does its parent.

* FILE:FILE_ALREADY_EXISTS

This error occurs when the target file already exists and the *overwrite* property is set to false.
