...
== List N files and sorting

In the 'Advanced' tab, you can use the `<file:subset>` element to limit the number of files returned and to sort them.

image::list-subset.png[]

Here is an example of a file subset you can use:
...
The limit and offset attributes are optional and are ignored if not provided.
