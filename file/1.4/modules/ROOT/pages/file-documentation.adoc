...
| In Memory Objects a| Number | Defines the maximum amount of instances the stream uses to keep data in memory. If more than the specified instances are required, then the system starts to buffer the content on disk. Default value is 500. | 500 |
|===
