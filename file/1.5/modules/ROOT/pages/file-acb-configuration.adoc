...
The *Delete* operation deletes the file that the *Directory path* field points to, as long as the file isn't locked. 
...
Use the *List* operation to list all files in the *Directory path*.
