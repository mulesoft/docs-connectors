...
|File Matching Rules a| Filters files based on the matching criteria you use for accepting or rejecting a file. Here is an example of some file matching rules:
