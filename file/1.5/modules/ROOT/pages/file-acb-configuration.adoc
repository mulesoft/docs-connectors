...
. Add the *On New or Updated* component to the canvas UI.
. Click the *On New or Updated* component on the canvas UI. 
...
. Click the *Copy* component on the canvas UI to configure the following attributes in the *General* tab:
+
[%header%autowidth.spread]
|===
| UI Field | Description | Required
...
. Click the *Create Directory* component on the canvas UI to configure the following attributes in the *General* tab:
+
[%header%autowidth.spread]
|===
| UI Field | Description | Required
