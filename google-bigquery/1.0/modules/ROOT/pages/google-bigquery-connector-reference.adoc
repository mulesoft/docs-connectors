...
| Project Id a| String |  Project ID. |  | x
...
* BIGQUERY:NOT_ACCEPTABLE
* BIGQUERY:NOT_FOUND
* BIGQUERY:RETRY_EXHAUSTED
* BIGQUERY:SERVER_ERROR
* BIGQUERY:SERVICE_UNAVAILABLE
* BIGQUERY:TIMEOUT
...
Performs a query. This operation makes an HTTP GET request to the /files/{fileId}/comments endpoint.
