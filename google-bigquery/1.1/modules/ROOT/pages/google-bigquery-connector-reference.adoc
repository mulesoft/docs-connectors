...
Get results of a query. This operation makes an HTTP GET request to the /files/{fileId}/comments endpoint.
...
Lists jobs. This operation makes an HTTP GET request to the /files/{fileId}/comments endpoint.
...
Executes a query. This operation makes an HTTP GET request to the /files/{fileId}/comments endpoint.
