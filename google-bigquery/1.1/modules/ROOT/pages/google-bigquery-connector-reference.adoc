...
This operation makes an HTTP GET request to the projects/{projectId}/queries/{jobId} endpoint.
...
This operation makes an HTTP POST query request to the /projects/{projectId}/queries endpoint.
