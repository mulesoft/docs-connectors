= Google BigQuery Connector 1.1 Examples 
...
. Enter the values to configure either JWT or OAuth2. For more information about what values to enter in the fields for the connector configuration, see xref:google-bigquery-connector-studio.adoc#configure-global-element[Configure a Global Element for the Connector].
