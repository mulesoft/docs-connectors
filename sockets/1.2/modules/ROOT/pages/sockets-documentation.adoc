...
Reading is terminated by the client by shutting down its output stream, also known as TCP Half Close feature. Use this protocol with SSL sockets that use TLS 1.3 version and later, (Half Close feature was introduced in TLS 1.3).
