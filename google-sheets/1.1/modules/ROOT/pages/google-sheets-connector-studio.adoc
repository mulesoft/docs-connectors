= Using Anypoint Studio to Configure Google Sheets Connector 1.1 - Mule 4
...
. On the *General* tab, configure the authentication for the connection as described in <<oauth-authentication,OAuth Authentication>>.
+
...
After you configure a global element for Google Sheets Connector, configure the other required fields for the connector, as described in the xref:google-sheets-connector-reference.adoc[Google Sheets Connector Reference].
