...
The application or AI system that initiates requests and consumes services offered by A2A servers.
...
The A2A server acts as a remote agent that exposes an HTTP(S) endpoint and implements the A2A protocol methods for interacting with other AI agents. 
...
| Name | Type | Description | Default Value | Required
|Name | String | Name for this configuration. Connectors reference the configuration with this name. | | x
| Connection a| <<Server_Connection, Connection>>
 | The connection types to provide to this configuration. | | x
| Card a| <<AgentCard>> |  |  | x
| Name a| String |  ID used to reference this configuration. |  | x
| Task History Enabled a| Boolean |  |  false | 
| Default Max History Length a| Number |  |  | 
...
| Response Headers a| Object |  |  | 
| Error Status Code a| Number |  |  500 | 
|===
...
| Documentation Url a| String |  |  | 
| Agent Authentication a| <<AgentAuthentication>> |  |  | 
| Default Input Modes a| Array of String |  |  | 
| Default Output Modes a| Array of String |  |  | 
|===
...
| Name a| String |  |  | x
| Description a| String |  |  | 
| Tags a| Array of String |  |  | 
| Examples a| Array of String |  |  | 
| Input Modes a| Array of String |  |  | 
| Output Modes a| Array of String |  |  | 
|===
...
|===
| Field | Type | Description | Default Value | Required
| Streaming a| Boolean |  | false | 
| Push Notifications a| Boolean |  | false | 
