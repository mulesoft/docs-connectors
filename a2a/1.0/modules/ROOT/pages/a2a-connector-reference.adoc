= A2A Connector Reference

Anypoint Connector for Agent2Agent (A2A) (A2A Connector) provides Agent2Agent (A2A) protcol support for your LLM agents, enabling your agents to talk to other agents.
