...
* A2A Connector now supports the new *A2A Client - Send Stream Message*, *A2A Client - Task Resubscribe*, *A2A Server - Update Task Artifact*, and *A2A Server - Update Task Status* operations.
