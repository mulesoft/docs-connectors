...
Use the Anypoint Connector for X12 EDI (X12 EDI Connector) Batch Write operation to merge individual X12 messages into a single transmission to send to your trading partners.
...
* Generates the intermediate X12 message payload using the X12 Batch Write operation.
