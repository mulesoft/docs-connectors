...
https://www.mulesoft.com/exchange/?search=X12&type=template/[Anypoint Exchange Templates] provide starting points for Studio projects such as:
...
https://www.mulesoft.com/exchange/?search=X12&type=example[X12 Connector Examples] enable you to create complete Studio projects such as:
