...
* Whether to enforce conditional rules on input data. The default behavior is to ignore conditional rules.
...
|acknowledgmentSchemaPath="" |Expect path either from file system or classpath. If path is specified it will overwrite the default acknowledgment.
