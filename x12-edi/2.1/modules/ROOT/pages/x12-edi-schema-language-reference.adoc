...
|count |mMaximum repetition count value, which can be a number or the special value `>1` meaning any number of repeats (optional, count value of 1 is used if not specified)
