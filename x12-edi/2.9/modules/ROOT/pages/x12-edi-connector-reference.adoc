...
* On the send side, this value is used as the default ISA Interchange Receiver ID Qualifier when this is not set in the message data. |  |
...
* On the send side, this value is used as the default ISA Interchange Receiver ID when this is not set in the message data. |  |
...
* On the send side, this value is used as the default GS Application Receiver's Code when this is not set in the message data. |  |
...
* If `false`, TAI acknowledgements are not requested.|  false |
