...
https://www.mulesoft.com/exchange/?search=x12&type=template&sort=score[Anypoint Exchange Templates for EDI X12] provide starting points for using X12 EDI Connector with Studio projects such as:

* Setting up your outbound transactions
+
https://www.mulesoft.com/exchange/org.mule.examples/template-b2b-edi-outbound-x12-map/minor/1.0//[Map application messages to outbound EDI X12 transactions]

* Setting up your inbound transactions

+
https://www.anypoint.mulesoft.com/exchange/org.mule.examples/template-b2b-edi-inbound-x12-map/minor/1.0//[Map inbound EDI X12 transactions to application message format]

* Setting up your Partner Manager content storage
+
https://www.anypoint.mulesoft.com/exchange/com.mulesoft.b2b/partner-manager-content-storage-service-s3/minor/1.0/[Partner Manager Content Storage API - S3 Template]
