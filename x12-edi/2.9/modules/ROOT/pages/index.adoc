...
X12 EDI Connector examples in Exchange enable you:
...
* https://www.mulesoft.com/exchange/org.mule.examples/b2b-demo-x12-transform/[Transform an X12 EDI 850 purchase order to JSON]
* https://www.mulesoft.com/exchange/org.mule.examples/example-b2b-nto-outbound-purchase-order-01/[Transform outbound purchase order XML messages to X12 EDI 850 transactions]
* https://www.mulesoft.com/exchange/org.mule.examples/example-b2b-mythical-inbound-purchase-order-01/[Transform inbound X12 EDI 850 transactions to a JSON purchase order]
