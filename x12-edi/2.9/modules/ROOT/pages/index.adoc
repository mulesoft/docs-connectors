...
* https://www.mulesoft.com/exchange/org.mule.examples/example-b2b-into-outbound-purchase-order-01/[Transform outbound purchase order XML messages to X12 850 transactions]
