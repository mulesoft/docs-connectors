= X12 EDI Connector 2.19 - EDI Schema Language Reference 
...
Define your implementation convention with an Overlay Schema. Overlay schemas specify how to use implementation conventions with a particular trading partner to extend and customize the standard.
