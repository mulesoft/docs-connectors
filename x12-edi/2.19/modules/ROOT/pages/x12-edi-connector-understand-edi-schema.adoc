= X12 EDI Connector 2.19 - Understanding the EDI Schema Language 
...
Customize X12 schema definitions to suit your data by defining an overlay schema. An overlay schema is a type of ESL that enables you to modify a base schema, such as an X12 4010 850 schema, with your specific conventions.
...
Define your own custom schemas, or copy and edit a base X12 schema definition to suit your data as shown in the xref:x12-edi-schema-language-reference.adoc[EDI Schema Language Reference].
