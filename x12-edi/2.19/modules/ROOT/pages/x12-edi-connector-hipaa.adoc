= X12 EDI Connector 2.19 HIPAA 
:page-aliases: connectors::x12-edi/x12-edi-connector-hipaa.adoc

Anypoint Connector for X12 EDI Connector 2.19 - HIPAA provides support for the Health Insurance Portability and Accountability Act (HIPAA) standards based on X12 EDI Connector standards and version `005010` document type.
