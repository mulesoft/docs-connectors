= X12 EDI Connector 2.19
:page-aliases: connectors::x12-edi/x12-edi-connector.adoc

Support Category: https://www.salesforce.com/en-us/wp-content/uploads/sites/4/documents/legal/Agreements/versioning-back-support-policy.pdf[Premium] +
...
to use as starting points for your apps and examples that illustrate a complete solution.
...
* https://www.mulesoft.com/exchange/org.mule.examples/b2b-demo-x12-transform/[Transform outbound XML messages into X12 purchase orders, inbound X12 purchase orders into JSON, and generate a functional acknowledgment]
