= X12 EDI Connector 2.14 HIPAA - Mule 4
...
For complete information about X12 standards, refer to xref:index.adoc[X12 EDI Connector 2.9] and xref:x12-edi-schema-language-reference.adoc[EDI Schema Language Reference].
