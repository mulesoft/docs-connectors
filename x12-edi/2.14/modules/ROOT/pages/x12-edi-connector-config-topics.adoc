= X12 EDI Connector 2.14 Schema and Trading Partner Configuration - Mule 4
...
|lockMechanism="X12"/"RUNTIME_LOCK_MANAGER"/"OBJECT_STORE" |Determine the mechanism used to manage locks for control number sequencing.
|===
