...
|Allow year zero| Boolean a|
When validating dates, the year zero '0000' will be valid by default.

* If `true`, the year zero is a valid year
* If `false`, the year zero is an invalid year, an error will be reported. | true |
