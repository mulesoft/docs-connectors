= X12 EDI Connector 2.12 Reference - Mule 4
...
| `strictValidationOfYear`| Enables the validation of the year `0000`. By default, the year `0000` is valid.
|===

For more information about system properties visit https://docs.mulesoft.com/mule-runtime/4.4/mule-app-properties-system[System Properties]
