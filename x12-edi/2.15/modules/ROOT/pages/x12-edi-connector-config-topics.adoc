= X12 EDI Connector 2.15 Schema and Trading Partner Configuration - Mule 4
...
//TODO Confirm name
|includeHLDetails="false" | Whether to include the HL segments in the output map and metadata
|===
