...
Use these optional XML configuration options to set self or partner identification thus defining your trading partner relationship.
You can set the types of error conditions that reject receive transaction sets, as well as any writer message separator operations.
...
These identify your side of the trading partner relationship.
