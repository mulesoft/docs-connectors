...
For complete information on X12 standards, refer to xref:index.adoc[X12 EDI Connector 2.5] and xref:x12-edi-schema-language-reference.adoc[X12 EDI Schema Language Reference].
