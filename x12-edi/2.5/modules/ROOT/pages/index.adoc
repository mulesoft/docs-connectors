...
The schema definitions for all xref:x12-edi-versions-x12.adoc[supported X12 standard transaction sets] are provided. For complete information on schemas, see xref:x12-edi-schema-language-reference.adoc[X12 EDI Schema Language Reference].
