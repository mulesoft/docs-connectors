...
The schema definitions for all xref:x12-x12-edi-versions-x12.adoc[supported X12 standard transaction sets] are provided.

Many HIPAA document versions are also supported, as listed separately in the xref:x12-x12-edi-versions-hipaa[Connector HIPAA reference page].
