...
This transformer can be tested using the following functional test. Note that it uses `FunctionalTestCase`, which is part of Mule's xref:3.8@mule-runtime::functional-testing.adoc[Test support].
