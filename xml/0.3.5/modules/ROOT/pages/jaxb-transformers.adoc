...
:page-aliases: 3.5@mule-runtime::jaxb-transformers.adoc
...
Mule offers automatic xref:0.3.7@jaxb-bindings.adoc[JAXB Bindings] so you don't even need use these transformers for most scenarios.
