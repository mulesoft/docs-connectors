...
:page-aliases: 3.6@mule-runtime::xml-namespaces.adoc
...
You can specify the namespace on any XML-based functionality in Mule, including the JXPath filter, Jaxen filter, XPath filter, filter-based splitter, expression splitter, round-robin splitter, JXPath extractor transformer, and XPath expression transformer in the xref:index.adoc[XML Module Reference] and xref:3.6@mule-runtime::xpath-annotation.adoc[XPath Annotation].
