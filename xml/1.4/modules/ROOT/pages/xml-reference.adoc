...
| Schemas a| String |  The path to the schema file. You can specify multiple schema locations by using a comma separator |  |
| Schema Contents a| Array of <<SchemaContent>> | Schema text content for performing a schema validation. |  |
