...
:page-aliases: 3.9@mule-runtime::xquery-support.adoc

The XQuery Module gives users the ability to perform XQuery transformations on XML messages in Mule. This works in a very similar way to the xref:3.9@mule-runtime::xslt-transformer-reference.adoc[XSLT Transformer] shipped with Mule.
