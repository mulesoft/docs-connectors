...
:page-aliases: 3.9@mule-runtime::domtoxml-transformer.adoc
...
These transformers support the xref:3.9@mule-runtime::transformers-configuration-reference.adoc[standard transformer attributes]. In addition, they support the following configuration.
