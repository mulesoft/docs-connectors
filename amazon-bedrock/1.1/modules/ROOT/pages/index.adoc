...
* *Streaming*
+
Support real-time data processing and interaction with language models. The xref:amazon-bedrock-connector-reference.adoc#ChatAnswerPromptStreaming[CHAT Answer Prompt Streaming] operation can include images or documents with the prompt.
