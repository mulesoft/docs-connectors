...
<ms-bedrock:agentcore-batch-create-memory-records
  ...
  <ms-bedrock:create-records>
    <ms-bedrock:create-record timestamp="1751500000" requestIdentifier="#[uuid()]">
      <ms-bedrock:content>#[payload.text]</ms-bedrock:content>
      <ms-bedrock:namespaces>
        <ms-bedrock:namespace value="support/session-123"/>
      </ms-bedrock:namespaces>
    </ms-bedrock:create-record>
  </ms-bedrock:create-records>
</ms-bedrock:agentcore-batch-create-memory-records>
----
...
<ms-bedrock:agentcore-batch-update-memory-records
  ...
  <ms-bedrock:update-records>
    <ms-bedrock:update-record memoryRecordId="#[payload.recordId]" timestamp="1751500000">
      <ms-bedrock:content>#[payload.updatedText]</ms-bedrock:content>
    </ms-bedrock:update-record>
  </ms-bedrock:update-records>
</ms-bedrock:agentcore-batch-update-memory-records>
----
...
<ms-bedrock:agentcore-batch-delete-memory-records
  ...
  <ms-bedrock:delete-records>
    <ms-bedrock:delete-record memoryRecordId="#[payload.recordId]"/>
  </ms-bedrock:delete-records>
</ms-bedrock:agentcore-batch-delete-memory-records>
----
...
* *Payload*
+
The payload to send to the agent runtime.
