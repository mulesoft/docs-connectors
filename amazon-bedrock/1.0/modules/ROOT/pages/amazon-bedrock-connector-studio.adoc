...
For detailed configuration information for each operation type, see xref:amazon-bedrock-additional-config.adoc[Amazon Bedrock Connector - Additional Configuration Information].
