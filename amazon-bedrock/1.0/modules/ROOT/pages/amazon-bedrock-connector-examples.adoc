	...
	<flow name="mule-amazon-bedrock-connector-testFlow" doc:id="5f7ee97f-30f9-481e-9516-9beb8b23624b" >
		...
		<choice doc:name="Choice" doc:id="3d613b19-1375-4be8-a997-3ccfcc9a0306" >
			<when expression='#[attributes.queryParams.operation == "prompt"]' >
				<mac-bedrock:chat-answer-prompt doc:name="Chat answer prompt" doc:id="cda31fe3-d232-4dbc-b85f-91a256d37389" config-ref="Amazon_Bedrock_Config" prompt="#[payload.prompt]" modelName="${llm_model_name}" region="${llm_region}" guardrailIdentifier="${guardrail_id}"/>
			</when>
			<when expression='#[attributes.queryParams.operation == "imageGenerate"]' >
				<mac-bedrock:image-generate doc:name="Image generate" doc:id="ad1ac413-f426-46cb-9a83-c03403fe7a29" config-ref="Amazon_Bedrock_Config" TextToImage="#[payload.prompt]" AvoidInImage="#[payload.avoid]" fullPathOutput='#["/Users/max.mule/Downloads/imageGen.png"]' modelName="${llm_image_gen_model_name}" region="${llm_region}"/>
			</when>
