...
image::bmc-remedy-create-user-flow.png["Creating a user flow"]
...
<<<<<<< W-21380082-Fix-broken-links-in-connector-docs-sis
* https://docs.bmc.com/xwiki/bin/view/Service-Management/On-Premises-Deployment/Remedy-Deployment/brid1908/Installing/[BMC installation instructions]
* https://help.mulesoft.com[MuleSoft Help Center]
* Access the https://docs.bmc.com/xwiki/bin/view/Service-Management/On-Premises-Deployment/Remedy-Deployment/[BMC Remedy AR System documentation]
=======
