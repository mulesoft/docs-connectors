...
and xref:5.x@studio::index.adoc[Anypoint Studio Essentials]. To increase your familiarity with Studio,
consider completing one or more xref:5.x@studio::basic-studio-tutorial.adoc[Anypoint Studio Tutorials]. Further,
