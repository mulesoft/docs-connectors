...
== Installing the Connector
 ...
 You can "test drive" the CMIS connector by installing it in Anypoint Studio. Follow the instructions to xref:6.x@studio::index.adoc[download and launch Anypoint Studio], then follow the steps below to install the connector:
