...
|===
| Method | Description
| Basic Auth V3 | Authenticates via the V3 login endpoint (`/saas/public/core/v3/login`) using JSON. Uses the `IDS-SESSION-ID` session header.
...
* Metadata Discovery
+
The connector dynamically retrieves available business entity types and source systems from the B360 tenant. Anypoint Studio and Anypoint Code Builder displays dynamic dropdowns for object types and source systems.
