...
+
Find similar records using Informatica's match engine. Search Match V1 matches against source records; Search Match V2 matches directly against master records for improved performance.
* Metadata Discovery
+
Retrieve available business objects from the B360 tenant at design time and runtime. Anypoint Studio displays dynamic dropdowns for object types and source systems.
