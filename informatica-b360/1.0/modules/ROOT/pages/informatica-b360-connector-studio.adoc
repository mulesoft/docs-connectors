...
* xref:informatica-b360-connector-reference.adoc#Config_BasicAuthV3Connection[Basic Auth V3 Connection] (recommended)
+
Authenticates using the Informatica V3 login endpoint with JSON-only communication.
* xref:informatica-b360-connector-reference.adoc#Config_BasicAuthV2Connection[Basic Auth V2 Connection]
+
...
* *Filters* (optional) — A JSON array of filter conditions
