...
| Maximum size a| Number | Maximum number of parsed schemas retained in the cache. A value of `0` disables the cache. This field is in the *Avro Schema Parse Cache* section. |  0 |
| Time to live a| Number | How long an unused parsed schema remains in the cache. A value of `0` disables idle eviction. If this value is greater than `0`, *Maximum size* must also be greater than `0`. This field is in the *Avro Schema Parse Cache* section. |  0 |
| Time to live time unit a| Enumeration, one of:
...
** MINUTES
** HOURS
** DAYS | Time unit for the *Time to live* field. This field is in the *Avro Schema Parse Cache* section. |  SECONDS |
|===
