...
To execute requests, the connector routes the requests through the Windows Gateway Services as shown in the following image:

image::ms-dynamics-ax-protocol-translation.png["Microsoft Dynamics AX Connector global elements properties config window on General tab"]
...
+
image::ms-dynamics-ax-component.png["Query Table operation"]
+
. For general settings complete these fields:
+
image::ms-dynamics-ax-any-config.png["Global Elements Properties General configuration tab"]
+
...
image::ms-dynamics-ax-any-advanced-config.png["Microsoft Dynamics AX Connector global elements properties config window on Advanced tab"]
...
* Run a query against an https://learn.microsoft.com/en-us/dynamicsax-2012/developer/tables-overview?redirectedfrom=MSDN[AOT table]
* Run an https://learn.microsoft.com/en-us/dynamicsax-2012/developer/queries-in-the-aot-for-data-access?redirectedfrom=MSDN[AOT static query]
* Call an https://learn.microsoft.com/en-us/dynamicsax-2012/appuser-itpro/aif-document-services?redirectedfrom=MSDN[AIF Document Service]
