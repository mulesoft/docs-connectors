...
image::ms-dynamics-ax-protocol-translation.png[alt=""]
...
+
image::ms-dynamics-ax-design-listener.png["General configuration tab for the HTTP Listener with queryTable as the Path"]
+
. Click the plus sign and search for Dynamics AX Connector and select the *Query Table* operation.
...
image::ms-dynamics-ax-design-operation.png["General Configuration tab for the Query Table operation"]
