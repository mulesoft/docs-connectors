...
For compatibility information and fixed issues, see the xref:release-notes::connector/servicenow-connector-release-notes-mule-4.adoc[ServiceNow Connector Release Notes].
...
see xref:servicenow-connector-studio.adoc[Studio Configuration].
* Power user
+
Read the xref:servicenow-connector-xml-maven.adoc[XML and Maven Support]
and xref:servicenow-connector-examples.adoc[Examples] topics.
...
xref:servicenow-connector-examples.adoc[Example] use cases includes getting a ServiceNow incident record.
