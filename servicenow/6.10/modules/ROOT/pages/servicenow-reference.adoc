...
| Display system references a| String a| Data retrieval operation for reference and choice fields. Retrieves the display value or the actual value from the database. The valid values are:
