...
:page-aliases: 3.6@mule-runtime::servicenow-connector.adoc
...
*Reference*: http://mulesoft.github.io/servicenow-connector[ServiceNow Connector]
...
If you don't use Anypoint Studio for development, follow the instructions to http://mulesoft.github.io/servicenow-connector[install the ServiceNow Maven dependencies] into your `pom.xml` file.
...
* A global ServiceNow element to be used by all the ServiceNow connectors in the application (read more about xref:3.6@mule-runtime::global-elements.adoc[global elements in Mule]).
