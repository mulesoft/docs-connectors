...
:page-aliases: 3.8@mule-runtime::servicenow-connector.adoc
...
Contact the mailto:info@mulesoft.com[MuleSoft Sales Team] to obtain either of these. (Read more about xref:3.8@mule-runtime::installing-an-enterprise-license.adoc[Installing an Enterprise License].)

== Configuration

To use the ServiceNow connector in your Mule application, you must configure:

* A global ServiceNow element to be used by all the ServiceNow connectors in the application (read more about xref:3.8@mule-runtime::global-elements.adoc[global elements in Mule]).
...
=== Configure with the Studio XML Editor
...
////
DOCS-2294 - Remove DataMapper section
