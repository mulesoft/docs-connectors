...
This example creates a Mule flow in Anypoint Studio 7 to retrieve keys from the Incident table in a ServiceNow instance:

. Create a Mule application as a project in Anypoint Studio. +
