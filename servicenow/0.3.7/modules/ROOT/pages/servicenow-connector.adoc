...
:page-aliases: 3.7@mule-runtime::servicenow-connector.adoc
...
If you don't use Anypoint Studio for development, view http://mulesoft.github.io/servicenow-connector[ServiceNow reference to set dependencies] in your `pom.xml` file.
...
////
DOCS-2294 - Hide DataMapper sections
