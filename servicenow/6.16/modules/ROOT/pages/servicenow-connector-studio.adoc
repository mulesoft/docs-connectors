= Using Anypoint Studio to Configure ServiceNow Connector 6.16 - Mule 4
...
|===
+
image::servicenow-studio-connection-6.7.0.png["Global element properties window with basic authentication selected"]
+
. Click *OK*.
...
+
image::servicenow-studio-requester-config.png["Transport tab for basic authentication"]
+
...
image::servicenow-oauth.png["General tab for configuring OAuth 2.0 Authorization Code"]
