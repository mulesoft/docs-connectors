= Apache Kafka Connector v4.3 - Mule 4
...
After you complete the prerequisites, you are ready to create an app with xref:kafka-connector-studio.adoc[Use to Studio to Configure Apache Kafka Connector].
