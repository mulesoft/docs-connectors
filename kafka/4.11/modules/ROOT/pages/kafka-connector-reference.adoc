...
Enable FIPS mode by setting the following flag to true. This will add com.sun.security.sasl.Provider security provider in the FIPS environment.

`com.mulesoft.connectors.allow-registration-of-sasl-security-provider-in-fips=true`
