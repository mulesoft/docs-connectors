...
You can install this connector in Anypoint Studio using the instructions in xref:6@studio::import-asset-exchange-task.adoc[To Import an Asset from Exchange].
