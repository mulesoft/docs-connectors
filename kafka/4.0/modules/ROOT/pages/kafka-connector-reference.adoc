...
[NOTE]
Batch Message Listener operation not support configurable streaming strategy, because not works with input stream, else, with a List of Records. The Streaming Strategy in use is non-repeatable-stream.
