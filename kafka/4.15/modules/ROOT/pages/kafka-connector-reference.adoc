...
** DEFAULT
** USE_ALL_DNS_IPS
** RESOLVE_CANONICAL_BOOTSTRAP_SERVERS_ONLY | Controls how the client uses DNS lookups. | `USE_ALL_DNS_IPS` |
| Compression type a| Enumeration, one of:
...
** SNAPPY
** LZ4
** ZSTD | Compression type for all data generated by the producer. | `NONE` |
...
** NONE
** LEADER_ONLY
** ALL | Number of acknowledgments the producer requires before considering a request complete. | `NONE` |
