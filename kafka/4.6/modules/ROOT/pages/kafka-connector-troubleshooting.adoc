...
When the Kafka Connector configurations fail to load the truststore files from the classpath, you receive the following error:
...
The configurations fail to establish connections even when the required files are available in the classpath.

To resolve this error:

Add the required truststore files to the main application that uses the Kafka Connector configuration. 
