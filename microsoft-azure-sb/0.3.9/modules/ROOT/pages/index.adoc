= Anypoint Connector for Microsoft Azure Service Bus - Mule 3
...
* xref:release-notes::connector/microsoft-azure-service-bus-connector-release-notes.adoc[Microsoft Azure Service Bus Connector Release Notes]
