= Use Studio to Configure Azure Service Bus Connector - Mule 4
...
Azure Service Bus Messaging supports This connector supports SAS (Shared Access signature) authentication.
...
The service namespace is the unique name assigned to the namespace at the time of creation. It is the host-name portion of the URL, for example: 
+
