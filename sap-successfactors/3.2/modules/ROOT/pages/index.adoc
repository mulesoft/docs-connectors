...
* Anypoint Studio
* Credentials to access SAP SuccessFactors using the ODATA API
...
* https://help.sap.com/docs/r/product/SAP_SUCCESSFACTORS_HXM_SUITE[SuccessFactors HCM Suite site]
