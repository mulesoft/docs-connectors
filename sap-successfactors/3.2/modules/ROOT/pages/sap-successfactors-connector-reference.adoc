...
This operation creates a new entity in the specified entity set.
...
| Entity Set Name a| String |  Name of the entity set |  |x
...
This operation retrieves an entity by its specified key from the resource path of the OData URI.
...
| Entity Set Name a| String | Entity set name to search for using the entity with the given key. |  |x
| Key Properties a| Object  |  #[payload] |  |x
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use | |x
| Entity Set Name a| String |  The type of entity to update. This value is dynamically loaded from the SuccessFactors OData description file.|  |x
...
This operation creates or updates an entity on SuccessFactors. The type of the entity is defined by the `entitySetName` property. This method returns the full SAP SuccessFactors upsert response after it finishes executing.
...
| Name | Type | Description | Default Value | Required
| Configuration | String | Name of the configuration to use | | *x*
| Entity Set Name a| String |  Type of entity being created. This value is dynamically loaded from SuccessFactors OData description file. |  | *x*
