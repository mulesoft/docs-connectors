...
In SAP SuccessFactors Connector 5.0 and later, *The private key from the X.509 certificate.* is removed from OAuth SAML Bearer Assertion Authentication. You can either migrate your existing JKS keystore file or generate a new JKS keystore file.
