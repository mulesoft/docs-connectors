= SAP SuccessFactors Connector 4.0 
...
* Access to Anypoint Studio or Anypoint Code Builder
...
* https://help.sap.com/docs/r/product/SAP_SUCCESSFACTORS_HXM_SUITE[SuccessFactors HCM Suite Help]
