...
NOTE: At the moment when you use query operation with pagination it may be possible to receive duplicate records. As a workaround you can use the idempotent filter in order to remove any duplicates received. 
