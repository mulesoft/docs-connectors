= Upgrading and Migrating SAP SuccessFactors Connector to Version 4.0 
...
* https://help.sap.com/docs/page-not-found?url=https://helpsap.cfapps.eu10-004.hana.ondemand.com/doc/a7c08a422cc14e1eaaffee83610a981d/2005/en-US/SF_HCM_OData_API_DEV.pdf[SAP SuccessFactors HXM Suite OData API:
Developer Guide]
