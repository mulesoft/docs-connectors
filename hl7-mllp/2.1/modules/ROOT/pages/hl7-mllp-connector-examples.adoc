...
Use these examples to read and write HL7 messages over the MLLP protocol.
...
MLLP messages. It is a hexadecimal 0x1C character also known as FS. Applications in some clinics use a different delimiter value, that can be set in this field. The standard value in the
