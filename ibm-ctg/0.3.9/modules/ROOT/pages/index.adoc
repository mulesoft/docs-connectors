...
Mule converts `RELEASE` to the latest version. To set the version to a specific release, see the xref:release-notes::connector/ibm-ctg-connector-release-notes.adoc[Release Notes] for version numbers.
