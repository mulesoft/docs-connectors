...
Metadata definition is not a required step to use the IBM CTG connector but it is essential to improve the usability of the connector.  Refer to xref:studio::metadata-editor-concept.adoc[Defining Metadata] for additional information.
