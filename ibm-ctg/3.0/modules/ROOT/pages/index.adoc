= IBM CICS Transaction Gateway Connector 3.0
...
See https://www.ibm.com/docs/en/cics-tg-multi/9.0.0[IBM ECI Timeout].
+
...
* IBM's https://www.ibm.com/docs/en/cics-ts/5.3.0?topic=applications-developing-java-cics[Developing Java applications for CICS]
* High-level tutorial of JCA in https://developer.ibm.com/languages/java/[Introduction to the J2EE Connector Architecture]
* https://www.redbooks.ibm.com/domains/zsoftware[Redbooks for the IBM Mainframe]
* xref:studio::create-metadata-class-task.adoc[Create Metadata]
* https://www.ibm.com/docs/en/cics-tg-multi/9.0.0[IBM ECI Timeout]
