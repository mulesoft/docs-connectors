...
* Integrate https://www.mulesoft.com/exchange/org.mule.examples/filesystem-to-veeva-vault-template/[File System to Veeva Vault]
* Integrate https://www.mulesoft.com/exchange/org.mule.examples/veevavault-connector-project-templates/[Veeva Vault to File System]
* Auto-approve loan applications through the https://www.mulesoft.com/exchange/org.mule.examples/spark-message-solution-template/[Spark message end solution]
