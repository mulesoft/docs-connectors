= Veeva Vault Connector 1.3 Examples - Mule 4
...
This example retrieves document details based on document type, subtype, and classification and stores the document details in the database.
...
. Copy and import the `spark-listener.jks` file under the `src/main/resources` 	project directory.
...
* Auto approval of loan applications through Spark message https://anypoint.mulesoft.com/exchange/c5788341-a495-4d6f-a931-875757082c63/spark-message-solution-template/[Spark Message End Solution]
