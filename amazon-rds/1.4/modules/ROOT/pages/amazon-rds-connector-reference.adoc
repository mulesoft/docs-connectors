= Amazon RDS Connector 1.4 Reference 
...
| External ID a| String |  A unique identifier used when assuming an IAM role in an external account. Provide the value specified by the administrator of the target account for added security. |  | 
...
This operation copies a DBSnapshot. The source DBSnapshot must be in the "available" state.

For more information, see this operation in the Amazon https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_CopyDBSnapshot.html[API Reference].
...
| Source DB Snapshot Identifier a| String | The identifier for the source DB snapshot. |  | x
| Target DB Snapshot Identifier a| String | The identifier for the copy of the snapshot. |  | x
...
For more information, see this operation in the Amazon https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_CreateDBInstanceReadReplica.html[API Reference].
...
For more information, see this operation in the Amazon https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_CreateDBSnapshot.html[API Reference].
...
For more information, see this operation in the Amazon https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_DeleteDBSnapshot.html[API Reference].
...
Returns information about provisioned RDS instances. This API supports pagination.   For more information, see this operation in the Amazon https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_DescribeDBInstances.html[API Reference].
...
Returns information about DB snapshots. This API action supports pagination.   For more information, see this operation in the Amazon https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_DescribeDBSnapshots.html[API Reference].
...
Returns information about reserved DB instances for this account, or about a specified reserved DB instance.  For more information, see this operation in the Amazon https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_DescribeReservedDBInstances.html[API Reference].
...
Lists available reserved DB instance offerings. For more information, see this operation in the Amazon https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_DescribeReservedDBInstancesOfferings.html[API Reference].
...
Modifies settings for a DB instance. You can change one or more database configuration parameters by specifying these parameters and the new values in the request. For more information, see this operation in the Amazon https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_ModifyDBInstance.html[API Reference].
...
For more information, see this operation in the Amazon https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_ModifyDBSnapshot.html[API Reference].
...
For more information, see this operation in the Amazon https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_RestoreDBInstanceToPointInTime.html[API Reference].
