...
| Failover Time a| Number |  Duration of a lease for a worker. This parameter also determines the frequency with which a worker looks for new leases to work on (roughly twice this value). |  10 |
