...
| Max Batch Size a| Number |  The maximum number of data records that a batch can carry. A batch is the number of records that the listener receives from the stream. |  10000 |
