...
The following example shows how to use Amazon Kinesis Data Streams Connector to send records and how to use the connector to listen from a Kinesis stream.
