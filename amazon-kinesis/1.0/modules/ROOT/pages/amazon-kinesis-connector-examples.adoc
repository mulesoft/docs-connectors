...
+
* This flow uses the *Listener* to listen for new data records:
+
image::amazon-kinesis-example-listener.png[Listener flow]
+
* This flow uses the *Listener* to listen for new data records. After receiving the new records, it calls the *Checkpoint* operation to set a  manual checkpoint:
+
