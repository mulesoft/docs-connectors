= SAP S/4HANA SOAP Cloud 2.1 - Examples - Mule 4
...
Next example sends an XML request to SAP S/4HANA's SOAP API and receives the replication outbound message which is saved to the object store.
There is another flow used to get this outbound message from the object store.
...
http://www.mulesoft.org/schema/mule/s4hana http://www.mulesoft.org/schema/mule/s4hana/current/mule-s4hana.xsd">
	...
	<s4hana-soap:listener-config name="SAP_S4_HANA_Cloud_SOAP_Listener_config" doc:name="SAP S4 HANA Cloud SOAP Listener config" httpListenerConfig="HTTPS_Listener_config" />

	<s4hana-soap:config name="SAP_S4_HANA_Cloud_SOAP_Config" doc:name="SAP S4 HANA Cloud SOAP Config" >
	...
	<flow name="product-message-type-flow">
		<s4hana-soap:outbound-message-listener doc:name="Outbound Message Listener" config-ref="SAP_S4_HANA_Cloud_SOAP_Listener_config" messageType="ProductMDMBulkReplicateRequestMessage" path="/productmdmbulkreplicaterequest" />
...
---
{
	ns0#ProductMDMBulkReplicateRequestMessage: {
		...
		<s4hana-soap:invoke doc:name="Invoke" config-ref="SAP_S4_HANA_Cloud_SOAP_Config" service="https://my303109-api.s4hana.ondemand.com/sap/bc/srt/wsdl_ext/flv_10002S111AD1/srvc_url/sap/bc/srt/scs_ext/sap/productmdmbulkreplicaterequest" operation="ProductMDMBulkReplicateRequest_In" customQueryParams='#["MessageId" : uuid()]'/>
