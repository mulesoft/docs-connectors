= Using Anypoint Studio to Configure SAP S/4HANA SOAP Connector 2.1 - Mule 4
:page-aliases: connectors::sap-s4hana-soap/sap-s4hana-soap-connector-design-center.adoc
