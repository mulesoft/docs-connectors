...
** WSA200508
** WSA200408 |  WS-Addressing version. Defaults to WSA 2005-08 |  WSA200508 | {nbsp}
| From a| String |  Reference of the endpoint where the message originated from. |  | {nbsp}
|===
...
| Web Service Addressing a| <<AddressingSettings>> | The configuration of WS-Addressing specific SOAP headers. |  |
...
If not specified, the connector will use value from configuration. |  |
| Wsa From a| String | Reference of the endpoint where the message originated from.
If not specified, the connector will use value from configuration. |  |
| Wsa Message ID a| String | An identifier that uniquely identifies this message in time and space.
If not specified, the connector will use time-based UUID. |  |
| Wsa Relates To a| String | A message ID that this message is related to. |  |
|======================
