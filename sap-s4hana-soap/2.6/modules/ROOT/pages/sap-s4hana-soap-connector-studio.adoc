= Using Anypoint Studio to Configure SAP S/4HANA SOAP Connector 2.6 - Mule 4
:page-aliases: connectors::sap/sap-s4hana-soap-connector-studio.adoc, connectors::sap-s4hana-soap/sap-s4hana-soap-connector-design-center.adoc
...
+
image::sap-hana-global-config-wizard.png["Global configuration elements screen with Create button"]
+
...
. In the *Global Configuration Elements* screen, click *Create*:
+
image::sap-hana-source-global-config-wizard.png["Global configuration elements screen with Create button"]
+
