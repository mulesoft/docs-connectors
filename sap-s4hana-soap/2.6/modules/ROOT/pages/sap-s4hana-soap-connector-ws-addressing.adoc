= Web Service Addressing Example 
...
+
image:sap-s4hana-soap-select-listener.png["HTTP Listener selected in the Mule Palette view"]
+
...
image::sap-s4hana-soap-invoke-addressing-props.png["Invoke operation advanced properties"]
...
+
image::sap-s4hana-soap-select-transform.png["Transform message core component selected in the Mule Palette view"]
+
...
image::sap-s4hana-soap-logger.png["Logger properties window"]
