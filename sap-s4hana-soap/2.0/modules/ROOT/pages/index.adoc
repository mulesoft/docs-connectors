= SAP S/4HANA SOAP Cloud Connector - Get Started 
...
* New user +
To create your Mule app, see xref:sap-s4hana-soap-connector-studio.adoc[Studio Configuration].  The
xref:sap-s4hana-soap-connector-examples.adoc[Examples] topic provides one or more use cases for using the connector.
* Power user +
Read the xref:sap-s4hana-soap-connector-xml-maven.adoc[XML and Maven Support]
