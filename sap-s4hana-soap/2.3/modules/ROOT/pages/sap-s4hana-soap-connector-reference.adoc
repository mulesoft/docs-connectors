...
| Custom Soap Headers a| Object |  The additional soap headers to be wrapped in the soap envelope. |  |
...
* <<RepeatableFileStoreStream>> |  Configure how Mule processes streams with streaming strategies. Repeatable streams are the default behavior.   |  |
