...
[source,xml,linenums]
----
<box-connector:config name="Box_Connector_Config"
 doc:name="Box Connector Config"
 property_client-id="${config.clientId}"
 property_client-secret="${config.clientSecret}"
 property_local-callback-config="HTTP_Listener_config"
 property_external-callback-url="http://localhost:8081/callback" />
----
+
...
<mule xmlns:ee="http://www.mulesoft.org/schema/mule/ee/core"
	xmlns:box-connector="http://www.mulesoft.org/schema/mule/box-connector"
...
http://www.mulesoft.org/schema/mule/box-connector
http://www.mulesoft.org/schema/mule/box-connector/current/mule-box-connector.xsd
...
---
{
	...
	name: "SampleFolder"
		...
		<box-connector:create-folder
			doc:name="Create folder" config-ref="Box_Connector_Config" />
		...
		<box-connector:get-folder doc:name="Get folder"
			config-ref="Box_Connector_Config" folder-id="#[payload.id]" />
		<logger level="INFO" doc:name="Logger to log the retrieved folder info"
			message="#[payload]" />
		<box-connector:delete-folder
			doc:name="Delete folder" config-ref="Box_Connector_Config"
			folder-id="#[payload.id]" />
...
----
<?xml version="1.0" encoding="UTF-8"?>
<mule xmlns:box-connector="http://www.mulesoft.org/schema/mule/box-connector" xmlns:ee="http://www.mulesoft.org/schema/mule/ee/core"
...
http://www.mulesoft.org/schema/mule/box-connector http://www.mulesoft.org/schema/mule/box-connector/current/mule-box-connector.xsd">
