...
[[TransformCreateFolderResponse]]
== Transform Create Folder Response
`<box:transform-create-folder-response>`
...
|===
| Name | Type | Description | Default Value | Required
| Expression Executor a| MuleExpressionLanguage |  |  | *x*{nbsp}
| Transformation Service a| TransformationService |  |  | *x*{nbsp}
| Original Output a| Any |  |  | *x*{nbsp}
| Streaming Strategy a| * <<RepeatableInMemoryStream>>
* <<RepeatableFileStoreStream>>
...
| Expression Executor a| MuleExpressionLanguage |  |  | *x*{nbsp}
| Transformation Service a| TransformationService |  |  | *x*{nbsp}
| Input Payload a| Any |  |  | *x*{nbsp}
| Expression a| String |  |  | *x*{nbsp}
| Streaming Strategy a| * <<RepeatableInMemoryStream>>
* <<RepeatableFileStoreStream>>
* non-repeatable-stream |  Configure if repeatable streams should be used and their behaviour |  | {nbsp}
| Target Variable a| String |  The name of a variable on which the operation's output will be placed |  | {nbsp}
...
== Transform Upload File Response
`<box:transform-upload-file-response>`
...
| Transformation Service a| TransformationService |  |  | *x*{nbsp}
| Original Output a| Any |  |  | *x*{nbsp}
| Include Parent Id a| Boolean |  |  false | {nbsp}
| Is Entries Array In Response a| Boolean |  |  false | {nbsp}
| Streaming Strategy a| * <<RepeatableInMemoryStream>>
* <<RepeatableFileStoreStream>>
* non-repeatable-stream |  Configure if repeatable streams should be used and their behaviour |  | {nbsp}
| Target Variable a| String |  The name of a variable on which the operation's output will be placed |  | {nbsp}
...
| Include sub-folders a| Boolean |  |  false | {nbsp}
