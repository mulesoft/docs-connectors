...
Retrieves details for a folder, including the first 100 entries in the folder. To fetch more items within the folder, use the [Get items in a folder](#get-folders-id-items) endpoint. This operation makes an HTTP GET request to the /folders/{folder_id} endpoint. This operation is automatically paginated with offset pagination.
...
This operation is automatically paginated with offset pagination.
