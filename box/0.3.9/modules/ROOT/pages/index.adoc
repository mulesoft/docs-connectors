...
:page-aliases: 3.9@mule-runtime::box-connector.adoc
...
For more information on how to install a connector xref:3.9@mule-runtime::installing-connectors.adoc[click here].
...
To use the Box connector in your Mule application, you must configure a global Box element that can be used by the Box connector (read more about  xref:3.9@mule-runtime::global-elements.adoc[Global Elements]).
...
|*Private Key Path* |Enter the *relative path* of the privateKey in the project. This file needs to be in PEM format.
