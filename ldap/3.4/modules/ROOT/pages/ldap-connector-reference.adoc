...
This means that, if the LDAP server supports paging, this operation will chunks the LDAP search request in pages, and returns then a list with all the results to the rest of the flow.
