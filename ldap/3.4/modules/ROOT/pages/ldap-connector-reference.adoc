...
This means that, if the LDAP server supports paging, this operation chunks in pages the LDAP search requests, and returns then a list with all the results to the rest of the flow.
