= Use Anypoint Studio to Configure LDAP Connector 3.4 - Mule 4
...
After configuring Studio, see the xref:ldap-connector-config-topics.adoc[Additional Configuration Information] topic for more configuration steps.
