...
connection fields.
+
For information about configuring the SSL, Secure SSL, and TLS connection types, see <<ssl-connection-type,Configure an SSL Connection Type>>, <<secure-ssl-connection-type,Configure a Secure SSL Connection Type>>, and <<tls-connection-type,Configure a TLS Connection Type>>.
+
