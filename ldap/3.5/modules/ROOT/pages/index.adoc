...
LDAP Connector connections use Basic authentication (username and password) to access the Active Directory. The connector supports three types of configurations:
...
For more information about configuring connection types, see xref:ldap-connector-use-studio.adoc[Use Studio to Configure LDAP Connector].
