...
*Note:* This kind of communications are not encrypted. If running in an instance configured with mule.security.model=fips140-2, attempting to use a Basic connection will result in an LDAP:SECURITY error.
