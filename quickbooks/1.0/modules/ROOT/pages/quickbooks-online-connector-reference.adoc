= QuickBooks Online Connector 1.0 Reference 

[IMPORTANT]
====
*AccountRef.name Field Change in the QuickBooks Accounting API*

For all entities and transactions that include the `AccountRef` field in the Accounting API response, the `AccountRef.name` field currently returns values inconsistently. QuickBooks Online will start returning the `FullyQualifiedName` in the `AccountRef.name` field going forward.

This change applies to `AccountRef` and all other fields that reference an Account object, including:
...
* `ExpenseAccountRef.name`
* `AssetAccountRef.name`

This change was implemented in Sandbox starting March 30, 2026, and in Production starting April 30, 2026.

*Note:* Write operations are not impacted. When writing data on transactions or entities, your request payload must contain the correct Account ID in the `AccountRef.value` field. You do not need to pass the name or `FullyQualifiedName` in your request.

MuleSoft recommends that you always use the `AccountRef.value` field when querying for account data to avoid being impacted by this change.

For more information, see the https://medium.com/intuitdev/upcoming-changes-to-accounting-apis-that-may-impact-your-application-023386ca2c52[Intuit developer announcement on upcoming Accounting API changes].
====
...
| Base Uri a| String |  Parameter base URI, each instance/tenant gets its own |  `\https://sandbox-quickbooks.api.intuit.com/v3/company/{companyId}` |
...
Report - General Ledger Method : GET Docs - https://developer.intuit.com/app/developer/qbo/docs/api/accounting/all-entities/general%20ledger This operation makes an HTTP GET request to the /reports/GeneralLedger endpoint
...
Report - Inventory Valuation Summary Method : GET Docs - https://developer.intuit.com/app/developer/qbo/docs/api/accounting/all-entities/inventory%20valuation This operation makes an HTTP GET request to the /reports/InventoryValuationSummary endpoint
...
Report - Item Sales Method : GET Docs - https://developer.intuit.com/app/developer/qbo/docs/api/accounting/all-entities/sales%20by%20product This operation makes an HTTP GET request to the /reports/ItemSales endpoint
...
Report - Profit and Loss Method : GET Docs - https://developer.intuit.com/app/developer/qbo/docs/api/accounting/all-entities/profit%20and%20loss This operation makes an HTTP GET request to the /reports/ProfitAndLoss endpoint
...
Report - Profit and Loss Detail Method : GET Docs - https://developer.intuit.com/app/developer/qbo/docs/api/accounting/all-entities/profit%20and%20loss%20detail This operation makes an HTTP GET request to the /reports/ProfitAndLossDetail endpoint
...
Report - Trial List Method : GET Docs - https://developer.intuit.com/app/developer/qbo/docs/api/accounting/all-entities/transaction%20list This operation makes an HTTP GET request to the /reports/TransactionList endpoint
...
Report - Trial Balance Method : GET Docs - https://developer.intuit.com/app/developer/qbo/docs/api/accounting/all-entities/trial%20balance This operation makes an HTTP GET request to the /reports/TrialBalance endpoint
...
Report - Vendor Balance Method : GET Docs - https://developer.intuit.com/app/developer/qbo/docs/api/accounting/all-entities/vendor%20balance This operation makes an HTTP GET request to the /reports/VendorBalance endpoint
...
Report - Vendor Balance Detail Method : GET Docs - https://developer.intuit.com/app/developer/qbo/docs/api/accounting/all-entities/vendor%20balance%20detail This operation makes an HTTP GET request to the /reports/VendorBalanceDetail endpoint
...
Report - Vendor Expense Method : GET Docs - https://developer.intuit.com/app/developer/qbo/docs/api/accounting/all-entities/expenses%20by%20vendor This operation makes an HTTP GET request to the /reports/VendorExpenses endpoint
