...
For complex scenarios, use the xref:anypoint-code-builder::acb-component-transform.adoc[Transform Message Component].

See xref:anypoint-code-builder::acb-component-set-payload.adoc[] for information about configuring the operation. 
...
. Click the *New* component on the canvas.
. In the *General* tab:
.. Select the *Class* that contains the method to use, in this case it is `com.me.TaxCalculator`.
