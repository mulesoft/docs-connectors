...
When you create a new Anypoint Code Builder project, `src/main/java` and `/src/test/java` folders are created. For existing projects, you can manually create these folders. 
...
Invokes methods with the provided arguments using a specified class instance. The identifier of the method to invoke includes the class and method names.
