...
When you create a new Anypoint Code Builder project, `src/main/java` and `/src/test/java` folders are created in the project. For existing projects, you can manually create these folders. 
...
+
Unselect this option if the class instance has to be of the exact same class. 
