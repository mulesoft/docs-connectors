...
image::update-data-from-hyper-file.png[Studio Flow for Update Data from Hyper File]
...
image::append-to-file-upload.png[Studio Flow for Append to File Upload]
...
image::create-project.png[Studio Flow for Create Project]
...
image::delete-project.png[Studio Flow for Delete Project]
...
image::initiate-file-upload.png[Studio Flow for Initiate File Upload]
...
image::publish-datasource.png[Studio Flow for Publish Datasource]
...
image::publish-workbook.png[Studio Flow for Publish Workbook]
...
image::query-projects.png[Studio Flow for Query Projects]
...
image::update-project.png[Studio Flow for Update Project]
