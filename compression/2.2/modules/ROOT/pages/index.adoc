...
Configure the `forceZip64` parameter to `true` to compress files greater than 4 GBs:

[source, xml]
----
<compression:compress doc:name="Compress" doc:id="e0a65016-07a4-4265-82b3-ec11ceb771e2">
       <compression:compressor >
...
Configure the `forceZip64` parameter to `true` to archive files greater than 4 GBs:
