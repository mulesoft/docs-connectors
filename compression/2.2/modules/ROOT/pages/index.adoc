...
The following example shows how to configure the `forceZip64` parameter to `true` to compress files greater than 4 GBs:
...
The following example shows how to configure the `forceZip64` parameter to `true` to archive files greater than 4 GBs:
