...
The following example shows how to configure the *Force ZIP64* field to archive files greater than 4 GBs:
...
The following example shows how to configure the *Force ZIP64* parameter to archive files greater than 4 GBs:
