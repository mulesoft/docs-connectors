...
Compression module provides the *Compress* and *Decompress* operations that enable you to compress or decompress a single file in the configured Gzip or Zip format. 
