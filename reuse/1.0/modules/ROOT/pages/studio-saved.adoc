...
include::connectors::partial$t-studio-topic-intro-partial.adoc[tag::topic-intro]
////
...
include::connectors::partial$t-studio-partial.adoc[[tag::create-project-sect-intro]
////
[[create-mule-project]]
...
* <<link to authentication method 2 and so on>>
...
include::connectors::partial$t-studio-next-step-sect-partial.adoc[]
