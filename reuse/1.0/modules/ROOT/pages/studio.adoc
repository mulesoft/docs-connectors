...
include::connectors::partial$t-studio-partial.adoc[tag=]
////
...
include::connectors::partial$t-studio-partial-2.adoc[create-project-sect-intro]
////
[[create-mule-project]]
...
include::connectors::partial$t-studio-add-connector-sect-intro-partial-2.adoc
////
