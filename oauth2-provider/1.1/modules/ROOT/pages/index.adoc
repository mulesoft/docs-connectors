...
The following documentation assumes a basic knowledge of the OAuth2 authorization protocol. For further reference, see the https://datatracker.ietf.org/doc/html/rfc6749[RFC-6749].
