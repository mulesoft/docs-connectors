...
| Discovery Service Enabled a| Boolean |  Feature switch for automatic service discovery.  If disabled, the service discovery relative path is not applied. | `true` |
