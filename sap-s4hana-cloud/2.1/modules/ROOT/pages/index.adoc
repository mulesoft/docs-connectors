= SAP S/4HANA OData Connector 2.1 - Mule 4

Support Category: https://www.mulesoft.com/legal/versioning-back-support-policy#anypoint-connectors[Premium]


Anypoint Connector for SAP S/4HANA OData (SAP S/4HANA OData Connector) provides full support for the query, get, create, update, delete entities, execute functions, and execute batch requests using the OData API exposed by SAP S/4HANA Cloud and on-premises.
...
* Have a developer account or other valid SAP S4/HANA instance
