...
* SAP S/4HANA OData Connector now provides support for old pagination logic (version 2.6.2 and earlier) in Query Operation.
To support this, a Legacy Pagination checkbox have been added in the Advanced tab of the Query Operation.
