= SAP S/4HANA OData Connector 2.4 Reference 
...
** MINUTES
** HOURS
** DAYS |  Time unit a cache entry will be kept in the cache until evicted. |  MINUTES |
...
** MINUTES
** HOURS
** DAYS |  The time unit to check for expired EDM objects in the ObjectStore. |  MINUTES |
