= SAP S/4HANA OData Connector 2.9 - Examples - Mule 4
...
image::sap-hana-create.png["Studio flow with Listener, Transform Message, Get entity, Transform Message, and Logger"]
image::sap-hana-get.png["Studio flow with Listener, Transform Message, Delete entity, Transform Message, and Logger"]
image::sap-hana-query.png["Studio flow with Listener, Query, Transform Message, and Logger"]
image::sap-hana-update.png["Studio flow with Listener, Transform Message, Update entity, Get entity by key, Transform Message, and Logger"]
image::sap-hana-execute.png["Studio flow with Listener, Transform Message, Execute function, Transform Message, and Logger"]
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd">
  ...
  <properties>
    ...
    <mule.maven.plugin.version>3.2.8</mule.maven.plugin.version>
  </properties>
