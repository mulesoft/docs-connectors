...
. On the *Database Config* window, for *Connection* select any of the connection types to provide to this configuration: 
...
The following screenshot shows the Database Connector Global Configuration window in Anypoint Studio:

.Database Connector Global Configuration
image::database-connector-configuration.png[Database Connector Global Configuration]
