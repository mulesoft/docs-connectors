...
This occurs when executing an invalid SQL statement or expecting that an error within a set of statements will collapse the procedure. In fact, JDBC returns a series of `ResultSets`, `UpdateCounts`, and `Exceptions`.
