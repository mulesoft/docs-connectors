...
If your Mule app requires operations bound to XA transactions, and the connection pooling is enabled for the database configuration in use, the default connection pool implementation for the Data Source Reference Connection is Enhydra XAPool.
