...
:page-aliases: 3.9@mule-runtime::database-batch-task.adoc
...
* xref:3.9@mule-runtime::file-connector.adoc[File Connector]
* xref:3.9@mule-runtime::batch-processing.adoc[Batch Processing]
* xref:3.9@mule-runtime::poll-reference.adoc[Poll Scope]

// FER: ATTACHMENT MISSING. HIDING FOR NOW.
// * link:_attachments_/batch-example.xml.zip[Download XML code for this example]
