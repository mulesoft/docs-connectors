...
4+|*General tab*
|*Parameter Name* |Parameterized Stored Procedure |Use to identify a named parameter in your SQL statement for which you wish to use the value at runtime, when your application submits your query which calls upon stored in the database instance. .4+|image:stored-procedure.png[]
...
* Learn more about xref:5.x@studio::datamapper-user-guide-and-reference.adoc[DataMapper].
