...
All databases that are not configured <<Configuring Database Engines Supported Out of the Box>> must be added through the generic database instalation, and then configured accordingly.
