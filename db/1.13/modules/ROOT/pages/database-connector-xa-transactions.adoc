...
For a DataSource connection, refer to the xref:database-connector-connection.aodc#configure-a-data-source-reference-connection-when-in-xa-transaction-mode[Configure a Data Source Reference Connection When in XA Transaction Mode] documentation. 
