...
* xref:database-xa-transactions.adoc[Using XA Transactions in Database Connector] +
Configure the *Use XA Transactions* field in the Database Connector global configuration so the datasource supports Extended Architecture transactions.
