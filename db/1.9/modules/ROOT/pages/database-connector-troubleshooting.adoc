...
* DB:CONNECTIVITY
 ...
 Any of several possible connectivity issues, including poorly configured connections, lack of database response waiting results or fetching rows, loss of database connection, and so on.
