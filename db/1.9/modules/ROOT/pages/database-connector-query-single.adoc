...
Although you invoke the *Query single* operation in the same way as you invoke the *Select* operation, you always get a single result, regardless of the number of records returned by the actual SQL query.
