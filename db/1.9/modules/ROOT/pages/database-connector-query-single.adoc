...
You invoke the *Query single* operation in the same way as you invoke the *Select* operation; however, you always get a single result using *Query single*, regardless of the number of records returned by the actual SQL query.
