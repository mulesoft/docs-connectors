...
image::../images/database-query-single-flow.png[Query a single record from a database flow]
...
image::../images/database-querysingle-example-1.png[The HTTP Listener global element configuration]

The following screenshots show the Database global element configuration:

.Database Config General configuration
image::../images/database-querysingle-example-2.png["The database general configuration setting the Host, Port, User, and Password fields."]
...
image::../images/database-querysingle-example-3.png[The Set Variable component configuration]
...
image::../images/database-querysingle-example-4.png[For Each configuration]
+
[start=3]
...
image::../images/database-querysingle-example-5.png[Query single configuration]
+
[start=7]
...
image::../images/database-querysingle-example-6.png[Set Payload configuration]
