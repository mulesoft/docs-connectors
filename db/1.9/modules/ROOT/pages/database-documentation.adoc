...
This operation does not support streaming, and indicates that the access to the results are done without any additional transformations to the payload. This behavior is identical to the the *Query Single* operation released on version 1.9.
