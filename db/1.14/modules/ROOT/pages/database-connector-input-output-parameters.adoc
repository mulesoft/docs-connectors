...
A *Stored procedure* operation returns data in a format that differs from what it expects. The limitation applies to all database vendors. To illustrate this behavior, consider the following scenario: +
