...
For an example with Oracle database, check out Oracle's Constant Field Values page (section oracle.jdbc.OracleTypes) for the correct id/type name combination.
...
For an example with Oracle database, check out their Constant Field Values page (section oracle.jdbc.OracleTypes) for the correct id/type name combination.
