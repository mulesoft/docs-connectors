...
Some drivers, however, load all results upon query execution, which means streaming does not work. For example, sometimes Postgres drivers load all results into memory.
