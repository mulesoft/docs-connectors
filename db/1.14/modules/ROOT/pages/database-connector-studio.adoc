= Using Anypoint Studio to Configure Database Connector 1.14 - Mule 4
:page-aliases: connectors::db/database-connector-studio.adoc, connectors::db/database-connector-design-center.adoc
