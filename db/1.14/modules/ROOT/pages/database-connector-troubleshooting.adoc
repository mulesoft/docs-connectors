...
If a query or stored procedure takes more than 15 ~ 30 minutes to execute, the connection might get closed by the firewall or network devices due to inactivity.
