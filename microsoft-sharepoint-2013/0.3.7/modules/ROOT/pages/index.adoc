...
:page-aliases: 3.7@mule-runtime::microsoft-sharepoint-2013-connector.adoc
...
Note: To filter by a datetime field type you need to write the value using ISO8601 format when specified in a DSQL clause (for example, Created > 2000-01-01T00:00:00-03:00).
...
To upload large files you need to configure your Sharepoint and IIS servers:
...
* xref:3.7@mule-runtime::transformers.adoc[Studio Transformers]
*  xref:3.7@mule-runtime::flow-reference-component-reference.adoc[Flow References]
