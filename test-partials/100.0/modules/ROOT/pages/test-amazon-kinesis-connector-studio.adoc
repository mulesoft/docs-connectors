...
include::connectors::partial$t-studio-first-paragraphs-partial.adoc[]
...
include::connectors::partial$t-studio-configure-source-sect-intro-partial.adoc[]

include::connectors::partial$t-studio-configure-listener-sect-partial.adoc[]
...
include::connectors::partial$t-studio-add-connector-operation-sect-intrl-partial.adoc[]
