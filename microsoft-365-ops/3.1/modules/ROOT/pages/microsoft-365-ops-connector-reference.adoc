= Microsoft Dynamics 365 For Operations Connector 3.1 Reference 
...
Performs the acknowledgment action for the downloaded data package from a recurring job, as described in https://learn.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/recurring-integrations[this link].
...
Creates a new entity. Refer to https://learn.microsoft.com/en-us/previous-versions/dynamicscrm-2016/developers-guide/gg328090(v=crm.8)?redirectedfrom=MSDN[this link] for creating an entity and https://learn.microsoft.com/en-us/previous-versions/dynamicscrm-2016/developers-guide/mt607875(v=crm.8)?redirectedfrom=MSDN[this link] for associating an entity upon creation.
...
Performs the dequeue action for the activity specified, as described in https://learn.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/recurring-integrations[this link].
...
Returns a data package that contains all of the data entities defined in the data project as described in https://learn.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/recurring-integrations[this link].
