...
* <<Dynamics365ForOperations_Oauth2, Oauth2>> {nbsp}
* <<Dynamics365ForOperations_Oauth2UserPassword, (DEPRECATED) Oauth Username Password>> {nbsp}
 | The connection types to provide for this configuration. | | *x*{nbsp}
