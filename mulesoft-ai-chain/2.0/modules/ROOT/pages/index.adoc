= MuleSoft AI Chain Connector 2.0 
...
MuleSoft AI Chain Connector supports 16 operations, categorized into:
...
* xref:mulesoft-ai-chain-connector-upgrade-migrate.adoc[Upgrading and Migrating MuleSoft AI Chain Connector to 2.x]
