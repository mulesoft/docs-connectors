= MuleSoft AI Chain Connector 1.0 Reference 
...
| File Path a| String | File path. |  | x
...
** MINUTES
** HOURS
** DAYS |  Time unit to use for the LLM timeout. |  SECONDS | 
| Max Tokens a| Number | Defines the number of LLM tokens to use when generating a response. |  500 | 
...
| Dataset a| String |  Refers to the user query to act upon. |  #[payload] | 
| Template a| String |  Refers to sample template used by LLM to respond adequately to the user queries. |  | x
| Instructions a| String |  This provides instructions to the LLM about how to understand and respond to the user queries. |  | x
...
| Memory Name a| String |  Name of the memory to fetch for further processing by the LLMs. |  | x
| Db File Path a| String |  Location of the file containing the memory. |  | x
| Max Messages a| Number |  Maximum number of messages to analyze for that memory. |  | x
| Output Mime Type a| String |  The MIME type of the payload that this operation outputs. |  | 
| Output Encoding a| String |  The encoding of the payload that this operation outputs. |  | 
| Config Ref a| ConfigurationProvider |  Name of the configuration to use to execute this component. |  | x
| Streaming Strategy a| * <<RepeatableInMemoryStream>>
...
| Name | Type | Description | Default Value | Required
| Configuration | String | Name of the configuration to use. | | x
| Data a| String |  The user prompt or query. |  #[payload] | 
| Store Name a| String |  Name of the store to query. |  | x
| Get Latest a| Boolean |  Determines whether to freshly fetch the store from the location. |  false | 
| Output Mime Type a| String |  The MIME type of the payload that this operation outputs. |  | 
| Output Encoding a| String |  The encoding of the payload that this operation outputs. |  | 
| Config Ref a| ConfigurationProvider |  Name of the configuration to use to execute this component. |  | x
| Streaming Strategy a| * <<RepeatableInMemoryStream>>
...
| Name | Type | Description | Default Value | Required
| Configuration | String | Name of the configuration to use. | | x
| Data a| String |  The user prompt. |  #[payload] | 
| Output Mime Type a| String |  The MIME type of the payload that this operation outputs. |  | 
| Output Encoding a| String |  The encoding of the payload that this operation outputs. |  | 
| Config Ref a| ConfigurationProvider |  Name of the configuration to use to execute this component. |  | x
| Streaming Strategy a| * <<RepeatableInMemoryStream>>
...
| Configuration | String | Name of the configuration to use. | | x
| Data a| String |  The user prompt. |  #[payload] | 
| Context URL a| String |  Image URL to analyze. |  | x
| Output Mime Type a| String |  The MIME type of the payload that this operation outputs. |  | 
| Output Encoding a| String |  The encoding of the payload that this operation outputs. |  | 
| Config Ref a| ConfigurationProvider |  Name of the configuration to use to execute this component. |  | x
| Streaming Strategy a| * <<RepeatableInMemoryStream>>
...
| Configuration | String | Name of the configuration to use. | | x
| Data a| String |  The user prompt. |  #[payload] | 
| File Path a| String |  Path to the file to analyze. |  | x
...
| Context Path a| String |  Defines the file path that is embedded. |  | x
| Output Mime Type a| String |  The MIME type of the payload that this operation outputs. |  | 
| Output Encoding a| String |  The encoding of the payload that this operation outputs. |  | 
| Config Ref a| ConfigurationProvider |  Name of the configuration to use to execute this component. |  | x
| Streaming Strategy a| * <<RepeatableInMemoryStream>>
...
| Name | Type | Description | Default Value | Required
| Configuration | String | Name of the configuration to use. | | x
| Data a| String |  Refers to the user input to analyze. |  #[payload] | 
| Output Mime Type a| String |  The MIME type of the payload that this operation outputs. |  | 
| Output Encoding a| String |  The encoding of the payload that this operation outputs. |  | 
| Config Ref a| ConfigurationProvider |  Name of the configuration to use to execute this component. |  | x
| Streaming Strategy a| * <<RepeatableInMemoryStream>>
...
| Context Path a| String |  Refers to the location of the file to process. |  | x
...
| Name | Type | Description | Default Value | Required
| Store Name a| String |  Name of the embedding store. |  | x
| Context Path a| String |  Refers to the location of the folder to process. |  | x
| Max Segment Size In Chars a| Number |  Max allowed size of continuous sequence of characters while embedding. |  | x
| Max Overlap Size In Chars a| Number |  Max size of overlapping characters allowed while embedding. |  | x
| Output Mime Type a| String |  The MIME type of the payload that this operation outputs. |  | 
| Output Encoding a| String |  The encoding of the payload that this operation outputs. |  | 
...
| Name | Type | Description | Default Value | Required
| Store Name a| String |  Name of the embedding store. |  | x
| Question a| String |  The user prompt or query. |  #[payload] | 
