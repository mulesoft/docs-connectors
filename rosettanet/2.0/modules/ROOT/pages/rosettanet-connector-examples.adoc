...
The second flow of the Buyer app receives a purchase order confirmation message from the seller and logs details about the message. 
...
Add a *Logger* component to log a message that includes information about the purchase order confirmation message:
...
. Receives an acknowledgment signal from the Buyer app and logs information about the Acknowledgement signal.
...
The second flow of the Seller app receives a purchase order request message from the Buyer app and logs information about the request.

==== Configure the Action Source

Configure the *Action* source to receive the purchase order request message. 
...
Add a *Logger* component to log information about the purchase order request message:
