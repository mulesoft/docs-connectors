...
image::tracing-module-set-logging-variable.png["A set logging variable operation configuration window"]
...
image::tracing-module-set-logging-variable-flow.png["A set logging variable flow in Studio canvas"]
