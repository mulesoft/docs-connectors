= Using Anypoint Studio to Configure Tracing Module 1.2
...
image::tracing-module-operations.png["A Mule Palette including Tracing module operation and scope in Anypoint Studio"]
