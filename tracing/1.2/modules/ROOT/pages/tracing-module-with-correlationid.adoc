...
image::tracing-module-scope-flow.png["A flow showing a With CorrelationID scope flow"]
...
+
image::tracing-module-with-correlationid.png["A With CorrelationID scope configuration window with Correlation ID field"]
[start=16]
