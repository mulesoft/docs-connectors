...
* The installation is supported on Windows Server 2008 and later versions, with .NET Framework 4.5 or later (including 4.7, 4.8, and 4.8.1 depending on the Windows version).
