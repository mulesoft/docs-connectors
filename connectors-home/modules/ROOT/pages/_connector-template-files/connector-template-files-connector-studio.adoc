...
// If the connector supports TLS, add this partial with the plus sign before it:
// include::connectors::partial$t-studio-partial.adoc[tags=global-element-tls]
...
== Next Step
// Include this partial if the doc includes an Additional Configuration topic:

include::connectors::partial$t-studio-partial.adoc[tags=next-step-config-topics]

// Otherwise, include this partial

include::connectors::partial$t-studio-partial.adoc[tags=next-step-reference]
