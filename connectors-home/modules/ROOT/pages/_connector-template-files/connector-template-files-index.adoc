...
For a major or minor release, see xref:connector-template-files-connector-upgrade-migrate.adoc[Upgrading and Migrating-{connector-name}-Connector to <major or minor version>].
////
