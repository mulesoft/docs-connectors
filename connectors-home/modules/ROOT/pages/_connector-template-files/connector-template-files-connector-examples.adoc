= <Connector name> Connector <version> - Examples 
...
////
For an example of this template, see NetSuite Connector 10.0 Examples. Consider using the Template for Including Multiple Examples in One Examples Topic if you have multiple, unrelated examples.
////
