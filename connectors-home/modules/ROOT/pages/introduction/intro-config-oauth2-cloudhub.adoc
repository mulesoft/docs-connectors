...
If your Salesforce instance doesn't support HTTP or HTTPS callback URLs with private cloud URLs, you can update the callback URL to use a public endpoint.
====
+
