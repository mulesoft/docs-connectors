...
You can configure a connector using xref:introduction/intro-config-use-studio.adoc[Anypoint Studio] or xref:introduction/intro-config-xml-maven.adoc[XML].
...
Instead of using static values for a connector configuration in Studio, you can use https://ant.apache.org/[Ant-style] property placeholders, as shown in this Studio example:
...
image::intro-config-overview-studio-test.png["Test the connection button in Studio"]
