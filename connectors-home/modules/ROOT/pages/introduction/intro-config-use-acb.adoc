...
To update a connector to a newer version in Anypoint Code Builder, see xref:anypoint-code-builder::int-versions.adoc#project-versions-connectors[Select Connector Versions for a Project].
