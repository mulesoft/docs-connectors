...
You can update a connector to a newer version in Anypoint Studio. For instructions, see xref:studio::update-modules.adoc[].
...
+
This screenshot shows the default values for the scheduling strategy:
+
