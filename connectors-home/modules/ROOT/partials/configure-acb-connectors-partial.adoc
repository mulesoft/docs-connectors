...
|Streaming Strategy | This attribute is not currently enabled in the configuration UI. Configure it in the XML editor. See xref:connectors::partial$streaming-strategies.adoc[].
