...
include::connectors::partial$acb-reusable-steps.adoc[tags="proj-directory-warn"]
|===
...
* *Allowed methods*
+
Comma-separated list of allowed HTTP methods by this listener. To allow all methods (default), do not define this attribute. To restrict certain methods, specify allowed methods, for example, GET, POST. 
+
