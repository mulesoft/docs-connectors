...
Create a basic integration project, add connectors and other components to your Mule application to process your business logic, and configure attributes.
