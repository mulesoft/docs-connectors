...
. In the *General* tab, enter the relative path for the path set in the HTTP configuration element in *Path*. See xref:connectors::http-listener-ref.adoc#configure-paths[Configure Paths]. 
