...
//Add this step if the connector supports TLS
. On the *TLS* tab, optionally specify the TLS information for the connector.
...
tag::next-step-additional-config[]
After you configure a global element and connection information, configure the other fields for the connector. See xref:{lc-connector-name}-connector-examples[{connector-name} Connector Examples] for use cases.
end::next-step-additional-config[]

tag::next-step-reference[]
After you configure a global element and connection information, configure the other fields for the connector. See xref:c{lc-connector-name}-connector-examples.adoc[{connector-name} Connector Examples] for use cases.
