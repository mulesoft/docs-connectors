...
Inside the `<version>` tags, put a version number, RELEASE for the latest release, or SNAPSHOT for the latest available version. See https://www.mulesoft.com/exchange/org.mule.modules/mule-module-marketo/[Anypoint Exchange] for version values.
