...
+
xref:image::azure-data-lake-create-path-filling-values.png[General properties configuration for Create/Rename Path operation]
+
. Save the project.
...
xref:image::azure-data-lake-update-path-setting-up-the-flow-2.png[Listener General properties configuration]
...
. Click *Finish*.
+
xref:image::azure-data-lake-update-path-adding-file-connector.png[Add File Connector from Exchange to your flow]
+
...
+
xref:image::azure-data-lake-update-path-using-the-file-connector-2.png[Read operation General properties configuration]
...
xref:image::azure-data-lake-update-path-using-the-file-connector-3.png[General properties configuration for the Set Variable component]
...
`payload`
+
xref:image::azure-data-lake-update-path-using-update-append.png[General configuration properties with example values for the Update Path operation with the `append` action]
+
. Save the project.
...
`0`
+
xref:image::azure-data-lake-update-path-using-update-flush.png[General configuration properties with example values for the Update Path operation with the `flush` action]
+
. Save the project.
...
+
xref:image::azure-data-lake-error-handling-setting-up-1.png[Drag the On Error Continue component to the flow]
+
. From the *Mule Palette* view, drag *Core > Transform Message* to the flow:
+
xref:image::azure-data-lake-error-handling-setting-up-2.png[Drag the Transform Message component to the flow]
+
...
+
xref:image::azure-data-lake-error-handling-setting-up-3.png[Expression to access the error code that comes from the Azure service]
+
To access the error message, the expression is: +
`error.muleMessage.typedValue.error.message`

xref:image::azure-data-lake-error-handling-setting-up-4.png[Expression to access the error message]
