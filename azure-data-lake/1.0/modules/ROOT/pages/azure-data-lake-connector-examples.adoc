= Azure Data Lake Storage Connector Examples 
...
. Click *Finish*.
+
image::azure-data-lake-update-path-adding-file-connector.png["File Connector added from Exchange to your flow"]
+
...
+
image::azure-data-lake-error-handling-setting-up-1.png["On Error Continue component dragged to the flow"]
+
. From the *Mule Palette* view, drag *Core > Transform Message* to the flow:
+
image::azure-data-lake-error-handling-setting-up-2.png["Transform Message component dragged to the flow"]
+
