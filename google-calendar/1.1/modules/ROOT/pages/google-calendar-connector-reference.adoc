...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | *x*
| Calendar Id a| String |  Calendar identifier. To retrieve calendar IDs call the calendarList.list method. |  | *x*
| Updated Min a| String |  Lower bound for an event''s last modification time (as a RFC3339 timestamp) to filter by. |  | *x*
