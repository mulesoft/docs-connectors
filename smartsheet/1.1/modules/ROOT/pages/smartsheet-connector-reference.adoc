= Smartsheet Connector 1.1 Reference - Mule 4
...
| If Version After (DEPRECATED) a| Boolean | (DEPRECATED) This parameter will be removed in future releases. Use the ifVersionAfter parameter with an integer value instead. |  false |
| If Version After a| Number | Specifies the version of sheet to be returned. |  |
