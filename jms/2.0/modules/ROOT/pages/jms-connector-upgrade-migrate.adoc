...
* JMS Connector now provides separate connection types for XA and non-XA transactions. In Anypoint Studio and the connectors UI, you now select *ActiveMQ XA Connection* or *Generic XA Connection* to use XA transactions, instead of enabling XA on a single connection through the *Enable xa* option.
