...
. In your *JMS Config*, select the *ActiveMQ XA Connection* connection type, and configure the *XA Connection Pool* fields for *Min pool size*, *Max pool size*, and *Max idle seconds*:
