...
Some of these properties are well-known JMS standards, but others depends on the implementation or custom user configurations. The `publish` operation allows you to configure all this properties directly in the Message.
