= JMS Connector Reference 1.7 - Mule 4
...
|===
| Field | Type | Description | Default Value | Required
| Durable a| Boolean | Indicate if messages will be cached when the client is not connected | false |
| Shared a| Boolean | Indicates uf the subscription will be shared among consumers | false |
| No Local a| Boolean |  inhibit the delivery of messages published by its own connection | false |
| Subscription Name a| String | The subscription name |  |
|===
...
|===
| Field | Type | Description | Default Value | Required
| Session Cache Size a| Number | The size of the session cache |  |
| Cache Producers a| Boolean | Indicates if the producer is cached | true |
| Cache Consumers a| Boolean | Indicates if the consumer is cached | true |
|===
...
|===
| Field | Type | Description | Default Value | Required
| Context Factory a| Object | The fully qualified class name of the factory class that will create the initial context|  |
