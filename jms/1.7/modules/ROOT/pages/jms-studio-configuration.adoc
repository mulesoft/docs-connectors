...
.JMS Config required libraries for ActiveMQ Connection
image::jms-libraries-activemq.png[In the Required Libraries section of the JMS Config, that shows the ActiveMQ KahaDB, ActiveMQ Broker, and ActivMQ Client libraries, click the Configure button to install the dependency]
...
.JMS Config required libraries for Generic Connection
image::jms-libraries-generic.png[In the Required Libraries section of the JMS Config, that shows JMS Client library, click the Configure button to install the dependency]
