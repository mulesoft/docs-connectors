...
To configure the connection in the global element, define the connection by selecting either *ActiveMQ Connection* or *Generic Connection*, to set up the connection libraries and the JMS specification. +
