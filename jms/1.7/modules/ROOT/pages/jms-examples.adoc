...
Configure the *Publish consume* operation to publish and consume messages within two flows, and uses a correlation id to ensure that the incoming messages are the proper reply of the outgoing message.
