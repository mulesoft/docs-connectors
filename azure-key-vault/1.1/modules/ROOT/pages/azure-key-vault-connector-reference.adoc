...
| Uri Override a| String |  The URI override for the key vault. If you configure this field, then the vault name is not taken into account. If the key vault is not located on Azure Commercial cloud then configure this field. |  | 
