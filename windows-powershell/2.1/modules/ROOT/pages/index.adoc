...
* Linux (Ubuntu) +
. Follow the https://documentation.ubuntu.com/server/[SSH installation steps].
. Follow https://learn.microsoft.com/en-us/powershell/scripting/install/installing-powershell-core-on-linux?view=powershell-6[install PowerShell on Linux] from Microsoft.
...
+
image::microsoft-powershell-config-global-wizard.png["Choose Global Type window with list of configurations"]
+
...
+
image::microsoft-powershell-config.png["Global element properties window with Windows configuration"]
