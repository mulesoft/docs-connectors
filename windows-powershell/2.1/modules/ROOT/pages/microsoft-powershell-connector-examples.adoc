...
image::microsoft-powershell-execute-command.png["Flow with Listener, Execute command, and Logger"]
...
+
image::microsoft-powershell-http-props.png["Listener configuration values in properties window"]
+
...
+
image::microsoft-powershell-config.png["Global element properties window for Windows configuration"]
+
...
+
image::microsoft-powershell-execute-command-props.png["Execute command operation properties window"]
+
...
.. Set *Level* to `INFO`:
+
image::microsoft-powershell-logger-props.png["Logger properties window"]
+
. Click *File > Save*.
...
image::microsoft-powershell-execute-script-file-flow.png["Flow with Listener, Parse Template, Execute script file, and Logger"]

To create the Mule flow:

. Drag an *HTTP Listener* component onto the canvas and enter `Listener` for *Display Name*:
+
image::microsoft-powershell-http-execute-script-file.png["Listener configuration values in properties window"]
+
...
+
image::microsoft-powershell-parse-template-props.png["Parse Template configuration values in properties window"]
+
...
+
image::microsoft-powershell-execute-script-file.png[["Execute script file operation configuration values in properties window"]
+
...
* https://documentation.ubuntu.com/server/[Linux Install SSH]
