...
:page-aliases: 3.8@mule-runtime::generic-connector.adoc
...
xref:3.8@mule-runtime::endpoint-configuration-reference.adoc#transformers[Nest transformers] inside your generic connector from its configured endpoint(s).
