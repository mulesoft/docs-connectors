...
Upgrade Anypoint Connector for Salesforce (Salesforce Connector) from version 9.x or 10.x to version 10.9.
...
*  Deprecated the xxx field for the Replay Channel Listener source
