...
[NOTE]
---
If you have multiple workers deployed in CloudHub, the same messages are processed by all instances of the app when using the *Replay Topic* or *Replay Channel* operations.  
