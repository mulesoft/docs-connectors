...
:page-aliases: connectors::salesforce/v10.1/salesforce-connector-reference-101.adoc
...
See the
xref:index.adoc[Salesforce Connector v10.1 guide] for usage information.
...
Although uncommon, there are cases in which you might want to disable the repeatable stream functionality and use non repeatable streams, for example, in cases where you don't want to pay for extra memory or have performance overhead.
