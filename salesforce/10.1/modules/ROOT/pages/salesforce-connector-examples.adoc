= Salesforce Examples v10.1 - Mule 4
:page-aliases: connectors::salesforce/v10.1/salesforce-connector-101-examples.adoc
...
MyCustomObject must hold a relationship to a MyOtherCustomObject. When upserting a `MyCustomObject`, the POJO sent as input to Salesforce Connector looks like this:
