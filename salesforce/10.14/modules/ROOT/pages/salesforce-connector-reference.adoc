...
| Name | Type | Description | Default Value | Required
| Configuration | String | Name of the configuration to use. | | x
| List of Merge Records a| Array of <<MergeRecord>> |  List of merge records. Each merge record contains the primaryRecord, the recordToMergeIds, and an optional additionalInformationMap. |  `#[payload]` |
