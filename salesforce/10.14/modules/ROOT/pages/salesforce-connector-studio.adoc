= Using Anypoint Studio to Configure Salesforce Connector 10.14 - Mule 4
...
[NOTE]
Currently the OAuth SAML Authentication allows only using Salesforce as an Identity Provider. See this https://help.salesforce.com/s/articleView?id=sf.sso_sfdc_idp_saml_parent.htm&type=5[documentation page] for more details of how you can enable Salesforce as an Identity provider.
