...
If the stored replay ID is outside this event retention window, then the replay option selected by the user will determine what events will be replayed.
