= Salesforce Connector 11.3 
:page-aliases: connectors::salesforce/salesforce-connector.adoc, connectors::salesforce-about.adoc, connectors::salesforce-to-work-with-topics.adoc, connectors::salesforce-to-work-with-streaming-channels.adoc, connectors::salesforce-to-receive-custom-events.adoc, connectors::salesforce-about-date-calendar-object-storage.adoc, connectors::salesforce-to-create-bulk-objects.adoc, connectors::salesforce-to-consumer-key.adoc, connectors::salesforce-to-generate-keystore-file.adoc, connectors::salesforce-about-apex-setting.adoc, connectors::salesforce-about-authentication.adoc, connectors::salesforce-about-proxy-settings.adoc, connectors::salesforce-about-threads-concurrency.adoc, connectors::salesforce-about-salesforce-apis.adoc, connectors::salesforce-tips.adoc, connectors::salesforce-xml-ref.adoc
...
* Access to the Salesforce target resource, which requires a  https://developer.salesforce.com[Salesforce developer account] and https://help.salesforce.com/s/articleView?language=en_US&id=user_security_token.htm[Salesforce security token].
+
...
* https://developer.salesforce.com/[Salesforce APIs: What they are and when to use them]
* https://help.salesforce.com/s/articleView?id=integrate_what_is_api.htm&language=en_US&type=5[Which Salesforce API should I use?]
