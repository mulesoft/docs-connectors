= Salesforce Connector 11.3 Examples 
:page-aliases: connectors::salesforce/salesforce-connector-examples.adoc

These examples show several Mule flows for Salesforce Connector:
...
This example shows how to configure Salesforce Connector to create a new Salesforce account and query new accounts, and to use xref:file-connector::index.adoc[File Connector] to write the new account data to a file. The example contains three flows:
...
Add the second *Transform Message* component to convert the field values to JSON format so the values can be used with xref:file-connector::index.adoc[File Connector]:
...
Add the *Transform Message* component to convert the field values to JSON format so the values can be used with xref:file-connector::index.adoc[File Connector]:
