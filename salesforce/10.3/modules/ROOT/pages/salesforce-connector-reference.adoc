...
Only objects of the same type can be merged. For example, Leads can be merged only with Leads.
* The Merge Multiple operation allows users to specify a list of a maximum of 200 Merge Requests.
