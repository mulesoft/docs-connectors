...
Beyond this example, access xref:index.adoc[introductory] and xref:connectors::salesforce/salesforce-connector-reference.adoc[reference] documentation for the Salesforce Connector.
...
* Access xref:connectors::salesforce/salesforce-connector-reference.adoc[full reference documentation] for the Salesforce Connector.
