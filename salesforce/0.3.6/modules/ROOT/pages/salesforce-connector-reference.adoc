...
:page-aliases: 3.6@mule-runtime::salesforce-connector-reference.adoc
...
This page does not list the attributes of each operation. For introductory information, access the xref:index.adoc[Salesforce Connector] documentation.
...
* Access explanatory documentation at xref:index.adoc[Salesforce Connector].
