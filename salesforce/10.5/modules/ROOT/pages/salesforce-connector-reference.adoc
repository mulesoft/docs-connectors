...
| Headers a| Object | Salesforce Headers - https://developer.salesforce.com/docs/atlas.en-us.api_bulk_v2.meta/api_bulk_v2/create_job.htm[More info] |  | {nbsp}
| Read Timeout a| Number |  Specifies the amount of time, in the unit defined in Time unit, for which the consumer waits for a response before it times out. |  |
| Time unit a| Enumeration, one of:
...
| Headers a| Object | Salesforce Headers - https://developer.salesforce.com/docs/atlas.en-us.api_bulk_v2.meta/api_bulk_v2/query_create_job.htm[More info] |  | {nbsp}
| Read Timeout a| Number |  Specifies the amount of time, in the unit defined in Time unit, for which the consumer waits for a response before it times out. |  |
| Time unit a| Enumeration, one of:
