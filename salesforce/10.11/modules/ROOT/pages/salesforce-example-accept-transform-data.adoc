...
* The second flow creates a new Salesforce account based on information in the HTML input form and ...

// Put the flows together here
...
.This flow uses the *Parse Template* component.
...
This flow configures an HTML template to use for providing HTML input to create the table:
