...
* The *Query Result Stream* operation is deprecated. There are two new operations, *Query Result List* and *Query Result Stream By Id*, that should be used instead.
