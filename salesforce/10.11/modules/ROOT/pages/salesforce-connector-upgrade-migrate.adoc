...
Upgrade Anypoint Connector for Salesforce (Salesforce Connector) from version 9.x or 10.x to version 10.11.
...
* Deprecated the Query Result Stream operation.
* Created two new operations that should be used instead of Query Result Stream. The added operations are: Query Result List and Query Result Stream By Id.
