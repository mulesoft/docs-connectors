...
All authentication types support mutual TLS. To use mutual TLS, you need a keystore file and a password for the file. See xref:connectors::salesforce-connector-config-topics.adoc#generate-keystore[Generate a Keystore File] for more information.
