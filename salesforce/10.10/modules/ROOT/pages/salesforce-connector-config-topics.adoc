...
In Salesforce Connector 10.x, to set field values to null, use an *Update* or *Upsert* request operation and set the name of the fields you want to nullify in the *fieldsToNull* field:
