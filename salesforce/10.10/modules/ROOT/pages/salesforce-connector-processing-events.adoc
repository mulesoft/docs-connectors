...
Having multiple sources listening to the same events and having the *Resume form Last Replay ID* option enabled leads to data corruption and potential loss of events.
---
