...
:page-aliases: connectors::salesforce/salesforce-connector-100-studio.adoc
...
See also xref:9.8@salesforce-connector-xml-maven.adoc#apexml[Apex XML Settings].
...
After completing Studio set up, see xref:9.8@salesforce-connector-config-topics.adoc[Additional Configuration Information].
