...
NOTE: If you are adding a new connector for platform events and change data capture events, you can use xref:salesforce-pubsub-connector::index.adoc[Salesforce Pub/Sub Connector], which is based on the Pub/Sub API.
