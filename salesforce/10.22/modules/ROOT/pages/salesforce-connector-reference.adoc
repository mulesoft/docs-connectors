...
Enabling "JSON Web Token-based access tokens" in Salesforce server is intended only for REST API calls and is incompatible with the Salesforce Connector
