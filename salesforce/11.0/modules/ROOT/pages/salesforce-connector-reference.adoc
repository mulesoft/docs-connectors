= Salesforce Connector 11.0 Reference 
...
| Token URL a| String |  Service provider’s token endpoint URL. | `\https://{domain}.my.salesforce.com/services/oauth2/token` |
