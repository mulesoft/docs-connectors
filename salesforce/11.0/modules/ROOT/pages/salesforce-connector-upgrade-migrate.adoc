= Upgrading and Migrating Salesforce Connector to 10.x - Mule 4
:page-aliases: connectors::salesforce/salesforce-connector-100-upgrade-migrate.adoc


Upgrade Anypoint Connector for Salesforce (Salesforce Connector) from version 9.x or 10.x to version 11.0.
