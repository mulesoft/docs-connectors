...
[NOTE]
====
The connector interacts with the Object Store(stores and retrieves data) only when the replay option is *ReplayOption.FROM_LAST_REPLAY_ID* or when the *ReplayOption.FROM_LAST_REPLAY_ID* checkbox is ticked.
====
