...
NOTE: The connector interacts with the Object Store to store and retrieve data only when the *Replay Option* is set to `FROM_LAST_REPLAY_ID` or when the *ReplayOption.FROM_LAST_REPLAY_ID* checkbox is selected.
