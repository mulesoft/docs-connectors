...
Upgrade Anypoint Connector for Salesforce (Salesforce Connector) from version 9.x or 10.x to version 10.13.
...
* Added Query XML Stream operation to be used instead of Query operation, due to a limitation of the Query operation.(SE-22017)
