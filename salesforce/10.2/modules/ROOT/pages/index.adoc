= Salesforce Connector 10.2 - Get Started - Mule 4
:page-aliases: connectors::salesforce/salesforce-connector.adoc, connectors::salesforce/v10.2/salesforce-connector-102.adoc
...
|xref:10.0@salesforce-connector-config-topics.adoc#customevents[Custom Event Notifications] |Get custom event notifications over a streaming channel
...
|xref:10.0@salesforce-connector-config-topics.adoc#eventsandtopics[Topics] |Subscribe to a Salesforce topic
|===
