= Troubleshooting Salesforce Connector 11.1 - Mule 4
...
* SALESFORCE:CONNECTIVITY
 ...
 A problem occurred and a connection could not be established. Review your Salesforce Connector configuration and reconnection strategy. 
