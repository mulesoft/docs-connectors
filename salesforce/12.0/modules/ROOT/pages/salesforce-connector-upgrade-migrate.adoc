...
* The *OAuth Username Password* connection type is removed because Salesforce is retiring the OAuth 2.0 Username-Password flow. Applications that use this connection type fail to deploy on 12.0.0. Migrate to another supported connection type, such as xref:connectors::salesforce/salesforce-connector-reference.adoc#sfdc-config_config-with-oauth[OAuth 2.0], xref:connectors::salesforce/salesforce-connector-reference.adoc#sfdc-config_oauth-client-credentials[OAuth Client Credentials], or xref:connectors::salesforce/salesforce-connector-reference.adoc#sfdc-config_jwt[OAuth JWT].
