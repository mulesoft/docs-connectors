...
* https://help.salesforce.com/s/articleView?language=en_US&id=user_security_token.htm[Salesforce security token]
+
...
* If you are using OAuth authentication, the namespace and schema location are required.
+
...
* New users
+
Read Get Started (this document) and create your Mule app in xref:salesforce-connector-studio.adoc[Anypoint Studio].
+
