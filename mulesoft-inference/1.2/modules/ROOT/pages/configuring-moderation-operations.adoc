...
NOTE: The XML DSL tag used to add these attributes varies by operation, so please refer to the specific operation's documentation to identify the supported tag.
