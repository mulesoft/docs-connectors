...
== Example: MCP Tools
 ...
 This Mule application showcases the use of the *[MCP] Tooling* operation to interact with OpenAI via the MCP connector. This operation enables you to select and run tools based on prompts without manual input via MCP tooling operation. In this example, it is configured to use the tools to check the inventory status for a specific part number, MULETEST0. 
