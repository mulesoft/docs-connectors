...
[start=3]
. In the *Additional Request Attributes* (optional) field, you can pass any additional request attributes in the request payload to generate more relevant and precise LLM outputs. The XML DSL tag for adding these attributes varies with each operation. Refer to the specific operation's documentation to identify the supported tag.
...
+
Streamline operations by offloading time-consuming tasks such as analyzing reported issues, identifying potential resolution paths, and drafting customer communications.
* *Sales Efficiency*
+
Empower sales teams to focus on high-value activities by integrating LLMs into the flow of their daily operations, fast-tracking previous time-intensive processes, including contract authoring and prospect research.
* *Marketing Personalization*
+
Empower marketing teams by infusing AI capabilities natively in the execution of their core responsibilities, such as drafting social media copy, synthesizing market research, and completing campaign analysis.
