...
+
3. In the *Additional Request Attributes* field, you can pass any additional attribute in the request payload to generate more relevant and precise LLM outputs. This step is optional.
...
NOTE:
. The XML DSL tag for adding the additional attributes varies with each operation. Refer to the specific operation's documentation to identify the supported tag.
