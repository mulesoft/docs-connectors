...
NOTE: The *Additional Request Attributes* field allows you to pass a JSON object with additional request attributes. These attributes will be flattened into the root level of the request payload, along with existing standard attributes.
