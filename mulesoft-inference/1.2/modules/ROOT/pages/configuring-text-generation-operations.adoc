...
As a prerequisite, ensure you download the MCP connector from Anypoint Platform Exchange. Note that the Inference connector now supports version 1.2 of the MCP connector.
...
For more information on MCP connector, see xref:mcp-connector-reference.adoc[MCP Connector Reference]
