...
NOTE: The XML DSL tag for adding the additional attributes varies with each operation. Refer to the specific operation's documentation to identify the supported tag.
