...
This operation responds with a JSON payload containing the toxicity detection and rating. The new toxicity attributes are provided as additional attributes within the chat operation and are supported by a few inferences, such as Azure. 
