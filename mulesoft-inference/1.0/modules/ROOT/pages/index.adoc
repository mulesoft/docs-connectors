...
Anypoint Connector for MuleSoft Inference (MuleSoft Inference Connector) provides access to inference offerings for large language models (LLMs) from multiple providers including OpenAI, NVIDIA NIM, Heroku AI, and many others. This connector provides operations to interface directly with the API of various inference providers, enabling seamless integration of AI capabilities into your Mule applications.
...
|Ollama
|Yes |Yes |Yes |Yes |Base64 only |No |No
