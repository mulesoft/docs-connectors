...
As long as you develop a Mule app that uses WebSocket Connector and you deploy Mule into Runtime Fabric, there is no additional configuration required to enable WebSockets Connector in Runtime Fabric.
