= WebSockets Connector Reference 
:page-aliases: connectors::websockets/websockets-connector-reference.adoc

Support Version: https://www.salesforce.com/en-us/wp-content/uploads/sites/4/documents/legal/Agreements/versioning-back-support-policy.pdf[Select]
