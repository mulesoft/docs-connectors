= WebSockets Connector in CloudHub 
...
[NOTE]
For CloudHub 2.0 deployments, a Mule app that supports websockets is deployed in the same manner as any other Mule app deployed to CloudHub 2.0. For details, refer to xref:cloudhub-2::ch2-deploy.adoc[].
