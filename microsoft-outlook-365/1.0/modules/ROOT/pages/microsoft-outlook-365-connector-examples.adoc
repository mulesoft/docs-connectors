...
image::accept-event.png[Studio Flow for Accept Event]
...
image::decline-event.png[Studio Flow for Decline Event]
...
image::list-event-attachments.png[Studio Flow for List Event Attachments]
...
image::add-event-attachment.png[Studio Flow for Add Event Attachment]
...
image::add-message-attachment.png[Studio Flow for Add Message Attachment]
...
image::list-message-attachments.png[Studio Flow for List Message Attachments]
...
image::get-message-attachment.png[Studio Flow for Get Message Attachment]
...
image::get-event-attachment.png[Studio Flow for Get Event Attachment]
...
This Mule flow sends a message from the Drafts folder. The *Create message*
operation created the message previously.
...
image::send-message.png[Studio Flow for Send Message]
...
image::send-mail.png[Studio Flow for Send Mail]
...
image::create-reply-all-to-message.png[Studio Flow for Create Reply All to Message]
...
This Mule flow creates a reply-all message that is sent without creating it first
...
image::reply-all-to-message.png[Studio Flow for Reply All to Message]
