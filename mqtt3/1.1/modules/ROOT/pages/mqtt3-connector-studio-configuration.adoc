= Using Anypoint Studio to Configure MQTT Connector 1.1
...
. Click *OK*.
. In the *On New Message* configuration screen, in *Topics*, select either:
+
* *Edit inline* to define topics directly in the listener.
* *Bean reference* to reuse a predefined set of topic subscriptions.
