...
MQTT Connector works with any MQTT version 3.x compliant server also known as MQTT broker.  To configure the server, refer to your MQTT broker’s documentation,  for example, refer to the https://mosquitto.org/documentation[Eclipse Mosquito] broker documentation.
