...
[NOTE]
The exact bean structure and classes for the `topics-ref` value depend on the connector version. Configure *Topics* as *Bean reference* in Studio and copy the generated XML to ensure that your app uses the correct bean definition.
