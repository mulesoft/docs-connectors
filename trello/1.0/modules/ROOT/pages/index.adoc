...
Trello connections use the <authentication-type> authentication type, which ... <add a brief description of the authentication type like the descriptions below>.
...
Trello connections can use the following authentication types:
...
For information about configuring authentication types, see xref:trello-studio.adoc[Use Studio to Configure Trello Connector].
