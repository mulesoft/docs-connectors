...
After you configure a global element and connection information, see the xref:amazon-ec2-connector-examples.adoc[Examples] topic for more configuration steps.
