...
The example includes configuring global elements for the connector, configuring additional properties such as volume size and type, configuring the Set Payload component, adding and configuring the Logger component, and finally testing your application's use of the connector.
