...
Attaches a network interface to an instance. See Amazon's http://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_AttachNetworkInterface.html[API reference] for this operation.
