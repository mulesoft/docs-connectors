...
=======
| Description a| String |  A new description for the AMI. |  |
| Attribute a| String |  Name of the attribute to modify. |  |
| Operation Type a| String |  Type of operation. |  |
| Launch Permissions a| Array of <<LaunchPermission>> |  A new launch permissions for the AMI. |  |
>>>>>>> 4510f32ab9c690e58bdd7c69eb8711d19942201d
