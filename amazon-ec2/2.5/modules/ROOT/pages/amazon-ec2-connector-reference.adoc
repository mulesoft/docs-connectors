...
|===
| Field | Type | Description | Default Value | Required
| (DEPRECATED) Name a| String | Name of the filter. Filter names are case-sensitive. Use filterName instead in most cases, for example if using the *Edit inline* definition. |  |
