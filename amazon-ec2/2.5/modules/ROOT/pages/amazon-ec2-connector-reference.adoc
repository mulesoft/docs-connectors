...
|===
| Field | Type | Description | Default Value | Required
| (DEPRECATED) Name a| String | Name of the filter, which is case-sensitive. In case of using "Edit inline" definition use filterName instead. |  |
| Filter Name a| String | The name of the filter. Filter names are case-sensitive. |  |
