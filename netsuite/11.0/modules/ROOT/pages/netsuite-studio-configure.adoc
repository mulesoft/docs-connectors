...
* <<request-based-authentication,Request-Based Authentication>>, which authenticates by using credentials in the SOAP header of each request
...
With request-based authentication, you authenticate by sending user credentials in the SOAP header of each request.
