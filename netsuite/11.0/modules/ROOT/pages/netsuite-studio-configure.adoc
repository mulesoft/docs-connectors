...
* <<request-based-authentication,Request-Based Authentication>>, which involves sending user credentials in the SOAP header of each request (*Reviewers, is this correct?*)
* <<token-authentication,Token Authentication>>, which
uses either a consumer key and token ID or secret pairs for authentication (*Reviewers, is this correct?*)
+
