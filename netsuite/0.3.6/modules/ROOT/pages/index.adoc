...
image::netsuitedemoflow.png[NetSuite Demo Flow]
...
+
image::netsuite-http.jpg[HTTP Settings]
+
...
+
image::netsuite-dataweave1.jpg[set payload]
+
...
+
image::netsuite-global-configuration.png[global element]
+
...
+
image::netsuite-addrecord.jpg[netsuite add record]
+
[%header%autowidth.spread]
|===
|Field |Value
