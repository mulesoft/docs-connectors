...
key `__customRecordType__customrecord_2663_bank_details__374` is used. Keys consist of
...
The example above shows `StringCustomFieldRef__custrecord_2663_legal_name__3878`, `BooleanCustomFieldRef__custrecord_2663_dd_batch__3864` and
`LongCustomFieldRef__custrecord_2663_eft_file_cabinet_id__3874`. The field names consist of
a custom field ref type, scriptId, and internalId.

`StringCustomFieldRef__custrecord_2663_legal_name__3878` also has a specified value
`ns02#value: "test"`,  `LongCustomFieldRef__custrecord_2663_eft_file_cabinet_id__3874` has a specified
value `ns02#value: 1234`, and `BooleanCustomFieldRef__custrecord_2663_dd_batch__3864` has a specified value ns02#value: true.
