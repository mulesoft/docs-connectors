...
key `\\__customRecordType__customrecord\_2663_bank\_details\\__374` is used. Keys consist of
...
`customrecord\_2663_bank\_details`, and the internalId is `374`.
...
The example above shows `StringCustomFieldRef\\__custrecord_2663\_legal\_name\\__3878`, `BooleanCustomFieldRef\\__custrecord_2663\_dd_batch\\__3864` and
`LongCustomFieldRef\\__custrecord_2663\_eft_file\_cabinet_id\\__3874`. The field names consist of
a custom field ref type, scriptId, and internalId.

`StringCustomFieldRef\\__custrecord_2663\_legal_name\\__3878` also has a specified value
`ns02#value: "test"`,  `LongCustomFieldRef\\__custrecord_2663\_eft_file\_cabinet_id\\__3874` has a specified
value `ns02#value: 1234`, and `BooleanCustomFieldRef\\__custrecord_2663\_dd_batch\\__3864` has a specified value ns02#value: true.
