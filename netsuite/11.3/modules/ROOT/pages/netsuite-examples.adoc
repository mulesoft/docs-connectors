...
key `\__customRecordType__customrecord1193580__1193580` is used. Keys consist of
...
The example above shows `StringCustomFieldRef__custrecord1395__4595` and
`DateCustomFieldRef__custrecord1398__4598`. The field names consist of
a custom field ref type, scriptId, and internalId.

`StringCustomFieldRef__custrecord1395__4595` also has a specified value
ns02#value: "2" and `DateCustomFieldRef__custrecord1398__4598` has a specified
