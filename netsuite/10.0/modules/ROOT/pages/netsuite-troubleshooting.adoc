...
* <<triggers-custom-records, I can't set custom records as object type on the triggers.>>
...
== I can't set custom records as object type on the triggers

The connector doesn't support Custom Records as Object Type on any trigger (On New Object, On Modified Object, On Deleted Object). You can set CUSTOM_RECORD_BASIC and work with that entity, but it is only available for On New Object and On Deleted Object.

As a last resource you can try to set up a Search operator that executes between certain amounts of time, that could work as a manually developed trigger.
