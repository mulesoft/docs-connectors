...
* For *On Deleted Object* or *On New Object*, set CUSTOM_RECORD_BASIC and work with this type.
* Set up a *Search* operator that executes for a certain amount of time and works as a manually developed source.
