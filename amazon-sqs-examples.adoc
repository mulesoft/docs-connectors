...
The common use case Amazon SQS connector can be sending a message along with meta data to an Amazon SQS queue and then receive it from the queue. This can be split into the following two flows:
...
== Use Case: Send and receive message
