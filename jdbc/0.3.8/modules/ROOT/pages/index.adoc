...
:page-aliases: 3.8@mule-runtime::jdbc-connector.adoc
...
NOTE: The JDBC connector supports multi-resource transactions. Multi-resource transactions are also supported by the xref:3.8@mule-runtime::database-connector.adoc[Database Connector]. Consider also the use of xref:3.8@mule-runtime::xa-transactions.adoc[XA Transactions] to handle this use case.
...
* For details on setting the properties for a JDBC endpoint using an XML editor, consult the xref:3.8@mule-runtime::jdbc-transport-reference.adoc[JDBC Transport Reference].
