= WMQ Connector
:page-aliases: 3.8@mule-runtime::wmq-connector.adoc
...
* See the xref:3.8@mule-runtime::mule-wmq-transport-reference.adoc[Mule WMQ Transport Reference] for details on setting the properties for a WMQ endpoint using an XML editor.
