...
image::wmq-1.png["WMQ configuration in properties window for General tab"]
...
image::2-adv-tab.png["WMQ configuration in properties window for Advanced tab"]
...
image::3-transformers.png["WMQ configuration in properties window for Transformers tab"]
