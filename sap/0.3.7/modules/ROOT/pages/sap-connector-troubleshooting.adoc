...
:page-aliases: 3.7@mule-runtime::sap-connector-troubleshooting.adoc

This page contains some common troubleshooting suggestions for the xref:3.7@mule-runtime::mulesoft-enterprise-java-connector-for-sap-reference.adoc[SAP Connector].
