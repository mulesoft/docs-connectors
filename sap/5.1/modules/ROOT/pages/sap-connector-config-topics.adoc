...
+
image::sap-connector-config-adv.png[This image shows the Advanced tab for Global Element Properties.]
+
...
image::sap-advanced.png[This image shows the advanced settings for configuration.]
...
+
image::sap-connector-advanced-tab.png[This image shows the lower advanced tab.]
+
