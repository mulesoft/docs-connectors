...
The SAP Connector provides a wide range of functionalities, beyond the basic ones already described in the xref:index.adoc[SAP Connector Overview]. The present document will help you harness the full potential of your SAP Mule application.
