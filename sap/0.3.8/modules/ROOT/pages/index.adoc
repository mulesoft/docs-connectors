...
*Note*: With DataSense support, the recommended way to generate the XML definitions is using xref:3.8@mule-runtime::dataweave.adoc[DataWeave]. However, if you are using a Mule 3.3 application, see  xref:6@studio::datamapper-user-guide-and-reference.adoc[DataMapper].
...
* https://www.anypoint.mulesoft.com/exchange/?search=SAP%20[SAP Templates]
