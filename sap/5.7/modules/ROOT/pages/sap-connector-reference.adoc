...
* A message server can be configured with multiple gateways and passed to the Document listener in the SAP Connector in order to distribute load and improve performance.
