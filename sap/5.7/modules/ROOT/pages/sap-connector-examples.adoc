...
This example shows you how to create a Mule app that configures a message server that has multiple gateway connections instead of a single gateway connection to distribute the load and improve performance.

The following screenshot shows the Studio flows for this example:

image::sap-multiple-gateways.png[Studio flow for configuring a message server with multiple gateways]
...
. In Anypoint Studio, create a new Mule project.
. From the *Mule Palette* view, select *SAP* and drag the *Document listener* source to the canvas to start a new flow.
