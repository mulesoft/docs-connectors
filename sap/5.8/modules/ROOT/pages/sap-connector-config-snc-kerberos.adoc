...
** *GSS Library Path*
+
Static value `/usr/lib64/libgssapi_krb5.so.2.2` when using CloudHub. For more information about downloading and installing the GSS library, refer to https://www.gnu.org/software/gss/manual/gss.html#Downloading-and-Installing[Downloading and Installing].
** *Principal*
+
