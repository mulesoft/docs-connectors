...
This example shows you how to create a Mule app that uses the *Send IDoc* operation to send an IDoc to SAP. The following screenshot shows the Studio flow for this example:
