...
* The SAP GUI application. To install this client, you need JAVA already installed in your machine. Then, download the installer for your OS. An alternative is to open terminal and enter `java -jar PlatinGUI750<OS>.JAR`.
** https://sap-infra.s3.amazonaws.com/PlatinGUI750_10-80002494-mac.JAR[Mac 7.50 rev10]
** https://sap-infra.s3.amazonaws.com/PlatinGUI750_10-80002495-win.JAR[Windows 7.50 rev10]
** https://sap-infra.s3.amazonaws.com/PlatinGUI750_10-80002496-lin.JAR[Linux 7.50 rev10]
