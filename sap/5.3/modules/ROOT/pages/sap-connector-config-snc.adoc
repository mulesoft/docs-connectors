...
* The SAP GUI application. To install this client, you need JAVA already installed in your machine. Then, download the installer for your OS.
...
An alternative is to open terminal and enter `java -jar PlatinGUI750<OS>.JAR`.
