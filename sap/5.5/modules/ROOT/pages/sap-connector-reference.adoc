...
| Encoding a| String |  Canonical name of the encoding. Refer to Oracle's supported encodings at `+https://docs.oracle.com/javase/8/docs/technotes/guides/intl/encoding.doc.html+`. |  |
