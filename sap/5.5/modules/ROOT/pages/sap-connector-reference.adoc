= SAP Connector 5.5 Reference - Mule 4
...
A message server can be configured with multiple gateways and can be passed to the *Document Listener* source to distribute the load and improve performance. For more information, refer to xref:sap-connector-examples.adoc#configure-multiple-gateways[Configure Multiple Gateways].
