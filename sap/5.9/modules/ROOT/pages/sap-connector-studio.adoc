= SAP Connector 5.9 Studio Configuration - Mule 4
...
This screen appears:
+
image::sap-connector-configuration-01.png["SAP Connector global element properties window"]
...
. Click *Install*.
+
image::sap-connector-configuration-02.png["Install button in Maven dependency window"]
+
. In the *Install* menu, click *Browse* to locate the library file.
. Specify a unique group ID, artifact ID, and version.
+
image::sap-connector-configuration-02-in.png["Install file into local repository window"]
+
. Click *Finish* or, if you want to cancel, click *Remove Dependency*.
+
image::sap-connector-configuration-02-finish.png["Finish button in Maven dependency window"]
...
. Specify a unique group ID, artifact ID, and version.
+
image::sap-connector-configuration-03-in.png["Install file into local repository window"]
+
. Click *Finish* or, if you want to cancel, click *Remove Dependency*.
+
image::sap-connector-configuration-03-finish.png["Finish button in Maven dependency window"]
...
. Specify a unique group ID, artifact ID, and version.
+
image::sap-connector-configuration-04-in.png["Install file into local repository window"]
+
. Click *Finish* or, if you want to cancel, click *Remove Dependency*.
+
image::sap-connector-configuration-04-finish.png["Finish button in Maven dependency window"]
...
image::sap-connector-libraries-installed.png["Global element properties window with required libraries installed"]
