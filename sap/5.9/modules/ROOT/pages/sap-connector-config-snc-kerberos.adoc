...
** *GSS Library Path*
+
Static value `/usr/lib64/libgssapi_krb5.so.2.2` for CloudHub and CloudHub 2.0 or Runtime Fabric when using images published after July 2025. Static value `/usr/lib/x86_64-linux-gnu/libgssapi_krb5.so.2.2` for CloudHub 2.0 or Runtime Fabric when using images published before July 2025.
** *Principal*
+
...
** *Client SNC My Name*
+
SNC name that identifies the client in secure network communications, in this example `p:sidadm`
