...
[NOTE]
====
The sRFC operation requires authorization for the `RFC_METADATA_GET` function module. If authorization is not granted, you may encounter the following error:
