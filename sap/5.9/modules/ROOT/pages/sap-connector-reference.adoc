...
NOTE: Kerberos Connection Type is supported only on CloudHub.
...
This operation is deprecated. Use the <<asynchronousRemoteFunctionCall, *Asynchronous RFC*>> operation instead.
...
This operation is deprecated. Use the <<synchronousRemoteFunctionCall, *Synchronous RFC*>> operation instead.
