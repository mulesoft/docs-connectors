...
The most frequent cause of the following error is that different versions of the native library and JCo JAR files are being employed:
...
If no TID handler is defined, and you receive the following exception:
