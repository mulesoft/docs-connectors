= Troubleshooting SAP Connector 5.2 
...
Further information is available externally at the https://maven.apache.org/plugins/maven-dependency-plugin/usage.html[Apache Maven Dependency Plugin].
