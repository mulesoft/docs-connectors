...
The Transaction ID is a property of the Mule Message, which enables you to provide the Transaction ID to get an IDoc number. This allows you to call RFC-enabled function modules on SAP in order to retrieve the IDoc number.
