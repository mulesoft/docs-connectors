...
[NOTE]
To add your schema content, you can either upload your file in the *Schema* field, or manually add the direct schema text content in the *Schema content* field.
