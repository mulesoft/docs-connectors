...
In the following example, you configure the *Schema Content* field of the the *Validate schema* operation. Enter in this field the schema content to validate. 
