...
[NOTE]
Supported schema versions are: Draft 3, Draft 4, Draft 6, Draft 7, Draft 2019-09 and Draft 2020-12. Drafts 3 and 4 have a different payload response than the other drafts.
