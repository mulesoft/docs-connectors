...
[NOTE]
The operation supports schema versions: Draft 3, Draft 4, Draft 6, Draft 7, Draft 2019-09 and Draft 2020-12. The operation can encounter memory constraints when loading extensive JSON files into memory.
