...
| Polling Time a| Number | Time to wait for a message to be ready for consumption (0-20000). If this value is greater than 0 and no message arrives, the connector throws a `ANYPOINT-MQ:TIMEOUT` exception. |  10000 |
