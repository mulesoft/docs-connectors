...
image::mq-failover-flow-publish.png[Anypoint MQ publish flow with failover enabled]

=== Consume Flow with Failover Enabled

With failover enabled, the consume flow for messages is:

image::mq-failover-flow-consume.png[Anypoint MQ consume flow with failover enabled]
