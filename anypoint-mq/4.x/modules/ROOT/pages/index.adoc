...
. Click *Copy* and select the connector version from the menu:
+
...
+
image::amq-4x-publish-url.png["URL, Client App ID, and Client Secret fields in the Anypoint MQ Configuration window"]
