...
image::amq-4x-consume-attributes.png["Mule message, including payload and message attributes"]
...
image::amq-4x-consume-operation.png["Connector configuration, including destination, acknowledgment mode and timeout, and polling timeout"]
