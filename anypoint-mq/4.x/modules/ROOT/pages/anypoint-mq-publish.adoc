...
image::amq-4x-publish-operation.png["Publish configuration window showing Destination set to invoiceQueue"]
...
image::amq-4x-publish-attributes.png["Mule message output, including payload and message attributes"]
...
image::amq-4x-publish-properties.png["Connector configuration showing AUTH_TYPE and AUTH_TOKEN attributes"]
...
image::amq-4x-publish-user-props.png["Message Browser showing the message's user properties"]
...
image::amq-4x-publish-transformed.png["Connector configuration showing a DataWeave transformation"]
...
image::amq-4x-publish-advanced.png["Publish configuration window Advanced tab showing Message ID set to 12345"]
...
+
image::amq-4x-publish-advanced-delay.png["Publish configuration window Advanced tab showing Delivery Delay set to 2000"]
+
...
+
image::amq-4x-publish-advanced-groupid.png["Publish configuration window Advanced tab showing Message Group ID set to #[vars.userId]"]
+
