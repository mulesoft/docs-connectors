...
:page-aliases: connectors::anypoint-mq/4.x/anypoint-mq-publish.adoc
...
image::amq-4x-publish-advanced.png[Anypoint MQ Publish Advanced Tab]
...
+
image::amq-4x-publish-advanced-delay.png[Anypoint MQ Publish Advanced Tab - deliveryDelay]
+
...
+
image::amq-4x-publish-advanced-groupid.png[Anypoint MQ Publish Advanced Tab - messageGroupID]
+
