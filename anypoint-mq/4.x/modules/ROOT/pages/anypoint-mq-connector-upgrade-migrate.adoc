= Upgrading and Migrating Anypoint MQ Connector from 3.x to 4.x 

Upgrade Anypoint Connector for Anypoint MQ (Anypoint MQ Connector) from version 3.x to version 4.x.
...
The changes included in version 4.x break backward compatibility with version 3.x.
