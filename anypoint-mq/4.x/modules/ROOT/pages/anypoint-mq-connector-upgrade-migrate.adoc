...
. In Anypoint MQ, in the *Destinations* page, click *Copy* and select the connector version from the menu:
+
include::mq::partial$mq-image-copy-button.adoc[]
...
+
image::mq-tutorial-studio7-mq-config.png["URL, Client App ID, and Client Secret fields in the Anypoint MQ Configuration window"]
