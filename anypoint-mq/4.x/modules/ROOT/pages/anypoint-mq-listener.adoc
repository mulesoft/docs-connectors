...
Flow control for the polling strategy is opt-in and disabled by default. Existing applications are unaffected unless you explicitly enable it.
...
To enable flow control, set the property for your runtime and set *Max Concurrency* on your flow to the number of messages you want processed in parallel:
