...
image::amq-4x-subscriber-prefetch.png[Prefetch subscriber type]
...
image::amq-4x-subscriber-polling.png[Polling subscriber type]
...
image::amq-4x-subscriber-output.png[Message output payload and attributes]
...
image::amq-4x-subscriber-polling-fixed.png[Fixed Frequency Scheduling Strategy]
...
image::amq-4x-subscriber-polling-cron.png[Cron Scheduling Strategy]
...
image::amq-4x-subscriber-states-view.png[Circuit Breaker States Diagram]
...
image::amq-4x-cb-global-canvas.png[Circuit breaker configuration properties in the Global Element Properties window]
+
...
image::amq-4x-cb-global-ref.png[Circuit breaker global reference in the Advanced tab of the Subscriber properties window]
...
image::amq-4x-cb-inline.png[Edit inline selected for the circuit breaker in the Advanced tab of the Subscriber properties window]
