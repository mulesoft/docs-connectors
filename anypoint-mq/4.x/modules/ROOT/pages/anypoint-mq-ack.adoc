...
Acknowledging the message automatically when it's received means that Anypoint MQ removes the message from the queue and doesn't redeliver it if an error occurs during processing.
