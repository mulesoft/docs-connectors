...
. Specify the URL for the region you want your MQ queues and exchanges to reside. See xref:mq::mq-faq.adoc#regions[MQ available regions]. Substitute the region name in this URL:
+
...
. Click the Operation field and specify an operation such as Publish or Consume. For information on the Ack and Nack operations, see xref:mq::mq-ack-mode.adoc[].
