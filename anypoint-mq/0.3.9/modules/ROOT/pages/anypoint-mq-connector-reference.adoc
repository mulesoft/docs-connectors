...
Specify the URL for the region you want your MQ queues and exchanges to reside. See xref:msmq::faq.adoc#regions[MQ Regions]. Substitute the region name in this URL:
