...
image::amq-3x-publish-advanced.png[Anypoint MQ Publish Advanced Tab - Message Id]
...
+
image::amq-3x-publish-advanced-delay.png[Anypoint MQ Publish Advanced Tab - Delivery Delay]
+
...
+
image::amq-3x-publish-advanced-groupid.png[Anypoint MQ Publish Advanced Tab - Message Group ID]
+
