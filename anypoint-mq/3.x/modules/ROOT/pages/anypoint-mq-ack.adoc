...
Acknowledging the message automatically when it's received means that the message is removed from the queue and isn't redelivered if an error occurs during processing.
