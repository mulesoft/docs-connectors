...
your data resides in a region outside the country until the primary region is available.
...
By default, when the primary region is down, Anypoint MQ Connector checks:

* Fallback queue once every five minutes (300,000 milliseconds)
