...
. Click *+* next to the *Connector configuration* field to configure a global element that can be used by all instances of `HTTP Listener` in the app.
...
+
`true` is the default value. *Reviewers - can you provide a description for this field?*
* *Include auto generated code*
+
`false` is the default value. *Reviewers - can you provide a desciption for this field?*
+
. On the *Advanced* tab, optionally specify reconnection information, including a reconnection strategy.
