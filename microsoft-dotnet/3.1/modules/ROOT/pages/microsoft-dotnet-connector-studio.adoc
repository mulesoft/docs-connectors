= Using Anypoint Studio to Configure Microsoft .NET Connector 3.1 
...
+
image::microsoft-dotnet-connection.png["Studio General tab for DotNet config"]
+
* *Connection*
+
...
image::microsoft-dotnet-external-assembly.png["External connection type with Assembly tab selected"]
...
+
image::microsoft-dotnet-gac-assembly.png["Global assembly cache connection type with Assembly tab selected"]
...
+
image::microsoft-dotnet-legacy-assembly.png["Legacy connection type with Assembly configurations"]
...
+
image::microsoft-dotnet-resource-assembly.png["Resource connection type with Assembly tab selected"]
