...
[NOTE]
====
This connector supports for standalone deployments only. This connector does not support CloudHub or Runtime Fabric deployments.

This connector is not supported for use with Anypoint Design Center.
====
