= DotNet Connector - Upgrade and Migrate - Mule 4
...
. In *Add Dependencies to Project*, enter `DotNet Connector` in the search field.
. In *Available modules*, select *DotNet Connector* and click *Add*.
. Click *Finish*.
