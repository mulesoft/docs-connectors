...
Use this connection type for an assembly installed in the GAC (Global Assembly Cache). To configure the GAC connection type:
...
. In the *Assembly Path* field, enter the path of the .NET assembly, for example, `C:\Projects\..dll`.
+
