...
* Anypoint Studio, the graphical interface to Mule ESB. See xref:6.x@studio::to-download-and-install-studio.adoc[Download and Launch Anypoint Studio] for details
