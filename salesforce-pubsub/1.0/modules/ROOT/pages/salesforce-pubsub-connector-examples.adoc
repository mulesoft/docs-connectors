= Salesforce Pub/Sub Connector 1.0 Examples - Mule 4
...
|Replay option| One of the given implementations, for example, `Earliest`. For more information on how to use `Replay id from object store` in *Replay option*, refer to xref:salesforce-pubsub-connector-studio.adoc#store-objectstore[].
