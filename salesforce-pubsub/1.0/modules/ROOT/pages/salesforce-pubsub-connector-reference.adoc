...
| Proxy configuration a| <<ProxyConfiguration>> |  Configures a proxy for outbound connections. The proxy requests are sent to the gRPC API (towards the gRPC host and gRPC port). |  |
