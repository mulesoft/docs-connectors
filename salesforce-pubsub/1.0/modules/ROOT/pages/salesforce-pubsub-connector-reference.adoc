...
| Name | Type | Description | Default Value | Required
| Configuration | String | Name of the configuration to use. | | x
| Topic a| String | Topic for the event you want to publish. The format of the topic is `/event/EventName__e`. For example, for the `Order_Event__e` event, the topic is `/event/Order_Event__e`.  |  | x
