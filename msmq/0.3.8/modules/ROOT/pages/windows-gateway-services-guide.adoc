...
:page-aliases: 3.8@mule-runtime::windows-gateway-services-guide.adoc
...
* xref:3.8@mule-runtime::microsoft-dynamics-ax-2012-connector.adoc[Dynamics AX Connector]
* xref:3.8@mule-runtime::microsoft-dynamics-crm-connector.adoc[Dynamics CRM Connector]
* xref:msmq-connector-user-guide.adoc[MSMQ connector]
* xref:3.8@mule-runtime::windows-powershell-connector-guide.adoc[PowerShell Connector]
...
For more information on the PowerShell connector, see the xref:3.8@mule-runtime::windows-powershell-connector-guide.adoc[Windows PowerShell Connector Guide].
...
For more information on the CRM connector, see the xref:3.8@mule-runtime::microsoft-dynamics-crm-connector.adoc[Microsoft Dynamics CRM Connector Guide.]
...
For more information on the AX connector, see the xref:3.8@mule-runtime::microsoft-dynamics-ax-2012-connector.adoc[Microsoft Dynamics AX Connector Guide.]
