...
:page-aliases: 3.8@mule-runtime::msmq-connector-user-guide.adoc
...
For more information, see the xref:windows-gateway-services-guide.adoc[Windows Gateway Services Guide].
...
For detailed information on how to address MSMQ please refer to the following https://msdn.microsoft.com/en-us/library/ms700996(v=vs.85).aspx[documentation].
