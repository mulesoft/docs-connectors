= VM Connector 
:page-aliases: connectors::vm/vm-connector.adoc, connecotrs::vm-connector-reference.adoc
...
Note that persistent queues are unavailable in CloudHub 2.0 and Runtime Fabric.
