= Use Anypoint Studio to Configure B2C Shop Connector 1.0 - Mule 4
...
|============
+
image::shop-connector-shopper-token-config.jpg[Commerce Cloud B2C Shop Connector Shopper Token General properties tab]
