= Using Anypoint Studio to Configure Stripe Connector 1.0 
...
After you configure a global element for Stripe Connector, configure the other required fields for the connector.The required fields vary depending on which connector operation you use.
