...
* New users, read:
** xref:validation-studio.adoc[Use Studio to Configure the Connector] to create your Mule app
...
After you complete the prerequisites and try the examples, you are ready to create your own app and configure the connector using xref:validation-studio.adoc[Anypoint Studio].
