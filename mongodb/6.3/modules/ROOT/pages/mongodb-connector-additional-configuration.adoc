...
To get additional results until there are none left, use the https://www.mongodb.com/docs/v4.4/reference/command/getmore/[`getMore` command] to retrieve the next page of results:
