...
* MONGO:CONSISTENCY_ERROR
 ...
 The data is not consistent as the client cannot find a read after performing a write.
...
* MONGO:PERMISSIONS_DENIED
 ...
 There is a permission error while accessing a collection in a database. 
