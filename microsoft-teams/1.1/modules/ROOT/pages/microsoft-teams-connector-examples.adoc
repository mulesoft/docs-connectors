= Microsoft Teams Connector 1.1 Examples 
...
image::ms-teams-delete-channel.png["Delete a channel flow"]
...
image::ms-teams-remove-member.png["Remove a team member flow"]
