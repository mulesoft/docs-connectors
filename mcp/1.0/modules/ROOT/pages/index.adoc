...
Use MCP Connector to connect your APIs with LLM applications. APIs with complex endpoints can be exposed as simpler, more atomic tools or resources that are better suited for agentic clients. The key is to decide on what is straightforward, repeatable, and optimal for agent actions, and start there.
