= MCP Connector 1.0 - Mule 4
:lc-connector-name: mcp

Anypoint Connector for Model Context Protocol (MCP Connector) uses the Model Context Protocol (MCP) to enable AI clients that support MCP to invoke and interact with APIs, connectors, and apps. 

[NOTE]
The beta release of this connector supports only tools and resources. 
