...
* xref:mcp-connector-reference.adoc#OnNewSessionListener[] 
* xref:mcp-connector-reference.adoc#ResourceListener[] 
* xref:mcp-connector-reference.adoc#ToolListener[]
