...
* The `mule.http.service.implementation=NETTY` property is no longer required and must be <<remove_property,removed>>. 
...
[[remove-property]]
== Remove the `-Dmule.http.service.implementation=NETTY` Property
