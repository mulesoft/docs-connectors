...
* Provides distributed tracing support through integration with the Tracing module, enabling comprehensive monitoring and observability of MCP interactions across distributed systems. 
