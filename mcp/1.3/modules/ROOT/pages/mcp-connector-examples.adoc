...
<mcp:server-config name="mcp-server-config" doc:name="MCP Server Config" doc:id="mcp-server-config" serverName="${server.name}" serverVersion="1.0.0"> <<2>>
