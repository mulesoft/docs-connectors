...
** The *Try Default AWSCredentials Provider Chain* parameter is removed. Use xref:mule-runtime::configuring-properties.adoc[properties] instead to avoid embedding secrets in Mule XML files.
