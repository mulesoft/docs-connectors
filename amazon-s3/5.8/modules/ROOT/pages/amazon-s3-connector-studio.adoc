= Using Anypoint Studio to Configure Amazon S3 Connector 5.8
...
. <<basic-authentication,Configure basic authentication>>
. <<role-authentication,Configure role authentication>>.
