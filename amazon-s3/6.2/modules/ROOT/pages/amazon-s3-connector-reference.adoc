...
==== Two most common ways to use this operation:

- If you try to upload a large file from (eg: FTP Connector operation of SFTP Connector operation), and you want to
upload this *content in parts*, you have to choose *non-repeatable streaming*, and specify the content length (amount of bytes to consume from this content).
- When you have many little contents to upload and, the content that you set in the upload part operation is the *entire content* that you want to upload, you can use *repeateable streaming*.
