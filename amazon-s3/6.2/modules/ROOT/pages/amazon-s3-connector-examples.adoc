= Amazon S3 Connector 6.2 Examples 
...
* https://docs.aws.amazon.com/sdk-for-java/v1/developer-guide/credentials.html[Amazon Default Provider Credential Chain]
* https://docs.aws.amazon.com/AmazonS3/latest/userguide/acl-overview.html[Amazon Access Control List (ACL) overview]
