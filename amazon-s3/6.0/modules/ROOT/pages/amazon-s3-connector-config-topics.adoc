= Amazon S3 Connector 6.0 Additional Configuration
...
After you understand how to configure an AWS KMS key and provide credentials, you can try out the xref:amazon-s3-connector-examples.adoc[Example].
