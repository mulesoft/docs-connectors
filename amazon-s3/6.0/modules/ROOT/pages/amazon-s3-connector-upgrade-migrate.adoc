...
** The *Try Default AWSCredentials Provider Chain* parameter was removed. Please use https://docs.mulesoft.com/mule-runtime/4.4/configuring-properties[properties] instead avoid having to embed secrets in Mule XML files.  
