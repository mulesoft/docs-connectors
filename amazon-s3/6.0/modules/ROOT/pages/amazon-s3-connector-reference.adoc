...
Configures the API logging enabled type.

[%header,cols="20s,25a,30a,15a,10a"]
|===
| Field | Type | Description | Default Value | Required
| Target Bucket a| String | Target bucket. |  | x
| Target Prefix a| String | Target prefix. |  | x
| Target Grants a| Array of <<Grant>> | Target grants. |  |
|===
