...
// * The S3 connection type now includes the *Max Connections* field. 
// * The *Copy Object*, *Delete Object*, *Delete Objects*, *Get Object*, *Get Object ACL*, *Get Object Attributes*, *Head Object*, *Put Bucket Tagging*, *Put Object ACL*, and *Restore Object* operations now throw the `NO_SUCH_BUCKET` error.
* The *Create Object Presigned Url* operation now includes the *Part Number*, *Upload Id*, *Content MD5*, and *Content Type* fields.
* The *Get Object* operation now also outputs the xref:amazon-s3-connector-reference.adoc#GetObjectOperationAttributes[Get Object Operation Attributes] type. 
* The *Put Bucket Tagging* operation is now of the Object type instead of Array of xref:amazon-s3-connector-reference.adoc#Tag[Tag].
* The *Put Object* operation now includes the *Sse Kms Key Id* field.
* The connector now includes the new xref:amazon-s3-connector-reference.adoc#GetObjectOperationAttributes[Get Object Operation Attributes] type. 
...
. Click *Finish*.
. Verify that the Amazon S3 dependency version is 7.x in the `pom.xml` file in the Mule project.
