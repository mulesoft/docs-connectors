= Amazon S3 Connector 7.0 Reference - Mule 4
...
NOTE: The Role type is supported only for standalone, CloudHub 2.0, or Runtime Fabric deployments. The Role type is not supported for CloudHub 1.0 deployments.
