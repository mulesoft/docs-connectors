...
+
[NOTE]
When you specify a FIPS-compliant endpoint in the *Custom Service Endpoint* field, you must also provide the bucket name in the *Test Connection Bucket Name* field. For non-FIPS compliant endpoints,you can specify the bucket name or leave it unspecified.
