...
[IMPORTANT]
Current Limitations: The ListBuckets API does not support FIPS-compliant endpoints (e.g., https://aws.amazon.com/compliance/fips/[AWS FIPS endpoints]). This is a know https://github.com/aws/aws-sdk/issues/521[issue] and has been logged for future enhancement.
