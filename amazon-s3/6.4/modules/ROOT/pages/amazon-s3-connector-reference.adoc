...
[IMPORTANT]
List Buckets API does not works for FIPS endpoints. It is an issue with AWS SDK and AWS team is aware of this as mentioned in this GitHub (https://github.com/aws/aws-sdk/issues/521) post. This will be fixed once AWS SDK gets the fix for the same.
