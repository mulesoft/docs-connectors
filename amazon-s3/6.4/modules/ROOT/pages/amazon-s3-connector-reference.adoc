...
| Test Connection Bucket Name a| String |Validates the AWS S3 client connection using the provided bucket name. This field is mandatory when you specify a FIPS-compliant endpoint in the Custom Service Endpoint field. |  |
