= Amazon S3 Connector
:page-aliases: 3.7@mule-runtime::amazon-s3-connector.adoc
...
To use the Amazon S3 connector in your Mule application, configure a global Amazon S3 element that can be used by all the Amazon S3 connectors in the application (read more about  xref:3.7@mule-runtime::global-elements.adoc[Global Elements].)
...
`src` folder of your project. See xref:3.7@mule-runtime::configuring-properties.adoc[Learn how to configure properties].
...
xref:3.7@mule-runtime::deploying-to-multiple-environments.adoc[Deploying to Multiple Environments] for instructions on how to manage this.
...
For background information on pooling, see xref:3.7@mule-runtime::tuning-performance.adoc[Tuning Performance].
