...
Additionally, to enable the queue to receive messages when a new object is created or deleted in an S3 bucket, you must create the policy for the queue in this format:
