...
For an explanation of what watermarks are and how MuleSoft approached that problem in Mule 3, see https://blogs.mulesoft.com/dev-guides/how-to-tutorials/data-synchronizing-made-easy-with-mule-watermarks/[this blog post].
