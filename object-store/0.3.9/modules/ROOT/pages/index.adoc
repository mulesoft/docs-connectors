...
* *Persistent*: Object store data goes to disk. If Mule runtime is restarted, the object store content persists.
...
See also the http://mulesoft.github.io/mule-objectstore-mule3-connector/[Object Store Technical Reference].
