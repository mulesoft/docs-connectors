...
* Positive number
+
TTL set to the specified value

// ** Mule version 4.2.x, 4.3.0, and later: TTL set to the specified value and creates a rolling TTL. 
// ** Mule versions earlier than 4.2.1: TTL set to the specified value.
