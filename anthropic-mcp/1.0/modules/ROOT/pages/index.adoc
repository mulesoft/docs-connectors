...
The MCP protocol's security is primarily built around the OAuth Authorization Code flow, but to maintain compatibility with various systems and use cases, the connector also supports other authentication methods, including:
