...
| Enforce Acknowledgement ERR Segment repeatability a| Boolean a| Whether to enforce the repeatability of the ERR segment in the acknowledgement of HL7 messages. This parameter is specific to the handling of ERR segments in HL7 messages prior to v2.5.
