...
| Handle empty arrays for fields in message a| Boolean a| If 'true`, emits the field separation character for optional repeatable fields when the incoming payload contains empty arrays.
|  false |
