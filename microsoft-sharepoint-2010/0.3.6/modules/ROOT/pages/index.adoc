...
:page-aliases: 3.6@mule-runtime::microsoft-sharepoint-2010-connector.adoc

The Anypoint Connector for Microsoft SharePoint 2010 (Microsoft SharePoint 2010 Connector) enables integration with SharePoint 2010 through its SOAP API.
...
More information on how to create the Kerberos configuration file can be found at http://web.mit.edu/kerberos/krb5-devel/doc/admin/conf_files/krb5_conf.html[MIT Kerberos Documentation - krb5.conf]
...
----
+
*Note*: Checking this option cancause large items with many reference fields to take a long time to retrieve.

== See Also

https://www.mulesoft.com/exchange/org.mule.modules/mule-module-sharepoint-2010/[Microsoft Sharepoint 2010 Connector on Exchange]
