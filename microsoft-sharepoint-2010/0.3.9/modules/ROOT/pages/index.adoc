...
image::sharepointcanvas.png["Studio flow for creating a flow to query SharePoint 2010"]
...
+
image::sharepointquerybuilder.png["Query builder screen configuration"]
+
. Click *OK*.
...
image::sharepointntlmconfig.png["Microsoft SharePoint 2010 NTLM connection global elements properties config window"]
...
image::sharepointkerberosconfig.png["Microsoft SharePoint 2010 Kerberos connection global elements properties window"]
...
image::sharepointclaimsconfig.png["Microsoft SharePoint 2010 Claims-based connection global elements properties window"]
...
+
image::sharepointobjectbuilder.png["Object builder window"]
+
* List Item Delete
+
