...
[NOTE]
Microsoft stopped providing support for Sharepoint 2010 in October 2020 [reference](https://techcommunity.microsoft.com/t5/microsoft-sharepoint-blog/extended-support-for-sharepoint-server-2010-ends-in-october-2020/ba-p/272628#:~:text=Mainstream%20support%20for%20SharePoint%20Server,support%20for%20SharePoint%20Server%202010.). As a result, MuleSoft's connector for Sharepoint 2010 has been deprecated since the underlying product does not have any support from the vendor (i.e. Microsoft).

MuleSoft continues to offer the below mentioned connectors to assist you with your Sharepoint integration needs.
