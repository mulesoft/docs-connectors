...
After obtaining the access token for your Concur instance, use the access token in the configuration for SAP Concur Connector. The following screenshot shows an example of obtaining an access token using Password grant:
+
