...
. Create an account on https://developer.concur.com/register[https://developer.concur.com/register]. When you
...
https://developer.concur.com/api-reference/authentication/apidoc.html[Concur Authentication page]. To
...
This user manual presents two of many use cases you might have for the Concur connector in your organization. You may jump ahead and paste the <<flowXML,Complete Flow XML>> into the XML Editor in Studio after the Concur connector has been downloaded and a global element referencing your Concur instance credentials has been created. Download other demo applications http://mulesoft.github.io/mule3-microsoft-dynamics-365-connector[here]

[[step-3-create-get-list-of-lists-flow]]
=== Getting a List of Lists

. After starting a <<step-1-create-demo-project,new project>> and creating a Concur <<step-2-add-global-elements,global element>> that references the credentials needed to connect to your instance, complete the following.
...
+
. For reference you may check the particular "getlists" flow within the full demo <<Flow-XML,Flow XML>> section.
...
* http://mulesoft.github.io/mule3-microsoft-dynamics-365-connector[Concur Technical Reference].
* https://anypoint.mulesoft.com/exchange/org.mule.modules/mule-module-concur/[Concur Connector on Anypoint Exchange]
