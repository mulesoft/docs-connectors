...
NOTE: This operation uses the SAP Concur Attendees v3 API, which SAP deprecated on July 1, 2025.
...
NOTE: This operation uses the SAP Concur List v3 / List Item v3 API, which SAP deprecated on April 16, 2021.
...
NOTE: This operation uses the SAP Concur Quick Expense v3.0 API, which SAP has decommissioned.
...
NOTE: This operation uses the SAP Concur Travel Request v3.1 API, which SAP is decommissioning on November 3, 2026.
...
NOTE: This operation uses the SAP Concur Expense v3 DELETE API, which SAP deprecated on June 26, 2025.
...
NOTE: This operation uses the SAP Concur Attendee Types v3 API, which SAP deprecated on July 1, 2025.
...
NOTE: This operation uses the SAP Concur Expense Group Configurations v3 API, which SAP deprecated on June 26, 2025.
...
NOTE: This operation uses the SAP Concur Locations v3 API, which SAP deprecated on October 10, 2025.
...
NOTE: This operation uses the SAP Concur Users v3.0 API, which SAP decommissioned on January 21, 2025.
