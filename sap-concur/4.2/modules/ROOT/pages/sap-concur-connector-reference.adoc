...
NOTE: This operation uses the SAP Concur Attendees v3 API, which SAP deprecated on July 1, 2025. Use the Attendees v4 API instead.
...
NOTE: This operation uses the SAP Concur List v3 / List Item v3 API, which SAP deprecated on April 16, 2021. Use the List v4 / List Item v4 API instead.
...
NOTE: This operation uses the SAP Concur Quick Expense v3.0 API, which SAP has decommissioned. Use the Quick Expense v4 API instead.
...
NOTE: This operation uses the SAP Concur Travel Request v3.1 API, which SAP is decommissioning. Access to this API ends November 3, 2026. Use the Request v4 API instead.
...
NOTE: This operation uses the SAP Concur Expense v3 DELETE API, which SAP deprecated on June 26, 2025. Use the Expense v4 DELETE API instead.
...
NOTE: This operation uses the SAP Concur Attendee Types v3 API, which SAP deprecated on July 1, 2025. Use the Attendee Types v4 API instead.
...
NOTE: This operation uses the SAP Concur Expense Group Configurations v3 API, which SAP deprecated on June 26, 2025. Use the Expense Configuration v4 API instead.
...
NOTE: This operation uses the SAP Concur Locations v3 API, which SAP deprecated on October 10, 2025. Use the Localities v5 API instead.
...
NOTE: This operation uses the SAP Concur Users v3.0 API, which SAP decommissioned on January 21, 2025. Calls to this operation return an HTTP 403 error. Use the SAP Identity v4 API (`/profile/identity/v4/Users`) instead.
