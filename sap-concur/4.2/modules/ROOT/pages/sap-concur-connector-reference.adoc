= SAP Concur Connector 4.2 Reference 
...
| authorization a| String |  `'Bearer ' + access token` |  |x
| Expiration Policy a| ExpirationPolicy |  Configures the minimum amount of time that a dynamic configuration instance can remain idle before the runtime considers it eligible for expiration. This doesn't mean the platform expires an eligible instance. The runtime purges instances as it sees fit. |  |
|===

== Operations

* Create Entry Attendee Association
* Create Attendee (Deprecated)
* Create Expense Entry
* Create Expense Itemization
* Create List Item (Deprecated)
* Create Payment Request
* Create Purchase Order
* Create Quick Expense (Decommissioned)
* Create Receipt Image
* Create Report
* Create Request (Decommissioned)
* Create Vendors
* Delete Entry Attendee Association
* Delete Expense Entry (Deprecated)
* Delete Expense Itemization (Deprecated)
* Delete List Item (Deprecated)
* Delete Quick Expense (Decommissioned)
* Delete Receipt Image
* Delete Vendor
* Get Allocation
* Get Allocations
* Get Attendee (Deprecated)
* Get Attendee Type (Deprecated)
* Get Attendee Types (Deprecated)
* Get Attendees (Deprecated)
...
* Get Expense Entries
* Get Expense Entry
* Get Expense Group Configuration (Deprecated)
* Get Expense Group Configurations (Deprecated)
* Get Expense Itemization
* Get Expense Itemizations
* Get Invoices
* Get List Item (Deprecated)
* Get List Items (Deprecated)
* Get Location (Deprecated)
* Get Locations (Deprecated)
* Get Payment Request
* Get Payment Request Digest
* Get Payment Request Digests
* Get Purchase Order
* Get Quick Expense (Decommissioned)
* Get Quick Expenses (Decommissioned)
* Get Receipt Image
* Get Receipt Images
* Get Report
* Get Reports
* Get Request (Decommissioned)
* Get Request Group Configurations (Decommissioned)
* Get Requests (Decommissioned)
* Get Users (Decommissioned)
* Get Vendors
* Recall Request (Decommissioned)
* Submit Request (Decommissioned)
* Update Attendee (Deprecated)
* Update Attendee Type (Deprecated)
* Update Digital Tax Invoice
* Update Entry Attendee Association
* Update Expense Entry
* Update Expense Itemization
* Update Invoices
* Update List Item (Deprecated)
* Update Payment Request
* Update Purchase Order
* Update Quick Expense (Decommissioned)
* Update Report
* Update Request (Decommissioned)
* Update Vendors
...
NOTE: This operation uses the SAP Concur Attendees v3 API, which SAP deprecated on July 1, 2025. SAP recommends migrating to the Attendees v4 API, which this connector doesn't currently support.
...
NOTE: This operation uses the SAP Concur List v3 / List Item v3 API, which SAP deprecated on April 16, 2021. SAP recommends migrating to the List v4 / List Item v4 API, which this connector doesn't currently support.
...
NOTE: This operation uses the SAP Concur Quick Expense v3.0 API, which SAP has decommissioned. SAP recommends migrating to the Quick Expense v4 API, which this connector doesn't currently support.
...
NOTE: This operation uses the SAP Concur Travel Request v3.1 API, which SAP is decommissioning. Access to this API ends November 3, 2026. SAP recommends migrating to the Request v4 API, which this connector doesn't currently support.
...
NOTE: This operation uses the SAP Concur Expense v3 DELETE API, which SAP deprecated on June 26, 2025. SAP recommends migrating to the Expense v4 DELETE API, which this connector doesn't currently support.
...
NOTE: This operation uses the SAP Concur Attendee Types v3 API, which SAP deprecated on July 1, 2025. SAP recommends migrating to the Attendee Types v4 API, which this connector doesn't currently support.
...
NOTE: This operation uses the SAP Concur Expense Group Configurations v3 API, which SAP deprecated on June 26, 2025. SAP recommends migrating to the Expense Configuration v4 API, which this connector doesn't currently support.
...
NOTE: This operation uses the SAP Concur Locations v3 API, which SAP deprecated on October 10, 2025. SAP recommends migrating to the Localities v5 API, which this connector doesn't currently support.
...
NOTE: This operation uses the SAP Concur Travel Request v3.1 API, which SAP is decommissioning. Access to this API ends November 3, 2026, the same date as the related Travel Request v3.1 shutdown. SAP doesn't currently offer a Request Policy v4 replacement for this operation.
...
NOTE: This operation uses the SAP Concur Users v3.0 API, which SAP decommissioned on January 21, 2025. Calls to this operation return an HTTP 403 error. SAP recommends migrating to the Identity v4 API (`/profile/identity/v4/Users`), which this connector doesn't currently support.
