...
* To align with modern development practices and ensure continued compatibility with secure and supported libraries, Spring Module is upgraded from Spring 5.x to the latest stable Spring 6.x version (Spring Framework 6.4.6).
...
. In *Add Dependencies to Project*, enter `spring` in the search field.
. In *Available modules*, select *Spring* and click *Add*.
. Click *Finish*.
