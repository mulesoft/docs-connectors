= Azure Event Hubs Connector 1.2 
...
* "https://learn.microsoft.com/en-us/azure/event-hubs/event-hubs-java-get-started-send?tabs=passwordless, roles-azure-portal"[Use Java to send events to or receive events from Azure Event Hubs^]
