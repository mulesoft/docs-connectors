= Using Anypoint Studio to Configure Azure Event Hubs Connector 1.2 - Mule 4
...
image::aeh-sas.png["Configuration of azure blob storage SAS authentication"]
...
image::aeh-active-directory-client.png["Configuration of active directory authentication with client credentials"]
...
image::aeh-active-directory-default-client.png["Configuration of active directory authentication with default client credentials"]
