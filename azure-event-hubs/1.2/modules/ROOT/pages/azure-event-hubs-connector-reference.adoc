= Azure Event Hubs Connector Reference 1.2 - Mule 4
...
* Earliest
* Latest
* <<EnqueuedTime>> | Defines the position of an event in an Event Hub partition. The position can be an enqueued time, the start of the stream, or the end of the stream. |  |
