...
image::netsuite-request-studio.png["Request based authentication global elements properties window"]
+
[%header,cols="30s,70a"]
|===
...
image::netsuite-token-studio.png["Token authentication global elements properties window"]
+
[%header,cols="30s,70a"]
|===
|Parameter |Description
