...
* Cassandra Operations do not support custom column types (frozen). When querying with/for custom column types, please use the  executeCQLQuery operation  using a raw cql query.
