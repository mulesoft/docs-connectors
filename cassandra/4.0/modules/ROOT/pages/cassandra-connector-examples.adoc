...
Add a *Transform Component* to xxx:
...
=== Add the Apache Cassandra Create Keyspace operation

. From the *Mule Palette* view, select *CassandDB* and drag the *Create Keyspace* operation to the right of *Transform Message*.
. On the *Create keyspace* tab, click the plus sign *+* next to the *Connector configuration* field to add a global element.
