...
This document assumes that you are familiar with Mule, xref:3.5@mule-runtime::anypoint-connectors.adoc[Anypoint Connectors], and the xref:5.x@studio::basic-studio-tutorial.adoc[Anypoint Studio Essentials]. To increase your familiarity with Studio, consider completing one or more xref:5.x@studio::basic-studio-tutorial.adoc[Anypoint Studio Tutorials].

== Installing Cassandra Connector in Anypoint Studio

You can "test drive" the CassandraDB connector by installing it in Anypoint Studio. Follow the instructions to xref:6.x@studio::index.adoc[Download and Launch Anypoint Studio], then follow the steps below to install the CassandraDB connector.
