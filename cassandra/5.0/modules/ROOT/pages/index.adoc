= Apache Cassandra Connector 5.0 
...
Apache Cassandra is an open source distributed NoSQL database intended to manage large amounts of product, customer, and employee data. Apache Cassandra Connector 5.0 implements the DataStax Java Driver for Apache Cassandra 4.17.0 and supports Apache Cassandra 5.x.
...
* Mule Enterprise Edition 4.6.0 or later and the entitlements necessary to use this software
