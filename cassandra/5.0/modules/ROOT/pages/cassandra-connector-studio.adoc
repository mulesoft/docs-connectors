...
+
. On the *Advanced Settings* tab, complete these fields when required:
+
[%header,cols="30s,70a"]
|===
|Field |Description
|*Cassandra Cluster Nodes* | Contact points that select the cluster.
...
|===
+
The *Advanced Settings* tab also includes *Max Schema Agreement Wait Seconds*, *Compression*, and *Prepared Statements Cache Size*. For field details, see xref:cassandra-connector-reference.adoc#config_connection[Connection].
+
