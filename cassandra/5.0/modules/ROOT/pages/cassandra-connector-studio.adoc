...
+
. On the *Advanced* tab, optionally specify reconnection information, including a reconnection strategy, and complete these fields when required:
+
[%header,cols="30s,70a"]
|===
|Field |Description
...
|===
+
For the remaining Advanced fields, see xref:cassandra-connector-reference.adoc#config_connection[Connection].
+
