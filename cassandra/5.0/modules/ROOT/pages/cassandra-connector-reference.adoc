...
| Cassandra Cluster Name (Deprecated) a| String | Cassandra cluster name. This field is deprecated. Use *Cassandra Cluster Nodes* and contact points to select the cluster. |  |
