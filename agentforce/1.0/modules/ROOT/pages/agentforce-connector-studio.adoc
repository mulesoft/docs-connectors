...
+
image:agentforce-palette-operations.png["Mule palette in Studio with Agentforce selected and all of the connector's operations listed"]
...
+
image:agentforce-config-studio.png["Global Element Properties window with configuration fields filled out for the Environment Variables configuration type"]
