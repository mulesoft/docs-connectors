...
* *Agent list*
+
Select the agent to invoke. The lists shows only agents that are currently active in the org. The connector filters out any agents that aren't in the `active` state.
