= Using Anypoint Code Builder to Configure Agentforce Connector - Mule 4
...
----
 <http:listener-config basePath="/path" name="HTTP-Listener-config">
  ...
  <mac-einstein:config configType="Environment Variables" filePath="-" llmType="OPENAI" modelName="gpt-4o" name="AGENTFORCE_Config"></mac-einstein:config>
...
For more information about configuring Agentforce Connector actions, see xref:agentforce-additional-config.adoc[Agentforce Connector - Additional Configuration Information].
