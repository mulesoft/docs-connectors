...
[NOTES]
---
* You must have S3 credentials to create and delete buckets and to create an object.
...
Prepare a data file to upload to S3. This data file will then be used as the data set in the `COPY` command for the Redshift table.
