...
---
. Open the Redshift configuration, scroll down, and configure the JDBC driver in the *Required libraries* section. In this example, choose the *Add recommended library* option.
