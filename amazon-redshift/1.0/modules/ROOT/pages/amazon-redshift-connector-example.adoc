...
---
. Open Redshift configuration, scroll down and configure JDBC driver in section Required libraries. In this example we can simply choose *Add recommended library* option.
