...
You can choose to *Use local file*, or *Add recommended library*, or *Add Maven dependency*.
- If you are trying to *Add recommended library* or *Add Maven dependency* and it does not work, please add the Amazon Maven repository to your pom.xml file and try again.
[source,xml,linenums]
----
<repositories>
...
