...
After you configure a global element and connection information, configure the other fields for the connector. See xref:salesforce-composite-connector-reference.adoc[Additional Configuration Information] for more configuration steps.
