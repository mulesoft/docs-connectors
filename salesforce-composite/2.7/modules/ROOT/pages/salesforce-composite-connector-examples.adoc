...
The *Create sobject tree* operation does what... 
...
This *Transform Message* component ... does what
...
The following screenshots show the flow for the Pre-Query example:
...
The *Pre create* operation provides metadata for creating an object called `NewAccount`. It generates a subrequest for the `executeCompositeBatch` operation:
