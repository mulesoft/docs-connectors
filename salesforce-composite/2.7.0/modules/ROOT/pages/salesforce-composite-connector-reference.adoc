...
|======================
| Name | Type | Description | Default Value | Required
| TLS configuration a| <<tls-configuration>> |  +++If the HTTPS was configured as protocol, then the user needs to configure at least the keystore configuration+++ |  | {nbsp}
