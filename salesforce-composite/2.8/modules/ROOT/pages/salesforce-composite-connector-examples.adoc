= Salesforce Composite Connector - Examples - Mule 4

== SObject Tree Operation Example

This example uses the following operations to connect to Salesforce, create and execute an SObject tree, and transform and output the results in JSON format:
...
The Execute Composite Batch operation executes the subrequests that the Pre Create and Pre Query operations created. To add the operation, follow these steps:
