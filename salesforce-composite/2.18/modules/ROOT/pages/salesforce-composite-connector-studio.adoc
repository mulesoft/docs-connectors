= Using Anypoint Studio to Configure Salesforce Composite Connector 2.18 - Mule 4
...
image::salesforce-composite-studio-basic-auth.png["Global configuration window for basic auth"]
