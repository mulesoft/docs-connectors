= Salesforce Composite Connector 2.4 Reference - Mule 4
...
| Connection Timeout a| Number |  The socket connection timeout value. This attribute works in tandem with #connectionTimeoutUnit. | 30 |
...
** MINUTES
** HOURS
** DAYS |  A TimeUnit that qualifies the #connectionTimeout |  SECONDS | 
