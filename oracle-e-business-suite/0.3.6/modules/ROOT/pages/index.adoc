...
You can install a connector in Anypoint Studio using the instructions in xref:3.9@mule-runtime::installing-connectors.adoc[To Install a Connector from Anypoint Exchange].
