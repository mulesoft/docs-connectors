...
:page-aliases: 3.7@mule-runtime::quartz-connector.adoc

When scheduling tasks, it's recommended that you instead resort to the xref:3.7@mule-runtime::poll-reference.adoc[Poll Scope]
...
Note that you also have the option to use a Poll scope at the beginning of a flow, which also supports Cron expressions and watermarks. Read more about the xref:3.7@mule-runtime::poll-reference.adoc[Poll scope].
...
* See the xref:3.7@mule-runtime::quartz-transport-reference.adoc[Quartz Transport Reference] for details on setting the properties for a Quartz endpoint using an XML editor.
...
* Read about the xref:3.7@mule-runtime::poll-reference.adoc[Poll scope].
