= Quartz Connector
:page-aliases: 3.5@mule-runtime::quartz-connector.adoc
...
You can install a connector in Anypoint Studio using the instructions in xref:3.8@mule-runtime::installing-connectors.adoc[Installing a Connector from Anypoint Exchange].
...
* See the xref:3.5@mule-runtime::quartz-transport-reference.adoc[Quartz Transport Reference] for details on setting the properties for a Quartz endpoint using an XML editor.
...
* Read about the xref:3.5@mule-runtime::poll-reference.adoc[Poll scope].
