...
+
Enter the segment size of the document to be split in. Can be blank.
* *Max Overlap Size (Characters)*
+
Enter the overlap size of the segments to fine-tune the similarity search. Can be blank.
