...
image::azure-sb-mgt-flow-get-queue.png[This app flow shows the components used in the get Get Queue Information example]
...
image::azure-sb-mgt-flow-create-topic.png[This app flow shows the components used in the Create Topic example]
. Create a new Mule project in Studio.
. In the Mule Palette view, search for *HTTP* and select the *Listener* operation:
