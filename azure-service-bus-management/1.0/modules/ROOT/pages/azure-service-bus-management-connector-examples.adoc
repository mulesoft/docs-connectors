...
=== Add and Configure the Get Queue Operation

. In the *Mule Palette* view, search for *azure service bus management* and select the *Get Queue* operation.
. Drag the *Get Queues* operation onto the canvas, to the right of the *Listener*.
...
. Drag the *Transform Message* component onto the canvas, to the right of the *Get Queue* component.
...
<http:listener doc:name="Listener" doc:id="60a97736-63e4-42bb-8487-e656cad985d6" config-ref="HTTP_Listener_config" path="queue"/>
<azure-service-bus-management:get-by-entity doc:name="Get Entity" doc:id="1adddf23-8292-4745-a8c6-e2d0ae9f77e9" config-ref="Azure_Service_Bus_Management_Connector_Config" entity="your-queue"/>
<ee:transform doc:name="Getting data" doc:id="3d069f90-86b3-49c6-81cf-c9c53251ab29" >
<ee:message >
