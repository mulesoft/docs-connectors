...
| Target Value a| String |  An expression that evaluates against the operation's output and stores the expression outcome in the target variable |  #[payload] |
...
Deletes a subscription over a specific topic. This operation makes an `HTTP DELETE`  request to the `/{topic}/Subscriptions/{subscription}` endpoint.
...
| Subscription a| String |  The subscription of the topic |  | x
| Config Ref a| ConfigurationProvider |  The name of the configuration to use to execute this component |  | x
| Custom Query Parameters a| Object |  |  #[null] |
| Custom Headers a| Object |  |  |
| Response Timeout a| Number |  The timeout for the request to the remote service. |  |
...
Delete a rule over an specific subscription from an specific topic from the service bus instance. This operation makes an `HTTP DELETE` request to the `/{topic}/Subscriptions/{subscription}/rules/{rule}` endpoint.
...
Retrieves all existing rules of the specific subscription over the specific topic from the service bus instance. This operation makes an `HTTP GET` request to the `/{topic}/Subscriptions/{subscription}/rules` endpoint.
...
| If Match a| String |  Set this header to â*â to update the entity. |  |
...
Creates or updates a subscription over an specific topic. This operation makes an `HTTP PUT` request to the `/{topic}/Subscriptions/{subscription}` endpoint.
...
| Configuration | String | The name of the configuration to use. | | x
| Topic a| String |  Topic |  | x
| Subscription a| String |  The subscription to create or update |  | x
| If Match a| String |  Set this header to â*â to update the entity. |  |
