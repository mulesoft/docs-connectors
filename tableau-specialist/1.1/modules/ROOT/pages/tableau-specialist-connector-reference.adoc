...
[NOTE]
Currently, you can't use these Hyper operations of the Tableau Connector in Mule apps deployed in a FIPS environment. However, you can use all other Tableau Connector operations successfully in a FIPS environment.
