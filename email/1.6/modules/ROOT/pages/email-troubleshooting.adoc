...
* EMAIL:ACCESSING_FOLDER
  ...
  An error occurred during an attempt to access a target folder that does not exist and the createTargetFolder attribute is set to false. The error can also occur by other exceptions on folder handling.
