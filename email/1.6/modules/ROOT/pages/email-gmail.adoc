...
In order to send emails to a Gmail account via the Email Connector, you need to https://support.google.com/accounts/answer/185833?visit_id=637917932546436561-2352829986&p=InvalidSecondFactor&rd=1[configure an app password] in your Gmail account.
