...
+
[start=6]
. In the *Trust Store Configuration* section, and select the *Insecure* checkbox.
. Click *OK*.
...
+
[start=6]
. In the *Trust Store Configuration* section, aand select the *Insecure* checkbox.
. Click *OK*.
...
If you do not have two-factor authentication set up, enable *Less Secure Apps* your Gmail account, and if your password does not work, go to https://accounts.google.com/DisplayUnlockCaptcha[Allow Access to Your Google Account] and follow these steps: +
