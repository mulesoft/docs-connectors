...
IBM MQ Connector provides two connection types:
...
Both connection types accept the same connection parameters. The XA connection type adds XA connection pool parameters.
