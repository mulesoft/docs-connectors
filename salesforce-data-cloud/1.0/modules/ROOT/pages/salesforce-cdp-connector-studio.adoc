...
If you are new to configuring connectors in Studio, see xref:connectors::introduction/intro-config-use-studio.adoc[Use Studio to Configure a Connector]. If, after reading this topic, you need additional information about the connector fields, see the xref:salesforce-data-cloud-connector-reference.adoc[Salesforce CDP Reference].
...
image::<image>.png[Basic is selected in the Connection field and the authentication fields are completed on the *General* tab.]
