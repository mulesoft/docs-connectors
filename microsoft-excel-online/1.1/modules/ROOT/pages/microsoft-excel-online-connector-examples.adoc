= Microsoft Excel Online Connector 1.1 Examples - Mule 4
...
image::microsoft-excel-online-add-worksheet.png["Add Worksheet Studio flow"]
...
image::microsoft-excel-online-list-worksheet.png["List Worksheet Studio flow"]
...
image::microsoft-excel-online-update-worksheet.png["Update Worksheet Studio flow"]
...
image::microsoft-excel-online-delete-worksheet.png["Delete Worksheet Studio flow"]
