= Microsoft Excel Online Connector 1.1 Reference 
...
Microsoft Excel Online Connector API has some limitations. See the following link for more details: https://learn.microsoft.com/en-us/connectors/excelonline/
...
| Worksheet Name a| String |  The name of the worksheet. |  | x
| (DEPRECATED) Chart Name/Id a| String |  Corresponding chart name to retrieve. |  | x
| (DEPRECATED) Request Body a| Any | Body of the request. Use the *Index* field instead. |  #[payload] |
| Index a| Number | Index value of the chart to retrieve. |  | x
| Config Ref a| ConfigurationProvider |  The name of the configuration to use to execute this component. |  | x
| Streaming Strategy a| * <<RepeatableInMemoryStream>>
* <<RepeatableFileStoreStream>>
* non-repeatable-stream |  Configures how Mule processes streams. Repeatable streams are the default behavior. |  |
...
| Configuration | String | The name of the configuration to use. | | x
| Workbook Id a| String |  The workbook ID where the worksheet is located. |  | x
| Workbook Name a| String |  The worksheet name to retrieve. |  | x
| Config Ref a| ConfigurationProvider |  The name of the configuration to use to execute this component. |  | x
| Streaming Strategy a| * <<RepeatableInMemoryStream>>
* <<RepeatableFileStoreStream>>
* non-repeatable-stream |  Configures how Mule processes streams. Repeatable streams are the default behavior. |  |
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | *x*
| Workbook Id a| String |  The ID of the workbook where the worksheet is located. |  | *x*
