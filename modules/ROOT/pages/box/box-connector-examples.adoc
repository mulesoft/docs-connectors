...
|localAuthorizationUrl |`+http://localhost:8081/authorize+`  |This URL needs to be entered after deploying the mule application to initiate `OAUTH2` dance.
...
This example demonstrates how to upload files to use with other box operations.
...
. Click the Headers tab next to the Body in the HTTP request, then click the *+* and configure the following parameter:
