...
== Anypoint Studio Example: Upload File

Since the Mule 4 version of Box connector doesn't provide upload file operation, this example demonstrates how to upload a file to Box.
