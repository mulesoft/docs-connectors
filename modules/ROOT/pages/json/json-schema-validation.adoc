...
The validator contains additional options, such as whether to allow duplicate keys or not, how to treat dereferencing, and so on. For complete details, see xref:json/json-reference.adoc[Json Module Documentation Reference].
