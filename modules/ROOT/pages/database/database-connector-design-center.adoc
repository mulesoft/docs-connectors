...
the xref:database/database-documentation.adoc[Database Connector Documentation Reference].

// Writer: Ensure that the connector reference xref and title are correct.
...
see the xref:database/database-connector-config-topics.adoc[Additional Configuration Information] topic
