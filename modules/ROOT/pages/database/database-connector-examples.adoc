...
For further information about parameters and connection type capabilities, see xref:database/database-documentation.adoc[the Database Connector Reference].
