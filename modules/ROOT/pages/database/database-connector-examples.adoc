...
:page-aliases: db/db-configure-connection.adoc, db-connector-query.adoc, db-connector-insert-update-delete.adoc, db-connector-sp.adoc, db-connector-ddl.adoc, db-connector-bulk-ops-ref.adoc, db-connector-datatypes-ref.adoc, db-connector-transactions-ref.adoc, db-connector-execute-script-ref.adoc
...
The following examples illustrate more advanced use cases, such as connecting to a global data source, configuring a JDBC driver, and configuring connection pooling.
