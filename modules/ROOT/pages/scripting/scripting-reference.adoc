...
IMPORTANT: The classes used with the Scripting Module must be exported, if not the execution will fail with a SCRIPTING:COMPILATION error. See xref:4.1@mule4-runtime::how-to-export-resources.adoc[How to export resources].
