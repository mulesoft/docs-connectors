...
Scripting Module examples help you how to use binding variables and access the registry.
...
== Access Registry Example
The following Scripting Module XML example shows how to:

* Access the registry using the `registry` object
* Get a flow to stop or start
