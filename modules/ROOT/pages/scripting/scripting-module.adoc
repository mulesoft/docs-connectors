...
You should enter de scripting code. In case you want to load the code from an external file, you can set this by using a xref:4.1@mule-runtime::configuring-properties.adoc[File Configuration Property].
