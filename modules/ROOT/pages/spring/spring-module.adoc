...
You must export the beans files used with the Spring module for your application to start. See xref:4.2@mule-runtime::how-to-export-resources.adoc[How to Export Resources]. 
...
* xref:4.2@mule-runtime::configuring-properties.adoc[Property Placeholders in Mule Apps]
* xref:4.2@mule-runtime::migration-module-spring.adoc[Migrate the Spring Module to Mule 4]
