...
IMPORTANT: The beans files used with the Spring Module must be exported, if not the application won't start. See xref:4.1@mule4-runtime::how-to-export-resources.adoc[How to Export Resources].
...
* xref:4.1@mule4-runtime::configuring-properties.adoc[About Property Placeholders in Mule Apps]