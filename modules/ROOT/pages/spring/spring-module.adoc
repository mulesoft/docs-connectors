...
The Anypoint Spring Module allows Mule apps to make use of the Spring framework.

Spring Module is installed in Studio 7 and does not require separate installation to be available.
Search the Mule Palette for "Spring" to view the Spring Module operation.
...
[NOTE]
====
Spring Module 1.3.0 and later requires Mule Runtime 4.1.1 and later. You can find the dependencies for earlier versions in https://anypoint.mulesoft.com/exchange/org.mule.modules/mule-spring-module/[Exchange] by selecting a version and clicking *Dependency Snippets*. 

Mule converts `RELEASE` in the `<version>` element to the latest version.
====
