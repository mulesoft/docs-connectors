...
. Search for Spring Module and click Install.
...
[NOTE]
====
Spring Module 1.3.0 requires Mule Runtime 4.1.1. You can find the dependencies for earlier versions in https://anypoint.mulesoft.com/exchange/org.mule.modules/mule-spring-module/[Exchange] by selecting a version and clicking *Dependency Snippets*. 
====
...
* xref:4.1@mule-runtime::migration-module-spring.adoc[Migrating the Spring Module to Mule 4]
