...
You must export the beans files used with the Spring module for your application to start. See xref:4.1@mule-runtime::how-to-export-resources.adoc[How to Export Resources]. 
