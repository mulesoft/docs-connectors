...
| Service directory a| String |  Common HTTP directory for all SAP services. It is possible to leave this parameter blank and specify the HTTP directory individually for every service in the unlisted services list. |  | {nbsp}
