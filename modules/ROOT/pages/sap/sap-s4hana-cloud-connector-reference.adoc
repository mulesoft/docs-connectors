= SAP S/4HANA Cloud Connector Reference - Mule 3
...
| Custom headers a| Object |  Custom headers that the request includes. The headers specified overwrite the default ones specified in the configuration. |  | 
| Custom query parameters a| Object |  Custom query parameters that the request includes. The parameters you specify here overwrite the default ones specified in the configuration. |  | 
...
| Custom headers a| Object |  Custom headers that the request includes. The headers you specify overwrite the default headers specified in the configuration. |  | 
| Custom query parameters a| Object |  Custom query parameters that the request includes. The ones specified here will overwrite the default ones specified in the config. |  | 
| Reconnection Strategy a| * <<Reconnect>>
* <<ReconnectForever>> |  A retry strategy in case of connectivity errors |  | 
|===
