...
To access the data in the SAP S/4HANA instance, your application’s requests using either Basic or OAuth 2.0.
...
After configuring the SAP S/4HANA OData Cloud Connector for use in Studio, see the
