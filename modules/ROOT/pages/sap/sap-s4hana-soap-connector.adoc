...
SAP S/4HANA SOAP Cloud Connector Version 1.0

// Release Notes: xref:release-notes::connector/sap-s4hana-soap.adoc[SAP S/4HANA SOAP Cloud Connector Release Notes]
Exchange: https://www.mulesoft.com/exchange/com.mulesoft.connectors/mule-sap-s4hana-soap-cloud-connector/[SAP S4Hana SOAP Cloud Connector]
