...
Basic Connection:
+
image::sap/sap-hana-conf1.png[]
+
image::sap/sap-hana-conf2.png[]
+
...
* Anypoint Studio with the Mule 4.1.x Runtime or later.
...
+
The connection timeout used in making the initial connection with the server.
The read timeout is timeout used  to read data from the server.
