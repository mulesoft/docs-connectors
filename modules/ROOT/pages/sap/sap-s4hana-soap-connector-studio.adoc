...
To access the data in the SAP S/4HANA instance, you need to authenticate your application’s requests using a supported authentication method. SAP S/4HANA Cloud SOAP Connector supports the following authentication types:
