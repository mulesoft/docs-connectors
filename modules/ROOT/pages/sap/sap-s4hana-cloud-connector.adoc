...
SAP S/4HANA Cloud Connector Version 1.0

The Mule SAP S/4HANA Cloud Connector provides full support to query, get, create, update, delete entities and execute function using the ODATA API exposed by S/4HANA.
...
+
** Service base URL - Enter the URL of the SAP S/4HANA instance which you wish to manage.
...
|Service base URL|The base URL of the service on SAP S/4HANA to be accessed from the connector.
