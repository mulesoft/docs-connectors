...
Exchange: https://www.mulesoft.com/exchange/com.mulesoft.connectors/mule-sap-s4hana-cloud-connector/[SAP S/4HANA OData Cloud Connector]
...
Mule translates the RELEASE keyword to the current version.
...
To use the SAP S/4HANA OData Cloud connector in a Mule app, configure a global SAP S/4HANA 
configuration element for use by SAP S/4HANA connector operations in your app.
