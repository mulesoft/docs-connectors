= SAP S4 HANA OData Cloud Connector - Mule 4
...
The Anypoint Connector for SAP S/4HANA OData Cloud (S/4HANA Connector) provides full support for 
...
This document assumes that you are familiar with S/4HANA, OData, Mule runtime engine (Mule), Anypoint Connectors, and the Anypoint Studio essentials.
