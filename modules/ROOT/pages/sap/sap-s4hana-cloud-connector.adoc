...
To specify a version, view Anypoint Exchange and click *Dependency Snippets*.
...
* https://www.mulesoft.com/exchange/com.mulesoft.connectors/mule-sap-s4hana-cloud-connector/[SAP S4 HANA OData Cloud Connector]
