...
Anypoint Connector for SAP S/4HANA OData (SAP S/4HANA OData Connector) provides full support for the query, get, create, update, delete entities, and execute functions using the OData API exposed by SAP S/4HANA.
...
To access the data in a <backend system> instance, you need to authenticate your application’s requests using a supported authentication method. 
...
* https://www.mulesoft.com/exchange/com.mulesoft.connectors/mule-sap-s4hana-cloud-connector/[SAP S4HANA OData Connector]
