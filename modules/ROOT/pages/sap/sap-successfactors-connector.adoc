...
image::sap/sap-successfactors-trigger.png[]
...
+
image::sap/sap-successfactors-http-listener.png[]
+
...
. Select the plus sign to add a component.
+
image::sap/sap-successfactors-plus.png[]
+
...
Basic Connection:
+
image::sap/sap-successfactors-conf1.png[]
+
image::sap/sap-successfactors-conf2.png[]
+
...
+
image::sap/sap-successfactors-global-config-wizard.png[Global Element Configuration Wizard]
+
...
+
image::sap/sap-successfactors-basic-config.png[Basic Connection screen]
+
...
image::sap/sap-successfactors-ops-1.png[Operations Studio 7 Flow]


image::sap/sap-successfactors-ops-2.png[Operations Studio 7 Flow]
...
For using a query as a filter follow the next steps:

1. For the Filter field select Query value (It's like saying: "I will use my own filter")

2. In the value field, enter the filter options. They must respect this format https://www.odata.org/documentation/odata-version-2-0/uri-conventions/ (see point 4.5)
