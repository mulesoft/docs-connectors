= SAP SuccessFactors Connector - Mule 4
...
To use this information, you should be familiar with SuccessFactors, Mule runtime engine (Mule), Anypoint Connectors, and the Anypoint Studio Essentials.
