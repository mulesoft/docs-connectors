...
To use SAP libraries in your Mule project, you must download and install all 
three of the IDOC library, the JCO library, and the JCO native library. You must 
have an SAP ID to do this. After you install the libraries, you can customize 
...
and you can download the folder on your computer. 
...
The three *Add Dependency* configurations are required to configure the SAP connector:
...
Both operations have these fields in common: *Configuration* name, *Operation Timeout*, *Gateway Host*, *Gateway Service*, *Program ID*, *Connection Count*, *Targeted Function*, *Transactional Action*, *Primary Node*, *Streaming Strategy*, *Redelivery Policy*, and *Reconnection Strategy*. 
