...
. Click the Exchange image::exchange-icon-in-studio.png[] icon in the upper left of the Studio task bar.
...
. In Studio, create a Mule project.
. In the *Mule Palette*, click *image::exchange-icon-in-studio.png[] Search in Exchange*.
