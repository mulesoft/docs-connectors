...
In Anypoint Studio, click the Mule Palette and type "sap". Choose an operation. If you want your application 
...
After 
installing the SAP connector in Studio and adding the connector to your Mule
