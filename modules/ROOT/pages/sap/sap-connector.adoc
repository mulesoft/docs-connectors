...
Creates a Mule application that receives a function using the SAP connector's *Function source* operation. The *Function source* operation passes the export parameter back to SAP.
