...
* SNC (Secure Network Communications): SNC integrates with the SAP NetWeaver single sign-on, or an external security product that works with SAP systems. SNC provides security functions that are not directly available with SAP systems.
+
