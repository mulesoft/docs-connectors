...
|Use SAP date time format |useSAPDateTimeFormat |Indicates to use SAP default format for DATE (`yyyy-MM-dd`) and TIME (`HH:mm:ss`) when working with BAPI functions over sRFC. |false
|===
