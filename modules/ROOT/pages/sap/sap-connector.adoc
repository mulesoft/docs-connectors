...
|Encoding |encoding |Canonical name of encoding. More details about supported encodings at: https://docs.oracle.com/javase/7/docs/technotes/guides/intl/encoding.doc.html |
