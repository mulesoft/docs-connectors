...
SAP Connector v4.3.2

The Anypoint Connector for SAP enables the integration of data to and from SAP NetWeaver-based and external systems.

This connector is not available in the Design Center feature of Anypoint Platform.
...
Before creating an app, you must have access to the SAP target resource and Anypoint Platform. You 
must also understand how to create a Mule app using Anypoint Studio.
