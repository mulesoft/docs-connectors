...
Before creating an app, you must have access to the SAP target resource and Anypoint Platform. You must also understand how to create a Mule app using Anypoint Studio.
