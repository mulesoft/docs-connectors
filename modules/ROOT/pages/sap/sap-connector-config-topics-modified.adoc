...
For doing this, you need to select the *Advanced tab* at the top of the Global Element Properties Screen:

image::sap/sap-connector-config-adv.png[]

== General Settings

image::sap/sap-general.png[]

If you need, to set Max Idle time parameter:
select *Expiration policy*, fill in the Max Idle time and than add the Time Unit
