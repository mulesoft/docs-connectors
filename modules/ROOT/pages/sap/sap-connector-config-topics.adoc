...
To do this, select the *Advanced tab* at the top of the *Global Element Properties* screen:
...
To set *Max Idle time* parameter, select *Expiration policy*, enter a value in the *Max Idle time*, and then add the *Time Unit*.
