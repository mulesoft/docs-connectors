= SAP S/4HANA OData Cloud - Examples - Mule 4
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

This example demonstrates the use of SAP S/4HANA connector to create and get an entity, query for a value, update the entity, and execute a function.
