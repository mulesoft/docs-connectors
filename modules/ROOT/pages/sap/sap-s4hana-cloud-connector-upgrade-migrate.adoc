...
The *OAuth 2.0 Application Connection Provider* option has been added to *Connection* types. For information about the configuration parameters for this connection type, see xref:sap/sap-s4hana-cloud-connector-reference.adoc[SAP S/4HANA OData Cloud Connector Reference]. 
...
. Verify that there are no problems the project `pom.xml` file.
