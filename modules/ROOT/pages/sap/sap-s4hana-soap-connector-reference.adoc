...
| Type a| String | The type of store used. The type of trust store where certificates are stored. The default is JKS and the connector allows JCEKS, PCKS12, and a custom security provider.  | JKS | 
...
| Type a| String | The type of store used. The type of key store where certificates are stored. The default is JKS and the connector allows JCEKS, PCKS12, and a custom security provider.  | JKS | 
