= SAP S4 HANA Cloud SOAP Connector Reference
...
// Release Notes: xref:release-notes::connector/sap-s4hana-cloud-soap-connector-release-notes-mule-4.adoc[SAP S4 HANA Cloud SOAP Connector]
