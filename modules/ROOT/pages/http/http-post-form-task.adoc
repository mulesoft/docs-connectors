...
The following example shows how to post a form using Anypoint Connector for HTTP (HTTP Connector) listener operation. Learn how to perform this operation both in Studio and XML. Additionally, review how to send the HTTP request that contains form parameters using an API tool such as Postman or Curl.
