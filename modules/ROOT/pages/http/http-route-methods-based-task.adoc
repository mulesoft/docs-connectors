...
. Create a second flow with an HTTP Listener. Ensure that the Connector Configuration is set to the HTTP_Listener_Config global element you created for the first connector.
. Set its Path to *requests*. In the properties editor, click *Advanced* and set *Allowed methods* to POST.
