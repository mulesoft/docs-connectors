...
You can also define your own schemas from scratch, or copy and edit a base TRADACOMS schema definition to suit your data. See the xref:partner-manager::edi-schema-language-reference.adoc[EDI Schema Language Reference] for more details.
