...
Because the aggregator listener is a source, the context of the flow where the aggregator exists is not accessible unless you add the aggregator listener to that flow. Once you do this, the new flow can access variables from the aggregrator's flow.
