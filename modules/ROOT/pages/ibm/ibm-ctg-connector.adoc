...
|Response Timeout |Enter the response timeout for the client to CTG. Default value is 30000 (30 seconds). **
...
|===
+
**Response Timeout setting of the connector will be overridden by the ecitimeout parameter if configured on the server side.
See ECI timeout in the See Also at the end of this document.
...
. Search for the connector and click *Add to project*.
...
* ECI timeout https://www.ibm.com/support/knowledgecenter/en/SSZHFX_9.0.0/com.ibm.cics.tg.doc/ctgunx/ipictimeout.html
