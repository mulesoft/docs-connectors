...
+
Having a metadata definition is not required to use IBM CTG Connector, but it is essential to improve the usability of the connector. See xref:7.2@studio::create-metadata-class-task.adoc[Create Metadata].
