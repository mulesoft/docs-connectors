...
Release Notes: xref:release-notes::connector/ibm-ctg-connector-release-notes-mule-4.adoc[IBM CICS Transaction Gateway Connector Release Notes - Mule 4]
...
NOTE: To successfully run use cases 1, 2 and 3, the target CICS system must have each program.
