...
to `MANUAL`.
For more information regarding a Message ACK, see xref:ibm/ibm-mq-ack.adoc[Handling Message Acknowledgment].
...
See xref:ibm/ibm-mq-xml-ref.adoc[JMS Reference] for details regarding the attributes structure.
