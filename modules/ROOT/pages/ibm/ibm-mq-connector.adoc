...
Mule converts RELEASE to the latest version. To specify a version, view the 
https://www.mulesoft.com/exchange/com.mulesoft.connectors/mule-ibm-mq-connector/[IBM MQ Connector] 
...
image::ibm/ibm-mq-client-connection-mode.png[Client Connection]
...
image::ibm/ibm-mq-binding-connection-mode.png[Client Connection]
...
* xref:ibm/ibm-mq-ack.adoc[Handle Message Acknowledgement]
* xref:ibm/ibm-mq-transactions.adoc[Handle Transactions in IBM MQ]
* xref:ibm/ibm-mq-performance.adoc[Tune For Performance]
* xref:ibm/ibm-mq-xml-ref.adoc[Connector Reference]
