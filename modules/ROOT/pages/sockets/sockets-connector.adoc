...
By default, a Socket implements the `Safe Protocol`, unless a different protocol is specified in the config element. The following example, demonstrates how to configure the socket to use Direct Protocol:
