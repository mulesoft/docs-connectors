...
transport can only read files as a result of inbound endpoint polling.
...
And then we can define our `read` operations referencing that configuration like this:
