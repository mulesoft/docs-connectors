...
Once your Web Service Consumer (WSC) connector configuration is created, you can start consuming SOAP operations from the configured service. (Note that if you have not created a Web Service Consumer configuration yet, you can refer to the xref:web-service/web-service-consumer-configure.adoc[Web Service Consumer Configuration Documentation]).
