...
In the Buffer Configuration tab you can set the send or receive buffer size and set the Validate output param in order to perform special character validation.
