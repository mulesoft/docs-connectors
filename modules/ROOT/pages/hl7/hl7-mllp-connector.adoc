...
** Keep connection open after data sending to be ready for next operations: Whether to close socket connections after each send operation.
...
In the Buffer Configuration tab you can set the send or receive buffer size and also set the Validate output param in order to perform special character validation.  
