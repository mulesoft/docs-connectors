...
HL7 EDI Connector Version 4.0.0

The Anypoint Connector for HL7 EDI (HL7 EDI Connector) lets you convert HL7 ER7 messages to and from DataWeave-compatible representations using lists and maps.

https://docs.mulesoft.com/release-notes/connector/hl7-connector-release-notes-mule-4[Release Notes]

https://www.mulesoft.com/exchange/mule-hl7-extension[Anypoint Exchange]
...
. Go to the properties view, select the connector configuration you previously created and select the Read operation.
+
...
HL7 EDI validates the message structure when it reads it in.
Message validation includes checking the syntax and content of the MSH and all component segments of the message.
Normally errors are logged, accumulated, and reported in the generated ACK message that is provided in the generated data structure.
...
* xref:connector/hl7-connector-release-notes.adoc[HL7 EDI Connector Release Notes]
* https://help.mulesoft.com[MuleSoft Help Center]
* xref:partner-manager/1.0/edi-schema-language-reference.adoc[EDI Schema Language]
