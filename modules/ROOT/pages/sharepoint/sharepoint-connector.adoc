...
Anypoint Connector for Microsoft SharePoint version 3.1
...
This document assumes that you are familiar with Microsoft SharePoint, Mule runtime engine (Mule), Anypoint Connectors, Anypoint Studio, Mule concepts, elements in a Mule flow, and Global Elements.

You need login credentials to test your connection to your target resource.

For compatibility information, see the xref:release-notes::connector/sharepoint-connector-release-notes-mule-4.adoc[connector Release Notes].

To use this connector with Apache Maven, view the pom.xml dependency information by clicking the
*Dependency Snippets* link in https://www.mulesoft.com/exchange/com.mulesoft.connectors/mule-sharepoint-connector/[Anypoint Exchange].
