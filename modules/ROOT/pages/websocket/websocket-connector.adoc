...
Anypoint Connector for WebSocket (WebSocket Connector) includes these integration capabilities: 
...
Typical use cases for WebSocket Connector include chat apps and stock quote apps.
