...
WebSocket Connector enables you to create real-time applications that need to avoid the overhead causes by the HTTP request-response message exchange pattern.  

//<<TBD - I will probably add more text here once I get this information from Esteban.>>
