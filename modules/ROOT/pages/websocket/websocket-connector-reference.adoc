...
| Content a| Binary |  the content to be sent |  #[payload] | 
| Path a| String |  the path of the sockets to be matched |  | x
| Socket Type a| Enumeration, one of:

** INBOUND
** OUTBOUND
** ALL |  the type of sockets to be matched |  ALL | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Socket Id a| String |  the id of the socket to be closed |  | x
| Close Code a| Enumeration, one of:
...
| Configuration | String | The name of the configuration to use. | | x
| Socket Id a| String |  |  | 
| Default Groups a| Array of String |  the groups to which the socket should be initially subscribed |  | 
| Config Ref a| ConfigurationProvider |  The name of the configuration to use to execute this component |  | x
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Socket Id a| String |  the id of the socket through which data is to be sent |  | x
| Content a| Binary |  the content to be sent |  #[payload] | 
| Config Ref a| ConfigurationProvider |  The name of the configuration to use to execute this component |  | x
| Reconnection Strategy a| * <<Reconnect>>
* <<ReconnectForever>> |  A retry strategy in case of connectivity errors |  | 
