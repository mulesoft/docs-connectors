...
. If you are:
+
* Using the default Amazon S3 storage, leave the default entries for *Proxy*, *Security*, and *Advanced* tabs.
...
The https://github.com/minio/[MinIO Project] is one example of Amazon S3 storage. If you configure this storage locally, you need to set the S3 Compatible Storage URL to `+http://127.0.0.1:9000+`.
////
