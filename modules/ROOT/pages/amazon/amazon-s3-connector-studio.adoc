...
. Search for the Amazon S3 connector, click the card for the connector, and click *Add to project*.
. Follow the prompts.
...
You can use the following Amazon S3 operations by moving then to the *Source* area
