...
Anypoint Connector for Amazon DynamoDB (Amazon DynamoDB Connector) provides connectivity to the Amazon DynamoDB API. This API enables you to interact with Amazon DynamoDB to create a database table that can:
