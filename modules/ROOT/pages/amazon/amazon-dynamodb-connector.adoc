...
|===
+
Placeholder values refer to the `mule-artifact.properties` configuration file in the
...
+
. Keep the *Advanced* tab Reconnection strategy with their default entries.
...
== Use Case: Create a Table in Amazon DynamoDB
