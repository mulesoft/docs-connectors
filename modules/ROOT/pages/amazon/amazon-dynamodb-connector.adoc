...
+
image::dynamodb-config-global-wizard.png[Global Element Configuration Wizard]
+
...
+
image::dynamodb-use-case-config.png[DynamoDB use case configuration]

== Use Case: Studio

This use case provides a Mule flow to create a table in Amazon DynamoDB.

image::dynamodb-create-table-use-case-flow.png[Creating a table in Amazon DynamoDB]
...
+
image::dynamodb-http-props.png[DynamoDB HTTP configuration properties]
+
...
|===
+
image::dynamodb-create-table-props.png[Publish message connector properties]
+
...
|===
+
image::dynamodb-create-table-logger-props.png[dynamodb create table logger]
+
