...
* Automatically spread the data and traffic for the table over a sufficient number of servers to handle the request capacity and the amount of data stored, while maintaining consistent and fast performance
...
see xref:amazon/amazon-dynamodb-connector-studio.adoc[Use Studio to Configure Amazon DynamoDB Connector]. The
xref:amazon/amazon-dynamodb-connector-examples.adoc[Examples] topic provides one or more use cases for the connector.
+
* Power user
+
Read the xref:amazon/amazon-dynamodb-connector-xml-maven.adoc[XML and Maven Support], and
and xref:amazon/amazon-dynamodb-connector-examples.adoc[Examples] topics.

== Authentication Types

Amazon DynamoDB Connecor supports the Basic and Role authentication types. For information about configuring these authentication types, see xref:amazon/amazon-dynamodb-connector-studio.adoc[Use Studio to Configure Amazon DynamoDB Connector].
...
After you complete the prerequisites and experimenting with templates and examples, you are ready to create a new app using Anypoint Studio.
...
* xref:amazon/amazon-dynamodb-connector-studio.adoc[Use Studio to Configure Amazon DynamoDB Connector]
