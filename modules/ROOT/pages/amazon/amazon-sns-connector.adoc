...
* Starting user
+
To create your Mule app, see xref:amazon/amazon-sns-connector-design-center.adoc[Design Center Configuration] or xref:amazon/amazon-sns-connector-studio.adoc[Studio Configuration]. See xref:amazon-sns-connector-config-topics.adoc [Additional Configuration Topics] to see what permissions AWS Identity and Access Management (IAM) users must have to use Amazon SNS Connector.
+
The xref:amazon/amazon-sns-connector-examples.adoc[Examples] topic provides one or more use cases for using this connector.

* Power user
+
Read the xref:amazon/amazon-sns-connector-xml-maven.adoc[XML and Maven Support], xref:amazon-sns-connector-config-topics.adoc [Additional Configuration Topics],
