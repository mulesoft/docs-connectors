...
* Power user
+
Read the xref:amazon/amazon-sns-connector-xml-maven.adoc[XML and Maven Support], xref:amazon/amazon-sns-connector-config-topics.adoc[Additional Configuration Information],
