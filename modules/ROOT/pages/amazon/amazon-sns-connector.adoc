...
Anypoint Connector for Amazon SNS (Amazon SNS Connector) Version v4.2.0

xref:release-notes::connector/amazon-sns-connector-release-notes-mule-4.adoc[Release Notes]
