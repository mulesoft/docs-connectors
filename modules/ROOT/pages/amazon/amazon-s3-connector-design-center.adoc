...
+
  ...
  * *HTTP Connector* *Listener* operation to initiate access to your app when the HTTP Listener accepts a request from a browser or application, such as Postman or CURL.
  * *scheduler* to inititate access your app at a specific time.
 +
