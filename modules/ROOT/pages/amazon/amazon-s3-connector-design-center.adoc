...
For information about Amazon S3 fields, see the xref:amazon/amazon-s3-connector-reference.adoc[Amazon S3 Connector Reference].
 ...
 ** The connector's *On Deleted Object* operation to access to your app when an Amazon S3 object is deleted.
 ** The connector's *On New Object* operation to access to your app when an Amazon S3 object is created.
 ** *HTTP Connector* *Listener* operation to access to your app when the HTTP Listener accepts a request from a browser or application such as Postman or CURL.
 ** *scheduler* to access your app at a specific time.
 +
