...
. If you are using this connector as an input source trigger, search for the connector; otherwise, search for HTTP or Scheduler.
. Complete the fields with the values you want to configure for the trigger.
