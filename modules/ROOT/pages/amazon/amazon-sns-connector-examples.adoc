...
<sns:config name="Amazon_SNS_configuration"
  ...
  doc:id="1f627e31-2209-474b-8388-54bd3dd88008" >
    ...
    secretKey="GGGVkXe16NAv3N9UWsPb86lSbC" />
</sns:config>
----
+
...
<sqs:basic-connection accessKey="AKIAJSIIXXJLRPC632TQ"
  secretKey="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" />
</sqs:config>
----
+
...
<mule xmlns:sqs="http://www.mulesoft.org/schema/mule/sqs"
  ...
  <sqs:basic-connection
    accessKey="AKIAJSIIXXJLRPC632TQ" secretKey="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" />
	</sqs:config>
