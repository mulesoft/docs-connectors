...
access Studio, and check to see if the Mule Palette displays entries for *Amazon SNS* and *Amazon SQS*.  If not, follow the instructions in <<amazon/amazon-sns-connector-studio.adoc#install-connector,Install the Connector>> to install both connectors.
