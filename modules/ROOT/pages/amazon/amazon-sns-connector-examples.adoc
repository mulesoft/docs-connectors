...
access Anypoint Studio, and verify that the Mule Palette displays entries for *Amazon SNS* and *Amazon SQS*.  If not, follow the instructions in <<amazon/amazon-sns-connector-studio.adoc#install-connector,Install the Connector in Studio Using Exchange>> to install both connectors.
...
|===
+
The following image shows a sample global element for the Receivemessages operation:
+
