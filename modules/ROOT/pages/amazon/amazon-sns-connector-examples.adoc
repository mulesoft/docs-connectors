...
<sns:config name="Amazon_SNS_Configuration"
  ...
  <sns:basic-connection
    accessKey=${sns.accessKey}
    secretKey=${sns.secretKey} />
</sns:config>
----
+
...
2+|*General section*
|*Topic arn* |${sqs.topicArn} or any other Amazon resource name (ARN).
|*Message* |``Hello World!``
