...
2+|*General*
|*Topic arn* |`arn:aws:sns:us-east-1:480410955647:sns-test` or any other Amazon resource name (ARN).
|*Message* |``Hello World!``
...
<sqs:config name="Amazon_SQS_Configuration"
  ...
  defaultQueueUrl="https://sqs.us-east-1.amazonaws.com/sns-test" >
...
<mule xmlns:sqs="http://www.mulesoft.org/schema/mule/sqs"
  ...
  messageStructure="JSON">
   ...
   message="`#[payload]`"/>
	...
	<sqs:receivemessages doc:name="Amazon SQS (Streaming)"
  config-ref="Amazon_SQS_Configuration"
  queueUrl="https://sqs.us-east-1.amazonaws.com/sns-test"/>
