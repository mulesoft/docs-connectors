...
|Key schemas | The attributes that make up the primary key for a table or an index.
...
+
. To add *Global Secondary Indexes*, add a variable before the *Create Table* operation in this format:
+
[source,xml,linenums]
----
<set-variable value='#[[
