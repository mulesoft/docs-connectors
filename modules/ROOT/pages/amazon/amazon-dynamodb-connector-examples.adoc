...
* The fifth items specify the maximum number of strongly consistent reads and writes consumed per second before Amazon DynamoDB returns a ThrottlingException.
