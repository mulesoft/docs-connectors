...
** USWEST1
** USWEST2
|  The ID of the region that contains the snapshot to be copied. |  | x
...
You can specify AWS account IDs (if you own the snapshots), self for snapshots for which you own or have explicit permissions, or all for public snapshots. 
