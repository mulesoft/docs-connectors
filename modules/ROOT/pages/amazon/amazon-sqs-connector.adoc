...
Anypoint Connector for Amazon SQS (Amazon SQS Connector) provides an easy way to interface with the Amazon Simple Queue Service (Amazon SQS) API, allowing Mule users to manage SQS queueing services without having to deal with the API directly.
...
Amazon SQS connector 5.4.1 is compatible with:
...
topic helps extend your understanding of Amazon SQS Connector. The
