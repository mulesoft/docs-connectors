...
Creates a platform application object for one of the supported push notification services, such as Apple Push Notification Service (APNs) and Google Cloud Messaging (GCM), to which devices and mobile apps may register. See the http://docs.aws.amazon.com/sns/latest/api/API_CreatePlatformApplication.html[Amazon SNS API Reference].
