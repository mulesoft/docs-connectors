...
To use Anypoint Connector for Amazon SNS (Amazon SNS Connector) in your Mule app, configure a global Amazon SNS element that can be used by all the Amazon SNS connectors in the application.
