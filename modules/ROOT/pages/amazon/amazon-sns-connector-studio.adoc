...
To use Amazon SNS connector in your Mule app, configure a global Amazon SNS element that can be used by all the Amazon SNS connectors in the application.
