...
+++
 The BatchDeleteItem operation deletes multiple items in one or more tables.   <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_BatchWriteItem.html">API Reference</a> 
+++
...
| Target Value a| String |  +++An expression to evaluate against the operation's output. The evaluation outcome is stored in the target variable.+++ |  `#[payload]` | 
...
+++
 The BatchPutItem operation puts multiple items in one or more tables.   <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_BatchWriteItem.html">API Reference</a> 
+++
...
+++
 Deletes a single item in a table by primary key.   <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_DeleteItem.html">API Reference</a> 
+++
...
+++
 Creates a new item, or replaces an old item with a new item. If an item that has the same primary key as the new item already exists in the specified table, the new item completely replaces the existing item.   <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_PutItem.html">API Reference</a> 
+++
...
+++
 Edits an existing item's attributes, or adds a new item to the table if it does not already exist.   <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_UpdateItem.html">API Reference</a> 
+++
