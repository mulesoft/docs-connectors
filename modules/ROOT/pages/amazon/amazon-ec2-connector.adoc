...
|Region Endpoint |Region to select from the menu for the Amazon EC2 Client |USEAST1
|===
+
...
* Some operations are not supported by the connector that are provided for  http://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_Operations.html[AWS EC2 Actions]. If you require additional operation support, see the https://support.mulesoft.com/s/ideas[Support Portal].
