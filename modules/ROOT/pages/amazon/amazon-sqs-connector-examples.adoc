...
|Message |`payload`
|Queue url |Value for the queue URL, if you did not enter a default queue URL in the global element.
|===
+
For example:
+
...
For example:
+
image::amazon/amazon-select-sqs-receive-config.png[select-send-message]
+
...
<mule xmlns:sqs="http://www.mulesoft.org/schema/mule/sqs"
  ...
  http://www.mulesoft.org/schema/mule/sqs http://www.mulesoft.org/schema/mule/sqs/current/mule-sqs.xsd">
	...
	<flow name="sqs-example-send-message-flow"  >
...
---
{
	...
	<flow name="sqs-example-receive-message-flow" >
