...
. Finish deploying and testing. Note that the access key and secret key are not listed in the connector configuration and that the correct values are used from the values specified in the settings.
