...
| Expiration a| DateTime |  The expiration date at which point the new pre-signed URL will no longer be accepted by Amazon S3, in milliseconds. | 900000 (15 minutes) |
