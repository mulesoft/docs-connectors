= Example: Store and Retrieve Information in an Object Store
...
TIP: Target variables used with the Object Store connector are described in the xref:4.1@mule4-runtime::target-variables.adoc[Mule Runtime Target Variables document].
