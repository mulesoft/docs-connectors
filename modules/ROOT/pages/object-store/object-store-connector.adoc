...
xref:object-store/object-store-to-define-a-new-os.adoc[To Define an Object Store]

xref:object-store/object-store-to-store-and-retrieve.adoc[To Store and Retrieve information from an Object Store]
