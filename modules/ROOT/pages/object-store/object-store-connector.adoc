...
*Reference:* xref:object-store/object-store-connector-reference.adoc[Object Store Connector Reference]

The Object Store Connector is a Mule component that allows for simple key-value storage. Although it can serve a wide variety of use cases, it is mainly design for:
...
Release Notes: xref:release-notes::connector/object-store-connector-release-notes-mule-4.adoc[Object Store Connector Release Notes] +
Exchange: https://www.mulesoft.com/exchange/org.mule.connectors/mule-objectstore-connector/[Object Store Connector]
...
* xref:object-store/object-store-to-define-a-new-os.adoc[Define an Object Store]
* xref:object-store/object-store-to-store-and-retrieve.adoc[Store and Retrieve information from an Object Store]
* xref:object-store/object-store-to-watermark.adoc[Example: Watermark]
