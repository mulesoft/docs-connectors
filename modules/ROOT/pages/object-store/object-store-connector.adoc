...
The Mule app is deployed to CloudHub workers using Anypoint Platform Runtime Manager, but the contents of the default Object Store is not visible in Runtime Manager in the *Application Data* page for the app.
