...
| Max Entries a| Number | The max number of entries allowed. Exceeding entries are removed when expiration thread runs. If absent, then the
...
** MINUTES
** HOURS
** DAYS | A #entryTtl | SECONDS | 
| Expiration Interval a| Number | How frequently should the expiration thread run.
