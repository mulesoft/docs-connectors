...
For information about Flow Designer field values, see the [<connector> Connector Reference].
...
. Complete the fields with the values you want to configure for your trigger. For more information on field values, see the xref:zuora-aqua/zuora-aqua-connector-reference.adoc[Zuora AQuA Connector Reference - Mule 4].
...
|*Base URI*| Base path of the AQuA API for your instance. For example: `https://apisandbox-api.zuora.com:443/`.
|===
...
After creating an app in Design Center, see the xref:zuora-aqua/zuora-aqua-connector-examples.adoc[Zuora AQuA Examples] section to experiment with the Zuora AQuA connector.
