...
** *Base Uri*: Base path of the AQuA API for your instance. Example: `https://rest.apisandbox.zuora.com:443/`.
+

image::zuora-aqua/zuora-aqua-basic-auth-studio.png[Zuora AQuA Connector Configuration in Studio 7]

== Next Step

After configuring this connector in Studio, see the xref:zuora-aqua/zuora-aqua-connector-examples.adoc[Zuora AQuA Examples] section to experiment with the Zuora AQuA connector.
