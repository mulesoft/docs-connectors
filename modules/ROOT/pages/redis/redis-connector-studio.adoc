...
image::redis/redis-basic-config-clustered.png[]
...
After completing configuration, see the xref:redis/redis-connector-config-topics.adoc[Additional Configuration Information] and 
