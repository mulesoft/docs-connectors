...
For information on Design Center field values, see the xref:redis/redis-connector-reference.adoc[Redis Connector Reference].
...
see the xref:redis/redis-connector-config-topics.adoc[Additional Configuration Information] topic for more configuration ideas.
