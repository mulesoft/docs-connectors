...
== Log PLSQL and Web Service Requests and Responses

To log the PLSQL interactions of the connector with Oracle EBS, configure the log4j2.xml file for the Mule app as follows:
...
To log the Web Service interactions of the connector with Oracle EBS, configure the log4j2.xml file for the Mule app as follows:

[source,xml,linenums]
----
<Logger name="org.apache.cxf.service" level="info" />
----
