...
This document assumes that you are familiar with Oracle EBS, Mule, Anypoint Connectors, Anypoint Studio, Mule concepts, elements in a Mule flow, and Global Elements.
