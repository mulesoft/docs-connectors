...
To use this information, you should be familiar with Oracle E-Business Suite, Anypoint Connectors, Anypoint Studio, Mule concepts, elements in a Mule flow, and Global Elements.
