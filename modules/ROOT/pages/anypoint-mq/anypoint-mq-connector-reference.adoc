...
** IMMEDIATE
** AUTO
** MANUAL |  Acknowledgment mode to use for the messages retrieved from the subscribers. |  IMMEDIATE |
...
** IMMEDIATE
** MANUAL |  Acknowledgment mode to use for the messages retrieved from this subscriber.  |  IMMEDIATE |
| Polling Time a| Number |  How much time in milliseconds to wait when requested messages are not ready to be consumed. |  10000 |
