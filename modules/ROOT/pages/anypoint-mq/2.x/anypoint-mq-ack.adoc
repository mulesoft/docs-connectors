...
* xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-consume.adoc[Consume a Message]
* xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-listener.adoc[Listen For New Messages]
