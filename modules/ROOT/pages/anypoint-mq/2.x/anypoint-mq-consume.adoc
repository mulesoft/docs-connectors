...
For more information regarding a message ACK, see xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-ack.adoc[How to Handle Message Acknowledgment].
...
See xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-connector-reference.adoc#consume[Consume] for details regarding the attributes structure.

== See Also

* xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-connector-reference.adoc#consume[Consume Technical Reference]
* xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-ack.adoc[How To Handle Message Acknowledgement]
