...
This documentation applies to Anypoint MQ connector 2.x only. To migrate from version 2.x to the version 3.x, see the xref:anypoint-mq/3.x/anypoint-mq-new-3x-major.adoc[Anypoint MQ 3.x Connector Migration Guide].
