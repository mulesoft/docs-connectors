...
This documentation applies to Anypoint MQ Connector version 2.x for Mule 4 versions 2.0.0-2.1.0 only. For information on Anypoint MQ Connector for Mule 3, see Mule 3 xref:3.9@mule-runtime::anypoint-mq-connector.adoc[Anypoint MQ Connector].
...
|xref:anypoint-mq/2.x/anypoint-mq-ack.adoc[NACK] |Changes the status of the message from in-flight to in-queue to be consumed again by an available consumer.
|===
