...
IMPORTANT: This documentation applies only to Anypoint MQ Connector version 2.x. A newer version 3.x can be found here xref:3.9@mule-runtime::anypoint-mq-connector.adoc[Mule 3 MQ Connector].
...
|xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-publish.adoc[Publish] |Publishes messages
to a queue or message exchange.
|xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-consume.adoc[Consume] |Consumes messages from a queue.
|xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-listener.adoc[Subscribe] |Waits for messages from a queue.
|xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-ack.adoc[Ack] |Indicates that the message has been consumed correctly and deletes the message from in-flight status.
|xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-ack.adoc[Nack] |Changes the status of the message from in-flight to in-queue to be consumed again by a subscriber.
|===

For a list of configuration fields for each operation and information about XML elements, see the xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-connector-reference.adoc[Anypoint MQ Connector Reference].
...
* xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-connector-reference.adoc[Anypoint MQ Connector Reference]
* xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-publish.adoc[Publishing a Message] 
* xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-consume.adoc[Consuming a Message] 
* xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-listener.adoc[Listening for Messages]
* xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-ack.adoc[Acknowledgment]
