...
For details on how each parameter works, see the xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-connector-reference.adoc#configurations[Connector Reference].
...
* xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-consume.adoc[Consume Messages]
* xref:anypoint-mq/2.x/anypoint-mq/anypoint-mq-ack.adoc[Use Topic Subscriptions]
