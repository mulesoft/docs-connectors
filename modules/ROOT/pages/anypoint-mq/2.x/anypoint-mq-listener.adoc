...
For details on how each parameter works, see the xref:anypoint-mq/2.x/anypoint-mq-connector-reference.adoc#configurations[Anypoint MQ Connector Reference - 2.x].
...
image::anypoint-mq/2.x/mq-subscriber-states-view.png[]
...
image::anypoint-mq/2.x/mq-subscriber-cb-config-tab.png[]
