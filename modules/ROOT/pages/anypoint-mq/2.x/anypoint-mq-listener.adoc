...
Since version 2.1.0, the Anypoint MQ connector Subscriber operation provides circuit breaking capability, enabling you to have more control on how the connector deals with errors that occurred while processing a consumed message.
