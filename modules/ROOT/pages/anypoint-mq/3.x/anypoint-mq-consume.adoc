...
image::amq-3x-consume-attributes.png[Anypoint MQ Message Atrributes]
...
See xref:anypoint-mq-connector-reference.adoc#consume[Consume] for details regarding the attributes structure.
