...
| Delivery Delay a| Number | Time to postpone delivery of the message before it can be consumed. The value of this parameter is between 0 and 15 minutes. | MILLISECONDS |
