...
. Drag the name of the operation from the palette to the canvas, and then select it.
...
. Drag the operation from the palette to the canvas, and then select it.
...
----
+
For a list of configuration fields for each operation and information about XML elements, see the .
