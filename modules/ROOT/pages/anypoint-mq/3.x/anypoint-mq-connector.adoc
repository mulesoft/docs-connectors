...
Release Notes: xref:release-notes::connector/anypoint-mq-connector-release-notes-mule-4.adoc[Anypoint MQ Connector Release Notes] +
Exchange: https://www.mulesoft.com/exchange/com.mulesoft.connectors/anypoint-mq-connector/[Anypoint MQ Connector 3.x — Mule 4]
...
This documentation applies to Anypoint MQ connector 3.x only. To migrate from version 2.x to the version 3.x, see the xref:anypoint-mq/3.x/anypoint-mq-new-3x-major.adoc[Anypoint MQ 3.x Connector Migration Guide].
...
+
image::anypoint-mq/3.x/amq-3x-connector-palette.png[Anypoint MQ Mule Palette]
...
|xref:anypoint-mq/3.x/anypoint-mq-listener.adoc[Subscriber] |Listens for messages from a queue.
|===
...
* xref:anypoint-mq/3.x/anypoint-mq-connector-reference.adoc[Anypoint MQ Connector Reference - 3.x]
