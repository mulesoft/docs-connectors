...
Instead of letting the Anypoint MQ service generate a unique `messageId` for the new published message, you can set a custom `messageId` for your outgoing message using the *Message id* field in the *Advanced* tab of the main screen:
