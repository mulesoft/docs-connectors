...
.The arrow shows the value of the *Subscriber type* field set to *Prefetch* in the *Subscriber* properties window.
image::anypoint-mq/3.x/amq-3x-subscriber-prefetch.png[Prefetch subscriber type]


For the `prefetch` subscriber-type, you configure the `maxLocalMessages` parameter to specify the target size for a full buffer, which controls how quickly messages are taken from the queue.
...
The most basic `polling` subscriber-type declaration looks like this:

.The arrow shows the value of the *Subscriber type* field set to *Polling* in the *Subscriber* properties window.
image::anypoint-mq/3.x/amq-3x-subscriber-polling.png[Polling subscriber type]
...
.The screenshot shows (*1*) the *Payload* and (*2*) the *Attributes* of the message in the *Output* tab.
image::anypoint-mq/3.x/amq-3x-subscriber-output.png[Message output payload and attributes]
...
.The arrow shows the value of the *Scheduling Strategy* field set to *Fixed Frequency* in the *Subscriber* properties window.
image::anypoint-mq/3.x/amq-3x-subscriber-polling-fixed.png[Fixed Frequency Scheduling Strategy]
...
.The arrow shows the value of the *Scheduling Strategy* field set to *Cron* in the *Subscriber* properties window.
image::anypoint-mq/3.x/amq-3x-subscriber-polling-cron.png[Cron Scheduling Strategy]
