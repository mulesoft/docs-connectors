...
1. Select **Search in Exchange**, and search for the Validation Module.
1. Add the extension.
1. You can now search in the Mule Palette for operations of the Validation Module. 

== See Also

xref:validation/validation-documentation.adoc[Validation Module Technical Reference]
