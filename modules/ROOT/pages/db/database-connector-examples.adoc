...
:page-aliases: db/db-connector-query.adoc, db/db-connector-insert-update-delete.adoc, db/db-connector-sp.adoc, db/db-connector-ddl.adoc, db/db-connector-bulk-ops-ref.adoc, db/db-connector-datatypes-ref.adoc, db/db-connector-transactions-ref.adoc, db/db-connector-execute-script-ref.adoc, db/database-documentation.adoc
