...
Which can be specified as indicated in the previous example, you can now set additional specific properties if you have the need to do so, for any Database provider. These additional properties will not override any of the main properties, if any of those was previously set.

This example shows you how to add properties to your database pooling profile using the `db:additional-properties` element:
