= Configure the NetSuite Connector in Studio 7
...
+
image::netsuite/netsuite-login-studio.png[login authentication]
+
[%header,cols="30s,70a"]
|===
...
+
image::netsuite/netsuite-request-studio.png[request based authentication]
+
[%header,cols="30s,70a"]
|===
|Parameter |Description
...
.. SSO Authentication
+
image::netsuite/netsuite-sso-studio.png[request based authentication]
+
[%header,cols="30s,70a"]
|===
|Parameter |Description
...
+
image::netsuite/netsuite-token-studio.png[request based authentication]
+
[%header,cols="30s,70a"]
|===
|Parameter |Description
...
+
image::netsuite/netsuite-enable-suitescript.png[Enable SuiteScript]
+
...
+
image::netsuite/netsuite-script-type.png[Select Script Type]
+
. Fill out the form using the content of the script you uploaded, and deploy the script.
+
image::netsuite/netsuite-setup-script.png[Setup Script]
+
...
+
image::netsuite/netsuite-script-deployment.png[Script Deployment]
...
+
image::netsuite/netsuite-demo-connection-test.png[Test Connection]
+
. Open a browser and access the URL `+http://localhost:8081+`. You should see the application deployed:
+
image::netsuite/netsuite-demo-main-page.png[Demo Index]

=== About the flows

. html-form-flow: Renders the HTML form with a `parseTemplate` component.
+
image::netsuite/netsuite-html-form-flow.png[Flow HMTL Form]
+
. restletGet: Calls the GET function of a RESTlet.
+
image::netsuite/netsuite-restlet-get.png[Flow HMTL Form]
+
. restletPost: Calls the POST function of a RESTlet.
+
image::netsuite/netsuite-restlet-post.png[Flow Processor 1]
+
. restletDelete: Calls the DELETE function of a RESTlet.
+
image::netsuite/netsuite-restlet-delete.png[Flow Processor 1]

== Next Steps

After configuring Studio, see the xref:netsuite/netsuite-examples.adoc[Examples] topic
for more configuration ideas.

== See Also

* Access the xref:netsuite/netsuite-about.adoc[NetSuite connector]
