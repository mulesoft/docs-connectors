= NetSuite - Design Center Configuration - Mule 4
...
the xref:netsuite/netsuite-connector-reference.adoc[NetSuite Connector Reference]. 
...
. In *Select a component*, search for the NetSuite Connector.
