...
To enable logging of the http interactions of the connector with Netsuite Openair, a logger must be configured in the log4j2.xml file of the Mule application as follows (within the Loggers section):
