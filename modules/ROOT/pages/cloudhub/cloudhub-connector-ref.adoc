...
| Environment a| String |  (Optional) Anypoint Platform environment to use. By default the enviroment defined as the default in Anypoint Platform is used. |  |
| Anypoint Platform URL a| String |  This is used to change between the US and EU Anypoint Platform if it is required. |  `+https://anypoint.mulesoft.com+` |
