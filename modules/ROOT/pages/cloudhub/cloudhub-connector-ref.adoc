= CloudHub Connector Reference - Mule 4
...
Anypoint Connector for CloudHub provides the capability of Create and List Notifications, and to retrieve the status of created applications on CloudHub.
...
| Environment a| String |  Platform Environment to use. It is Optional, and by default will be used the one defined as Default in the platform. |  |
| Anypoint Platform URL a| String |  This is used to change between the US and EU Anypoint Platform if is required. |  `+https://anypoint.mulesoft.com+` |
