...
*Reviewers, should this say "with the following structure" or "with the following attributes, like the text for Find Files? Can we use the same terminology for all structures?"*
*Another comment - in the Reference Guide, this operation is called Create File From Payload. Shouldn't the Reference Guide Match what's in Studio?*
