...
** *Deleted Objects* - Trigger your app when a MongoDB user deletes an object.
** *Modified Objects* - Trigger your app when a MongoDB user modifies an objectd.
** *New Object* - Trigger your app when a MongoDB user creates an object. 
+
