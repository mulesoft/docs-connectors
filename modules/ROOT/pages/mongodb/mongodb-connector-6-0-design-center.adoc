...
For information about Design Center field values, see the xref:mongodb/mongodb-connector-reference.adoc[MongoDB Connector Reference].
...
|===
|Fields |Description
|Collection Name |Location of the collection. Create this collection in the database that you selected in the global configuration.
