...
. To use the MongoDB connector as an input source trigger, choose the Object Listener input source.
+
...
*Reviewers: It is not clear if this is an alternative way of passing fields or if it is an alternative way of passing fields as a literal list. Which is it?*
|===
+
* Remove Documents:
+
