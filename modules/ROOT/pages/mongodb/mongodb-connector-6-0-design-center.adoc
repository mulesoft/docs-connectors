...
To set up a MongoDB configuration use the following fields:
...
|===
|Field |Description
|Collection Name |Location that points a collection to use. Create this collection in the database that you selected in the global configuration.
|Fields (optional) |Document to insert. If you don't use the _id field to specify an object, MongoDB automatically generates one.
...
|===
|Fields |Description
|Collection Name |Location that points to the collection you want. Create this collection in the database that you selected in the global configuration.
