...
MongoDB Connector v6.0.0 and later supports the use of SSL, if your instance supports it. To set up the global configuration for SSL, select the `TLS context` property in the *Security* tab in your MongoDB connection. *Reviewers, what does it mean "if your instance supports it."" Does this mean your MongoDB instance?*
