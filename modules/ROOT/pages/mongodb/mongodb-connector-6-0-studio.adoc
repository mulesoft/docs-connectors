...
+
The default value for the *Connect timeout* field is 30000 milliseconds (30 seconds). Any connection requests that take longer than 30 seconds to send and receive throws an exception.
+
