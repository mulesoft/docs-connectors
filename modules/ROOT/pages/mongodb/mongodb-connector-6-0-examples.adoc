...
. Click on *Transform Message* and enter two key-value pairs:
+
...
----
+
. From the Mule Palette view, drag other *Transform Message* components after the MongoDB connector.
...
*Reviewers, what is this trying to say? There are many other operations, so why is this here?*
+
* Find documents
* Update Documents
