...
// Is that correct, or should this be *Subscribe Channel Listener*?
...
// Where does the next paragraph fit in? Is it a step to perform after step 5 in the previous procedure?
