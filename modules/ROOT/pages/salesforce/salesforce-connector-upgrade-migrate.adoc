...
*Is a connection provider the same as an input source?*
...
| Create
a| Return type is now BulkOperationResult.
...
| Hard delete bulk | Create Job operation with a `hardDelete` operation parameter and a Create batch operation BulkOperationResult
