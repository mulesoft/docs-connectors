...
* Added Connection Pool Config tab to support multi-threading running for operations. This contains 3 parameters that
...
configuration. It has a default value of 0 seconds and it can be override by any operation.
