...
* *Key Store* (required)
+
Path to the keystore used to sign data during authentication. Use only a Java-format keystore. See xref:salesforce/salesforce-connector-config-topics.adoc#keystoregen[Generate a Keystore File].
+
...
* *Key Store* (required)
+
Path to the keystore used to sign data during authentication. Format the keystore as a JAVA. See xref:salesforce/salesforce-connector-config-topics.adoc#keystoregen[Generate a Keystore File].
+
* *Store Password* (required)
+
Key store password
