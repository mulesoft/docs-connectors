...
Creates a Batch using the given objects within the specified Job. The Job can be of XML or CSV type.  This operation uses the Bulk API. The operation is performed asynchronously.
...
Creates a Batch using the given query. This operation uses the Bulk API. The operation is performed asynchronously.
...
Creates a Batch using the given stream within the specified Job. The stream can have a CSV, XML, ZIP_CSV, or ZIP_XML format. This operation uses the Bulk API. It is performed asynchronously.
