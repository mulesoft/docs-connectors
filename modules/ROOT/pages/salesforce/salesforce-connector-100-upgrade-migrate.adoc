...
| Get session id | There is no replacement for this operation but it should not be needed as the connector should be used to leverage the Salesforce API functionalities
|===
