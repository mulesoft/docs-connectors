...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Since a| String |  +++Specify a date in the yyyy-MM-ddTHH:mm:ssZ MULE_DATETIME_FORMAT format where Z is the time zone (i.e. 2019-03-17T16:30:40-03:00) to retrieve the selected objects+++ |  | 
