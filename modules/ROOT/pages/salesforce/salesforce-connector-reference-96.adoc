...
** ZIP_XML
** ZIP_CSV
** ZIP_JSON |The only value allowed is ZIP_CSV. If any other value is selected, an exception is thrown. The error is an INVALID REQUEST DATA with the message `The only content type supported is CSV`. | ZIP_CSV | 
