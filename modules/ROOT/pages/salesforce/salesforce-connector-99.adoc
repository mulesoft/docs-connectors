= Salesforce Connector 9.9 - Get Started - Mule 4
...
Reference Guide: xref:salesforce/salesforce-connector-reference-98.adoc[Salesforce Connector Reference v9.9] +
...
|xref:salesforce/salesforce-connector-config-topics.adoc#objectstoreusage[Object Store Usage] |How the connector uses object stores
