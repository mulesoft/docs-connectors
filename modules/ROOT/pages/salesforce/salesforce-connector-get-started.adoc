...
* Starting users -- Read Get Started (this document) and configure your Mule application in 
...
helps you extend your understanding of Salesforce actions.
...
Now that you have completed Getting Started, you can try out xref:salesforce/salesforce-connector-design-center.adoc[Design Center] or 
xref:salesforce/salesforce-connector-studio.adoc[Anypoint Studio].
