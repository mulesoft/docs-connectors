...
* Power user - Read the XML and Maven Support, xref:salesforce-connector-configuration-topics.adoc[Configuration Topics], and xref:salesforce-connector-use-cases.adoc[Use Cases].
