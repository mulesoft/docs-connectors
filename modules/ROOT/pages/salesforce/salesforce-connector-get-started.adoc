...
https://www.mulesoft.com/exchange/[Anypoint Exchange] provides templates and examples to simplify your use of the Salesforce connector. Templates provide a starting point that enable you to add additional functionality. Examples provide a complete solution.
