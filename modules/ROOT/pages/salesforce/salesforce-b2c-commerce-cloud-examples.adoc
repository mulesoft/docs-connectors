...
+
image::salesforce/salesforce-b2c-commerce-cloud-http-listener-config.jpg[]
+
. Add Variable, Post Basket, Post Order, and Post Customer operations to the flow.
+
image::salesforce/salesforce-b2c-commerce-cloud-post-checkout-flow.jpg[]
+
. Obtain the required body for the Post Basket operation from the postman and save it into Variable.
+
image::salesforce/salesforce-b2c-commerce-cloud-basket-body-variable.jpg[]
+
...
+
image::salesforce/salesforce-b2c-commerce-cloud-customer-configuration.jpg[]
+
...
+
image::salesforce/salesforce-b2c-commerce-cloud-post-basket-config.jpg[]
+
. Complete the required fields for the Post Order operation and save the configuration.
+
image::salesforce/salesforce-b2c-commerce-cloud-post-order-config.jpg[]
+
. Supply the required body for the Post Customers operation and save the configuration.
+
image::salesforce/salesforce-b2c-commerce-cloud-post-customer.jpg[]
+
