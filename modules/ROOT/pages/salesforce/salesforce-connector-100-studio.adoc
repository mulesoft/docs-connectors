...
You can configure Apex REST and SOAP access using Studio or in XML. When you connect to Salesforce, Salesforce Connector gets the names of the Apex classes, and methods belonging to them, that can be invoked.
