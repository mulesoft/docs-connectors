...
. Configure an input source for your flow.
...
+
To use the Salesforce connector as an input source, drag one of these operations to the Source area of a flow:
+
* *On Deleted Object*
+
...
+
Subscribes to a topic. This trigger provides topic-related notification settings for new events and events stored by Salesforce within the 24-hour retention period. Events that take place on records in the specified topic trigger the flow.
+
* *Subscribe channel listener*
+
Subscribes to a streaming channel. This trigger provides channel-related notification settings for new events that take place after you subscribe.
+
* *Subscribe topic listener*
+
Subscribe to a topic. This trigger provides topic-related notification settings for new events that take place after you subscribe.
+
...
+
In Studio, you typically store the certificate in the workspace that contains your Mule application.
+
...
. Click *Manage*. In the OAuth Policies section, expand the *Permitted Users* dropdown, and select *Admin Approved Users are Pre-Authorized*.
+
. Click *Save*.
