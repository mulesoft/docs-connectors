...
This example shows how to use Salesforce Connector to perform an upsert for an object. The example uses the following custom object types to create a structure in Salesforce for this relationship:
...
* The `CustomField` field identifies the value and name of the `MyOtherCustomObject` to reference. In this case, `CustomField` identifies the field `CustomField` that has a value of `ABC123`.
