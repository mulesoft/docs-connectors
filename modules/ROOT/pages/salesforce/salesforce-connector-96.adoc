...
|===
+
NOTE: In version 9.6.0, OAuth 2.0 is listed as Deprecated. This connection type is not deprecated and you can ignore the `Deprecated` label.
+
...
+
NOTE: In version 9.6.0 OAuth 2.0 is shown as Deprecated. You can ignore the Deprecated label.
+
