= Salesforce Studio Configuration v10.1 - Mule 4
...
See also xref:salesforce/v10.1/salesforce-connector-101-xml-maven.adoc#apexml[Apex XML Settings].
...
After completing Studio set up, see xref:salesforce/v10.1/salesforce-connector-101-config-topics.adoc[Additional Configuration Information].
