...
For information about Flow Designer field values, see the xref:salesforce/salesforce-connector-reference-101.adoc[Salesforce Connector Reference].
...
* *Consumer Key* (required)
+
Consumer key for the Salesforce-connected app. See xref:salesforce/salesforce-connector-101-config-topics.adoc#create-consumer-key[Create a Consumer Key].
+
* *Consumer Secret* (required)
+
Consumer secret for accessing Salesforce
