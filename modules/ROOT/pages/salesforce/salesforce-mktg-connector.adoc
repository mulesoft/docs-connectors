...
See <<salesforce/salesforce-mktg-connector.adoc#providing-subclass,Providing a Subclass as a Type to a Complex Field>> for an example detailing how to achieve this.
...
For more information, see the <<salesforce/salesforce-mktg-connector.adoc#asynchronous-operations,Asynchronous Operations>>.
