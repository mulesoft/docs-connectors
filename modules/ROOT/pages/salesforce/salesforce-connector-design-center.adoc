...
For information on Design Center field values, see the xref:salesforce/salesforce-connector.adoc[Salesforce Connector Reference] list for this Salesforce version.
