...
* Power users
+
Read xref:salesforce/salesforce-connector-101-xml-maven.adoc[XML and Maven Support],
the xref:salesforce/salesforce-connector-101-config-topics.adoc[Additional Configuration] topic,
and xref:salesforce/salesforce-connector-101-examples.adoc[Examples].
...
|===
|Subject |Description
|xref:salesforce/salesforce-connector-101-examples.adoc#accandtrans[Accept and Transform Data] |Accept and transform data from Salesforce example
...
|xref:salesforce/salesforce-connector-101-examples.adoc#parentchild[Parent Child Relationships] |Create and update parent and child relationships example
