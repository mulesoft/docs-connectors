...
| xref:salesforce/salesforce-connector-101.adoc[Salesforce Connector v10.1] +
xref:salesforce/salesforce-connector-reference-101.adoc[Salesforce Connector Reference v10.1]
...
* Added support for Audience URL for the OAuth JWT connection
