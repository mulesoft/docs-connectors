...
* The Salesforce connector does not expose _all_ possible operations of the Salesforce APIs.
...
The Salesforce https://www.salesforce.com/us/developer/docs/api_asynch/[Bulk API] quickly and securely load batches of your organization's data into Salesforce. See also: <<Loading Data in Batches>>.

*Streaming API:*

The Salesforce http://www.salesforce.com/us/developer/docs/api_streaming/[Streaming API] securely receives notifications for changes to your organization's information in Salesforce. See <<Receiving Inbound Data From Salesforce>> for more information on the use of the Streaming API.
