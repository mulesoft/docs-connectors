...
| xref:salesforce/salesforce-connector-10.adoc[Salesforce Connector v10.0] +
xref:salesforce/salesforce-connector-reference-10.adoc[Salesforce Connector Reference v10.0]
