...
. Search for the Salesforce connector, click on the connector in Exchange, and click *Add to project*.
...
Now that you have completed Studio set up, see the xref:salesforce/salesforce-connector-config-topics.adoc[Additional Configuration] topics.
