...
These are XML and POM file configuration information and XML-related usage topics. To use this connector with Maven, view the pom.xml dependency information in the Dependency Snippets in Anypoint Exchange.
