...
. Proceed to configure your trigger. For more information, see the [connector] Reference.

Now you're ready to configure a component.

== Configure the [connector] Target Component
. Click the plus sign to the right of the trigger card.
