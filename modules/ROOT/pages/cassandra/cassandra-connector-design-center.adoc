...
. Proceed to configure your trigger. For more information, see xref:cassandra/cassandra-connector-reference.adoc[Cassandra Connector Reference]. 
...
After completing these steps, see xref:cassandra/cassandra-connector-examples.adoc[Cassandra Example] to experiment with the use cases described there.
