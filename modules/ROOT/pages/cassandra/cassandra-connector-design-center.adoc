= Cassandra Design Center - Mule 4
...
. Proceed to configure your trigger. For more information, see xref:cassandra-connector-reference.adoc[Cassandra Connector Reference]. 

Now you're ready to configure a component.

== Configure the Target Component

. Click the plus sign on the right of the trigger card.
. Under the *Select a component* card, search for the connector.
...
. Click the Cassandra Connector to edit it and set these fields.
...
After completing these steps, see xref:cassandra-connector-examples.adoc[Cassandra Example] to experiment with the use cases described there.
