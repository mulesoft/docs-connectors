...
the *Dependency Snippets* link in https://www.mulesoft.com/exchange/org.mule.connectors/mule-peoplesoft-connector/[Anypoint Exchange].
...
To enable logging of the interactions of the connector with Peoplesoft, configure a logger in the log4j2.xml file of the Mule app as follows (inside the Loggers tag in log4j2.xml):
