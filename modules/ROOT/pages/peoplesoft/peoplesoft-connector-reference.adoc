...
Default: false +
Required: No
| Date format for the conversion| Format the connector uses to convert DateTime values to PeopleSoft. By default, the connector uses "MM/dd/yyyy K:mm:ssa" where MM : month , dd : day , yyyy : calendar year , K : hour , mm : minutes , ss : seconds , a : AM/PM . This format depends  on the Peoplesoft instance .
