...
Default: false +
Required: No
| Date format for the conversion | DateTime format used for the conversion of values . By default uses "MM/dd/yyyy K:mm:ssa"
 where MM : month , dd : day , yyyy : calendar year , K : hour , mm : minutes , ss : seconds , a : AM/PM . This format depends
 on the Peoplesoft instance .
