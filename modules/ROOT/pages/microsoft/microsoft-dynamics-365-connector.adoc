...
* Listener Config - A reference to an to use to create the listener to catch the access token callback endpoint 
...
* Resource - The Application ID URI of the web API's secured resource
