...
See xref:release-notes::connector/microsoft-dynamics-365-connector-release-notes-mule-4.adoc[Microsoft Dynamics 365 Connector Release Notes] for compatibility information.
...
| Before a| String |  +++The name of a flow to be execute right before starting the OAuth dance.+++ |  | 
| After a| String |  +++The name of a flow to be execute right after an accessToken has been received.+++ |  | 
