...
----
+
. In *Mule Palette > Core*, select *Logger*, then drag it to the canvas after the *Execute command* operation.  
...
http://www.mulesoft.org/schema/mule/powershell http://www.mulesoft.org/schema/mule/powershell/current/mule-powershell.xsd">
	<http:listener-config name="HTTP_Listener_config" doc:name="HTTP Listener config" doc:id="f04f88ea-e572-496d-991b-37a0f9dfdd2d" >
		<http:listener-connection host="localhost" port="8081" />
	</http:listener-config>
	<powershell:config name="Powershell_Configuration" doc:name="Powershell Configuration" doc:id="528c3cfa-f64f-4bb0-8725-754a97ebea2c" >
		<powershell:powershell-connection host="localhost" username="user" password="password" operativeSystem="LINUX"/>
	</powershell:config>
	<flow name="powershell-exampleFlow" doc:id="dce31eaa-1323-40bf-a6f5-16f415c6790f" >
		<http:listener doc:name="Listener" doc:id="344c8f8e-8f0b-4704-8402-d533472c28f9" config-ref="HTTP_Listener_config" path="/executescriptfile"/>
		<parse-template doc:name="Parse Template" doc:id="abc1114d-4b12-42fd-8be6-e88c4dab1887" location="get-en-param.ps1" />
		<powershell:execute-script-file doc:name="Execute script file" doc:id="10ec32df-0ad8-4489-b52f-77b9d9335b8f" config-ref="Powershell_Configuration">
		...
		<logger level="INFO" doc:name="Logger" doc:id="4998ddb5-c8a7-4584-bcb2-378052d4dba6" message="#[payload]]"/>
	</flow>
</mule>
----
+
