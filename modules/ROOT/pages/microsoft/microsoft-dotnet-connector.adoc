...
Anypoint Connector for Microsoft .NET enables you to execute native .NET code in a Mule Runtime application.
...
NOTE: This connector is only compatible with Java 8.
...
https://www.mulesoft.com/exchange/com.mulesoft.connectors/mule-microsoft-dotnet-connector/[Microsoft .NET Connector] in
