...
. Select *Microsoft Dynamics 365 Connector* and select your input source as either *On New Object* or *On Modified Object*, and see xref:microsoft/microsoft-dynamics-365-connector.adoc#trigger-required-fields[Trigger Required Fields].
