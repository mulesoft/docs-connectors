...
. Define optional attributes for the default, the entity ID is a required attribute to indicate which entity instance to update.
+
...
----
+
image::microsoft/microsoft-365-update-entity.png[]
+
Flow definition:
+
[source,xml,linenums]
