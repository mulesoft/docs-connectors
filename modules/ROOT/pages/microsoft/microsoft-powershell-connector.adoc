...
Also, in order to install Powershell on Linux you can follow these https://docs.microsoft.com/en-us/powershell/scripting/install/installing-powershell-core-on-linux?view=powershell-6[steps]

NOTE: The connector does not support executing a powershell script on a macOS machine. 
