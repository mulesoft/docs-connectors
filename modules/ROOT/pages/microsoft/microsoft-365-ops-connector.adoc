...
Microsoft Dynamics 365 for Operations Connector v2.0
...
+
For more information, see the xref:microsoft/microsoft-365-ops-connector-reference.adoc[Microsoft Dynamics 365 for Operations Connector Reference].
+
. If using the *Retrieve Multiple* operation, configure the *Data Query URL* field:
+
image::microsoft/microsoft-365-ops-retrieve-multiple.png[]
+
