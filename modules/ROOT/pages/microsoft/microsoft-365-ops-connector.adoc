...
You can also paste this XML code into Anypoint Studio to experiment with the flow.

Using a properties file, define these attributes for use in the flow:
