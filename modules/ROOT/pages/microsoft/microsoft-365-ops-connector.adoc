...
+
image::microsoft/microsoft-365-ops-dc-oauth2.png[Design Center OAuth configuration]
|===
...
image::microsoft/microsoft-365-ops-dc-oauth-username-pass.png[Design Center OAuth username and password config]
...
+
image::microsoft/microsoft-365-ops-studio-use-case.png[Studio 7 dynamics-op-testFlow icons]
