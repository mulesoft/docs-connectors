...
image::windows/win-gw-anypoint-gateway.png[Gateway install wizard]
...
image::windows/win-gw-services-tool.png[Services Tool]
...
image::windows/win-gw-local-computer-cert-store.png[Local Computer certificate store]
...
image::windows/msmq-windows-gateway.png[Windows Gateway]
