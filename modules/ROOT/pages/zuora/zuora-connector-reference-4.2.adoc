...
| Connection a| <<config_connection, Connection>> | The connection types to provide to this configuration. | | x
...
| Connection Id a| String a|  The ID of the connection that you want to accept. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Add Attachments Request Data a| Any |  a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Amend Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Apply Credit Memo Request Data a| Any |  a| `#[payload]` | 
| Credit Memo Id a| String a| The unique ID of a credit memo. 

For example: `8a8082e65b27f6c3015ba45ff82c7172` |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Apply Payment Request Data a| Any |  a| `#[payload]` | 
| Payment Id a| String a| The unique ID of an unapplied payment. 

For example: `8a8082e65b27f6c3015b89e4344c16b1` |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Id a| String a|  The ID of the job. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Aqua_  Post Query Or Export Deleted Data Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Cancel Authorization Request Data a| Any |  a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Debit Memo Id a| String a| The unique ID of a debit memo. 

For example: `8a8082e65b27f6c3015ba419f3c2644e` |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Refund Id a| String a| The unique ID of a refund. 

For example: `4028905f5a87c0ff015a889e590e00c9` |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Cancel Subscription Request Data a| Any |  a| `#[payload]` | 
| Subscription Key a| String a| Possible values are:

* A subscription number
* A subscription ID |  | x
| Zuora Version a| String a| The minor version of the Zuora REST API.
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| X Zuora Wsdl Version a| String |  Zuora WSDL version number. |  '79' | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create A Notification Definition Request Data a| Any |  a| `#[payload]` | 
| Authorization a| String |  `Bearer {token}` for a valid OAuth token.   Note that you must regenerate the OAuth token after the Notification and the Configurable Event features are enabled in your Zuora tenant. The OAuth tokens generated before the features are turned on do not work. |  | x
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Account Request Data a| Any |  a| `#[payload]` | 
| Zuora Version a| String a| The minor version of the Zuora REST API.
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Account Crud Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Accounting Code Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Accounting Period Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create An Email Template Request Data a| Any |  a| `#[payload]` | 
| Authorization a| String |  `Bearer {token}` for a valid OAuth token.   Note that you must regenerate the OAuth token after the Notification and the Configurable Event features are enabled in your Zuora tenant. The OAuth tokens generated before the features are turned on do not work. |  | x
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create An Event Trigger Request Data a| Any |  a| `#[payload]` | 
| Authorization a| String |  `Bearer {token}` for a valid OAuth token. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Apple Pay Payment Method Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Authorization Request Data a| Any |  a| `#[payload]` | 
| Payment Method Id a| String |  Unique identifier of a payment method. (Since this ID is unique, and linked to a customer account in the system, no customer identifier is needed.) |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Bill Run Crud Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Billing Preview Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Billing Preview Run Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Contact Crud Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Credit Balance Adjustment Crud Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Credit Card Payment Method Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Credit Memo From Charge Request Data a| Any |  a| `#[payload]` | 
| Zuora Version a| String a| The minor version of the Zuora REST API. See https://www.zuora.com/developer/api-reference/#section/API-Versions/Minor-Version[Minor Version] for information about REST API version control.
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Credit Memo From Invoice Request Data a| Any |  a| `#[payload]` | 
| Invoice Id a| String a|  The ID of the invoice. 

For example: `2c92c8955bd63cc1015bd7c151af02ab` |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Debit Memo From Charge Request Data a| Any |  a| `#[payload]` | 
| Zuora Version a| String a| The minor version of the Zuora REST API. See https://www.zuora.com/developer/api-reference/#section/API-Versions/Minor-Version[Minor Version] for information about REST API version control.
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Debit Memo From Invoice Request Data a| Any |  a| `#[payload]` | 
| Invoice Id a| String a|  The ID of the invoice. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Document Properties Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Entity Multi Entity Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Export Crud Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Import Crud Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Invoice Adjustment Crud Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Invoice Payment Crud Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Job To Hard Delete Billing Document Files Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Journal Run Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Order Request Data a| Any |  a| `#[payload]` | 
| Zuora Version a| String a| The minor version of the Zuora REST API.
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Order Asynchronously Request Data a| Any |  a| `#[payload]` | 
| Zuora Version a| String a| The minor version of the Zuora REST API.
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Payment Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Payment Crud Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Payment Method Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Payment Method Crud Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Payment Run Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Product Crud Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Product Rate Plan Charge Crud Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Product Rate Plan Crud Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Refund Crud Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Revenue Schedule For Credit Memo Item Distribute By Date Range Request Data a| Any |  a| `#[payload]` | 
| Cmi Id a| String a| The unique ID of a credit memo item. You can get the credit memo item ID from the response of https://www.zuora.com/developer/api-reference/#operation/GET_CreditMemoItems[Get credit memo items]. |  | x
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Revenue Schedule For Credit Memo Item Manual Distribution Request Data a| Any |  a| `#[payload]` | 
| Cmi Id a| String a| The unique ID of a credit memo item. You can get the credit memo item ID from the response of https://www.zuora.com/developer/api-reference/#operation/GET_CreditMemoItems[Get credit memo items]. |  | x
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Revenue Schedule For Debit Memo Item Distribute By Date Range Request Data a| Any |  a| `#[payload]` | 
| Dmi Id a| String a| The unique ID of a debit memo item. You can get the debit memo item ID from the response of https://www.zuora.com/developer/api-reference/#operation/GET_DebitMemoItems[Get debit memo items]. |  | x
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Revenue Schedule For Debit Memo Item Manual Distribution Request Data a| Any |  a| `#[payload]` | 
| Dmi Id a| String a| The unique ID of a debit memo item. You can get the debit memo item ID from the response of https://www.zuora.com/developer/api-reference/#operation/GET_DebitMemoItems[Get debit memo items]. |  | x
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Revenue Schedule For Invoice Item Adjustment Distribute By Date Range Request Data a| Any |  a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Revenue Schedule For Invoice Item Adjustment Manual Distribution Request Data a| Any |  a| `#[payload]` | 
| Invoice Item Adj Key a| String |  ID or number of the Invoice Item Adjustment, for example, e20b07fd416dcfcf0141c81164fd0a72.  If the specified Invoice Item Adjustment is already associated with a revenue schedule, the call fails. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Revenue Schedule For Invoice Item Distribute By Date Range Request Data a| Any |  a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Revenue Schedule For Invoice Item Manual Distribution Request Data a| Any |  a| `#[payload]` | 
| Invoice Item Id a| String |  A valid Invoice Item ID. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Revenue Schedule On Subscription Charge Request Data a| Any |  a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Sequence Sets Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Stored Credential Profile Request Data a| Any |  a| `#[payload]` | 
| Payment Method Id a| String |  Unique identifier of a payment method. (Since this ID is unique, and linked to a customer account in the system, no customer identifier is needed.) |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Subscription Request Data a| Any |  a| `#[payload]` | 
| Zuora Version a| String a| The minor version of the Zuora REST API.
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Summary Journal Entry Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Taxation Item Crud Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Taxation Items For Credit Memo Request Data a| Any |  a| `#[payload]` | 
| Credit Memo Id a| String a| The unique ID of a credit memo. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Taxation Items For Debit Memo Request Data a| Any |  a| `#[payload]` | 
| Debit Memo Id a| String a| The unique ID of a debit memo. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Unit Of Measure Crud Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Create Usage Crud Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Decrypt Rsa Signature Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Delete Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| X Zuora Wsdl Version a| String |  Zuora WSDL version number. |  '79' | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Id a| String a|  The ID of the notification definition to be deleted. |  | x
| Authorization a| String |  `Bearer {token}` for a valid OAuth token.   Note that you must regenerate the OAuth token after the Notification and the Configurable Event features are enabled in your Zuora tenant. The OAuth tokens generated before the features are turned on do not work. |  | x
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Id a| String a|  The ID of the email template to be deleted. |  | x
| Authorization a| String |  `Bearer {token}` for a valid OAuth token.   Note that you must regenerate the OAuth token after the Notification and the Configurable Event features are enabled in your Zuora tenant. The OAuth tokens generated before the features are turned on do not work. |  | x
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Document Properties Id a| String a| The unique ID of document properties. 

For example: `402892c74c9193cd014c96bbe7c101f9` |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Id a| String a| The unique ID of the payment to be deleted. 

For example: `2c92c0f85d4e95ae015d4f7e5d690622` |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Payment Run Id a| String a| The unique ID of a payment run. 

For example: `402890245f097f39015f0f074a2e0566` |  | x
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Id a| String a| The unique ID of the product rate plan charge to be deleted. 

For example: `2c93808457d787030157e031fcd34e19` |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Rs Number a| String a| Revenue schedule number of the revenue schedule you want to delete, for example, RS-00000256. 
...
* Cannot have a revenue schedule date in a closed accounting period. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Id a| String a|  The ID of the sequence set to delete |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Id a| String a| The unique ID of a taxation item. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Object a| String a| API name of an object in your Zuora tenant. 

For example: `InvoiceItem`. See https://www.zuora.com/developer/api-reference/#section/Zuora-Object-Model[Zuora Object Model] for the list of valid object names. Depending on the features enabled in your Zuora tenant, you may not be able to list the fields of some objects. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Distribute Revenue Across Accounting Periods Request Data a| Any |  a| `#[payload]` | 
| Rs Number a| String a| Revenue schedule number of the revenue schedule you want to delete, for example, RS-00000256. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Distribute Revenue By Recognition Start And End Dates Request Data a| Any |  a| `#[payload]` | 
| Rs Number a| String a| Revenue schedule number of the revenue schedule you want to delete, for example, RS-00000256. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Distribute Revenue On Specific Date Request Data a| Any |  a| `#[payload]` | 
| Rs Number a| String a| Revenue schedule number of the revenue schedule you want to delete, for example, RS-00000256. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Edit Attachments Request Data a| Any |  a| `#[payload]` | 
| Attachment Id a| String |  Id of the attachment to be deleted. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Email Billing Documents Generated From Bill Run Request Data a| Any |  a| `#[payload]` | 
| Bill Run Id a| String a|  The ID of the bill run. 

For example: `2c92c8f95d0c886e015d11287a8f0f8b` |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Email Credit Memo Request Data a| Any |  a| `#[payload]` | 
| Credit Memo Id a| String a| The unique ID of a credit memo. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Email Debit Memo Request Data a| Any |  a| `#[payload]` | 
| Debit Memo Id a| String a|  The unique ID of a debit memo. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Email Invoice Request Data a| Any |  a| `#[payload]` | 
| Invoice Id a| String a|  The ID of the invoice. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Execute Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| X Zuora Wsdl Version a| String |  Zuora WSDL version number. |  '79' | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Generate Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| X Zuora Wsdl Version a| String |  Zuora WSDL version number. |  '79' | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Generate An Oauth Token Request Data a| Any |  a| `#[payload]` | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Generate Billing Documents By Account Request Data a| Any |  a| `#[payload]` | 
| Id a| String a|  The ID of the customer account that billing documents are generated for. 

For example: `8a8082e65b27f6c3015ba3e326b26419` |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Generate Quotes Document Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Generate Rsa Signature Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Sort a| String a| This parameter restricts the order of the data returned in the response. You can use this parameter to supply a dimension you want to sort on.  
...
| Charge Key a| String a|  The unique ID of a product rate plan charge. 

For example: `8a8082e65ba86084015bb323d3c61d82` |  | x
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Subscription Id a| String a|  The ID of the subscription whose amendment changes you want to retrieve. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Account Id a| String a|  The ID of the customer account that the billing documents are associated with. |  | x
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| As Of Date a| Date |  Billing states of the order are calculated as of this date. Invoices with the invoice date later than this date are not counted into the billed amount. The default value is today. |  | 
| Order Number a| String |  The number of the order to be deleted. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| End Time a| Date |  The final date and time of records to be returned. Defaults to now. Use the format `yyyy-MM-ddTHH:mm:ss` |  | 
| Start Time a| Date |  The initial date and time of records to be returned. Defaults to (end time - 1 day). Use the format `yyyy-MM-ddTHH:mm:ss` |  | 
| Object Id a| String a|  The ID of an object that triggered a callout notification. |  | 
...
| Event Category a| String a|  Category of records to be returned by event category.
...
* Otherwise, the numeric code of the event category. For example: `1210` See https://knowledgecenter.zuora.com/DC_Developers/AA_REST_API/Event_Categories_for_Notification_Histories[Event Categories for Notifications] for more information. |  | 
...
For example: `8a8082e65b27f6c3015ba45ff82c7172` |  | x
| Cmitemid a| String a| The unique ID of a credit memo item. You can get the credit memo item ID from the response of https://www.zuora.com/developer/api-reference/#operation/GET_CreditMemoItems[Get credit memo items]. |  | x
| Zuora Version a| String a| The minor version of the Zuora REST API. See https://www.zuora.com/developer/api-reference/#section/API-Versions/Minor-Version[Minor Version] for information about REST API version control.
...
For example: `8a8082e65b27f6c3015ba45ff82c7172` |  | x
| Partid a| String a| The unique ID of a specific credit memo part. You can get the credit memo part ID from the response of https://www.zuora.com/developer/api-reference/#operation/GET_CreditMemoParts[Get credit memo parts]. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
For example: `8a8082e65b27f6c3015ba45ff82c7172` |  | x
| Partid a| String a| The unique ID of a specific credit memo part. You can get the credit memo part ID from the response of https://www.zuora.com/developer/api-reference/#operation/GET_CreditMemoParts[Get credit memo parts]. |  | x
| Itempartid a| String a| The unique ID of a specific credit memo part item. You can get the credit memo part item ID from the response of https://www.zuora.com/developer/api-reference/#operation/GET_CreditMemoItemParts[Get credit memo part items]. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Start Date a| String |  Start date of the date range for which you want to get exchange rates.  The date must be in `yyyy-mm-dd` format, for example, 2019-01-15. The start date cannot be later than the end date. |  | x
| End Date a| String |  End date of the date range for which you want to get exchange rates.   The date must be in `yyyy-mm-dd` format, for example, 2019-01-16. The end date can be a maximum of 90 days after the start date. |  | x
...
For example: `8a8082e65b27f6c3015ba419f3c2644e` |  | x
| Dmitemid a| String a| The unique ID of a debit memo item. You can get the debit memo item ID from the response of https://www.zuora.com/developer/api-reference/#operation/GET_DebitMemoItems[Get debit memo items]. |  | x
| Zuora Version a| String a| The minor version of the Zuora REST API. See https://www.zuora.com/developer/api-reference/#section/API-Versions/Minor-Version[Minor Version] for information about REST API version control. 
...
By default, the response data is displayed in descending order by debit memo number.  `field_name` indicates the name of a sortable field. 
...
| Document Id a| String a|  The unique ID of document properties to be retrieved. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| End Time a| Date |  The end date and time of records to be returned. Defaults to now. Use the format `yyyy-MM-ddTHH:mm:ss`. The maximum date range (`endTime` - `startTime`) is three days. |  | 
| Start Time a| Date |  The initial date and time of records to be returned. Defaults to (end time - 1 day). Use the format `yyyy-MM-ddTHH:mm:ss`. The maximum date range (`endTime` - `startTime`) is three days. |  | 
...
| Event Category a| String a| Category of records to be returned by an event category.

The following formats are supported:

* `{Event Type Namespace}:{Event Type Name}`- If the Configurable Event features are enabled in your Zuora tenant. For example: `user.notification:NewSubscriptionCreated`
* Otherwise, numeric code of the event category. For example: `1210`. See https://knowledgecenter.zuora.com/DC_Developers/AA_REST_API/Event_Categories_for_Notification_Histories[Event Categories for Notifications] for more information. |  | 
| Page Size a| Number |  Number of rows returned per page. |  20 | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Provisioned a| String a|  Specify whether to retrieve provisioned or unprovisioned entities:   - `true`: 

Provisioned entities   - `false`: Unprovisioned entities
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Job Id a| String a|  The unique ID of a billing document file deletion job. 

For example: `2c92c8f83dc4f752013dc72c24ee016c` |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Start Date a| Date a|  The start date of the date range for which you want to get the metrics. The date must be in `yyyy-mm-dd` format. 

For example: `2019-12-03` |  | x
| End Date a| Date a|  The end date of the date range for which you want to get the metrics. The date must be in `yyyy-mm-dd` format. 
...
For example: `8a8082e65b27f6c3015b89e4344c16b1` |  | x
| Partid a| String a| The unique ID of a specific payment part. You can get the payment part ID from the response of https://www.zuora.com/developer/api-reference/#operation/GET_PaymentParts[Get payment parts]. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
For example: `8a8082e65b27f6c3015b89e4344c16b1` |  | x
| Partid a| String a| The unique ID of a specific payment part. You can get the payment part ID from the response of https://www.zuora.com/developer/api-reference/#operation/GET_PaymentParts[Get payment parts]. |  | x
| Itempartid a| String a| The unique ID of a specific payment part item. You can get the payment part item ID from the response of https://www.zuora.com/developer/api-reference/#operation/GET_PaymentItemParts[Get payment part items]. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Id a| String a|  The ID of a payment transaction log. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Product Id a| String a| The unique ID of the product you want to retrieve. 

For example: `8a808255575bdae4015774e9602e16fe` |  | x
...
| Configuration | String | The name of the configuration to use. | | x
| Page Size a| Number |  Number of rows returned per page. |  20 | 
| Product Id a| String a| The unique ID of a product. 

For example: `2c92c0f96487e16a016487f663c71a61` |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
For example: `4028905f5a87c0ff015a889e590e00c9` |  | x
| Refundpartid a| String a| The unique ID of a specific refund part. You can get the refund part ID from the response of https://www.zuora.com/developer/api-reference/#operation/GET_RefundParts[Get refund parts]. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
For example: `4028905f5a87c0ff015a889e590e00c9` |  | x
| Refundpartid a| String a| The unique ID of a specific refund part. You can get the refund part ID from the response of https://www.zuora.com/developer/api-reference/#operation/GET_RefundParts[Get refund parts]. |  | x
| Itempartid a| String a| The unique ID of a specific refund part item. You can get the refund part item ID from the response of https://www.zuora.com/developer/api-reference/#operation/GET_RefundItemParts[Get refund part items]. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Charge Key a| String a| The unique ID of the subscription rate plan charge. 

For example: `402892793e173340013e173b81000012` |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Charge Detail a| String a|  The segmented rate plan charges.  When an amendment results in a change to a charge, Zuora creates a segmented rate plan charge. Use this field to track segment charges.  
...
* A subscription number
* A subscription ID |  | x
| Version a| String a|  Subscription version. 
...
For example: `2c92c8955bd63cc1015bd7c151af02ab` |  | x
| Item Id a| String a| The unique ID of an invoice item. 

For example: `2c86c8955bd63cc1015bd7c151af02ef` |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Page Size a| Number |  Number of rows returned per page. |  20 | 
| Subscription Number a| String |  The number of the subscription to retrieve terms for. 

For example: `A-S00000001` |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Initiate Connection Multi Entity Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Invoice And Collect Request Data a| Any |  a| `#[payload]` | 
| Zuora Version a| String a| The minor version of the Zuora REST API. You need to set this parameter if you use: 

* `documentDate`
* `targetDate`

If you have the Invoice Settlement feature enabled, you need to specify this parameter. Otherwise, an error is returned. See https://www.zuora.com/developer/api-reference/#section/API-Versions[Zuora REST API Versions] for more information. |  | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Perform Mass Action Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Post Or Cancel Bill Run Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  Object id |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Post Usage Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Preview Order Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Preview Order Asynchronously Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Preview Subscription Request Data a| Any |  a| `#[payload]` | 
| Zuora Version a| String a| The minor version of the Zuora REST API.
...
See https://www.zuora.com/developer/api-reference/#section/API-Versions[Zuora REST API Versions] for more information. |  | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Query Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| X Zuora Wsdl Version a| String |  Zuora WSDL version number. |  '79' | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Query More Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| X Zuora Wsdl Version a| String |  Zuora WSDL version number. |  '79' | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Event Type Name a| String |  The name of the event. |  | 
| Email Template Id a| String a|  The ID of the email template. |  | 
| Authorization a| String |  `Bearer {token}` for a valid OAuth token.   Note that you must regenerate the OAuth token after the Notification and the Configurable Event features are enabled in your Zuora tenant. The OAuth tokens generated before the features are turned on do not work. |  | x
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Refund Credit Memo Request Data a| Any |  a| `#[payload]` | 
| Creditmemo Id a| String a| The unique ID of a credit memo. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Refund Payment Request Data a| Any |  a| `#[payload]` | 
| Payment Id a| String a| The unique ID of an unapplied payment. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Reject Payment Request Data a| Any |  a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Renew Subscription Request Data a| Any |  a| `#[payload]` | 
| Subscription Key a| String a|  Possible values are:
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Request Breakdown Of Credit Memo Items By Order Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Request Breakdown Of Invoice Items By Order Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Resume Subscription Request Data a| Any |  a| `#[payload]` | 
| Subscription Key a| String a|  Possible values are:
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Return Hmac Signatures Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Version Number a| String a|  Version of the Payment Pages for which you want to retrieve the configuration information. Specify 1 for Payment Pages 1.0 or 2 for Payment Pages 2.0. If omitted, information for all versions of Payment Pages are returned. The response also depends on your tenant settings for Payment Pages 1.0 and Payment Pages 2.0. 

For example: If only the tenant setting for Payment Pages 2.0 is enabled, the response only contains information for Payment Pages 2.0 forms even when this parameter is omitted. |  | 
| Page Size a| Number |  Number of rows returned per page. |  20 | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Reverse Invoice Request Data a| Any |  a| `#[payload]` | 
| Invoice Id a| String a|  The ID of the invoice. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Reverse Payment Request Data a| Any |  a| `#[payload]` | 
| Payment Id a| String |  Unique ID of the payment. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Contact Id a| String a|  The ID of the contact that you want to scrub sensitive data from. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Send User Access Requests Multi Entity Request Data a| Any |  a| `#[payload]` | 
| Username a| String |  Specify the login name of the user that you want to accept the access request for. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Settle Payment Request Data a| Any |  a| `#[payload]` | 
| Payment Id a| String |  Unique ID of the payment. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Share A Product With An Entity Multi Entity Request Data a| Any |  a| `#[payload]` | 
| Product Id a| String a| The unique ID of the product you want to share. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Submit Data Query Request Data a| Any |  a| `#[payload]` | 
| Authorization a| String |  `Bearer {token}` for a valid OAuth token. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Subscribe Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| X Zuora Wsdl Version a| String |  Zuora WSDL version number. |  '79' | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Suspend Subscription Request Data a| Any |  a| `#[payload]` | 
| Subscription Key a| String a|  Possible values are:
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Transfer Payment Request Data a| Any |  a| `#[payload]` | 
| Payment Id a| String a| The unique ID of an unapplied payment. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Unapply Credit Memo Request Data a| Any |  a| `#[payload]` | 
| Credit Memo Id a| String a| The unique ID of a credit memo. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Unapply Payment Request Data a| Any |  a| `#[payload]` | 
| Payment Id a| String a| The unique ID of an unapplied payment. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| X Zuora Wsdl Version a| String |  Zuora WSDL version number. |  '79' | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update A Notification Definition Request Data a| Any |  a| `#[payload]` | 
| Id a| String a|  The ID of the notification definition to be deleted. |  | x
| Authorization a| String |  `Bearer {token}` for a valid OAuth token.   Note that you must regenerate the OAuth token after the Notification and the Configurable Event features are enabled in your Zuora tenant. The OAuth tokens generated before the features are turned on do not work. |  | x
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Account Request Data a| Any |  a| `#[payload]` | 
| Account Key a| String |  Account number or account ID. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Account Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  Object id |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Accounting Period Request Data a| Any |  a| `#[payload]` | 
| Ap Id a| String |  ID of the accounting period you want to delete. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Amendment Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  Object id |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update An Accounting Code Request Data a| Any |  a| `#[payload]` | 
| Ac Id a| String |  ID of the accounting code you want to update. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update An Email Template Request Data a| Any |  a| `#[payload]` | 
| Id a| String a|  The ID of the email template to be deleted. |  | x
| Authorization a| String |  `Bearer {token}` for a valid OAuth token.   Note that you must regenerate the OAuth token after the Notification and the Configurable Event features are enabled in your Zuora tenant. The OAuth tokens generated before the features are turned on do not work. |  | x
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update An Event Trigger Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  |  | x
| Authorization a| String |  `Bearer {token}` for a valid OAuth token. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Basic Information Of A Summary Journal Entry Request Data a| Any |  a| `#[payload]` | 
| Je Number a| String |  Journal entry number in the format JE-00000001. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Contact Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  Object id |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Credit Balance Adjustment Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  Object id |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Credit Card Payment Method Request Data a| Any |  a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Credit Memo Request Data a| Any |  a| `#[payload]` | 
| Credit Memo Id a| String a| The unique ID of a credit memo. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Custom Fields On Revenue Items By Revenue Event Number Request Data a| Any |  a| `#[payload]` | 
| Event Number a| String |  The number associated with the revenue event. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Custom Fields On Revenue Items By Revenue Schedule Number Request Data a| Any |  a| `#[payload]` | 
| Rs Number a| String |  Revenue schedule number. The revenue schedule number is always prefixed with "RS", for example, "RS-00000001". |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Debit Memo Request Data a| Any |  a| `#[payload]` | 
| Debit Memo Id a| String a| The unique ID of a debit memo. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Debit Memos Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Document Properties Request Data a| Any |  a| `#[payload]` | 
| Document Properties Id a| String a| The unique ID of document properties. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Entity Multi Entity Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  Specify the Id of the entity that you want to delete. You can get the entity Id from the GET Entities call. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Invoice Request Data a| Any |  a| `#[payload]` | 
| Invoice Id a| String a|  The ID of the invoice. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Invoice Adjustment Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  Object id |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Invoice Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  Object id |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Invoice Payment Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  Object id |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Invoices Request Data a| Any |  a| `#[payload]` | 
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Order Action Trigger Dates Request Data a| Any |  a| `#[payload]` | 
| Order Number a| String |  The number of the order to be deleted. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Order Custom Fields Request Data a| Any |  a| `#[payload]` | 
| Order Number a| String |  The number of the order to be deleted. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Payment Request Data a| Any |  a| `#[payload]` | 
| Payment Id a| String a| The unique ID of an unapplied payment. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Payment Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String a| The unique ID of the payment to be deleted. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Payment Method Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  Object id |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Payment Run Request Data a| Any |  a| `#[payload]` | 
| Payment Run Id a| String a| The unique ID of a payment run. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Product Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  Object id |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Product Rate Plan Charge Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String a| The unique ID of the product rate plan charge to be deleted. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Product Rate Plan Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  Object id |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Refund Request Data a| Any |  a| `#[payload]` | 
| Refund Id a| String a| The unique ID of a refund. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Refund Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  Object id |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Revenue Schedule Basic Information Request Data a| Any |  a| `#[payload]` | 
| Rs Number a| String a| Revenue schedule number of the revenue schedule you want to delete, for example, RS-00000256. 

To be deleted, a revenue schedule:
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Sequence Set Request Data a| Any |  a| `#[payload]` | 
| Id a| String a|  The ID of the sequence set to delete |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Subscription Request Data a| Any |  a| `#[payload]` | 
| Subscription Key a| String a| Possible values are:
...
You need to set this parameter if you use: 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Subscription Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  Object id |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Subscription Custom Fields Request Data a| Any |  a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Taxation Item Request Data a| Any |  a| `#[payload]` | 
| Id a| String a| The unique ID of a taxation item. |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Taxation Item Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  Object id |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Unit Of Measure Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  Object id |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Update Usage Crud Request Data a| Any |  a| `#[payload]` | 
| Id a| String |  Object id |  | x
| Zuora Entity Ids a| String a| An entity ID. If you have https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity[Zuora Multi-Entity] enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-Entity enabled, you do not need to set this header. |  | 
| Zuora Track Id a| String |  A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.   The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`"`), and quote (`'`). |  | 
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Upload File For Credit Memo Request Data a| Any |  a| `#[payload]` | 
| Credit Memo Id a| String a| The unique ID of a credit memo. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Upload File For Debit Memo Request Data a| Any |  a| `#[payload]` | 
| Debit Memo Id a| String a| The unique ID of a debit memo. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Upload File For Invoice Request Data a| Any |  a| `#[payload]` | 
| Invoice Id a| String a|  The ID of the invoice. 
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Verify Payment Method Request Data a| Any |  a| `#[payload]` | 
| Payment Method Id a| String |  Unique identifier of a payment method. (Since this ID is unique, and linked to a customer account in the system, no customer identifier is needed.) |  | x
| Target Variable a| String |  The name of a variable to store the operation's output. |  | 
| Target Value a| String |  An expression to evaluate against the operation's output and store the expression outcome in the target variable. a| `#[payload]` | 
|===
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Write Off Invoice Request Data a| Any |  a| `#[payload]` | 
| Invoice Id a| String a|  The ID of the invoice. 
