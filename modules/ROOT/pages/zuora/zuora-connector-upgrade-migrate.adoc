...
| 11	|
Create Account|
Create Accounting Request Data(Any) |N/A|Create account a| * Create Accounting Request Data (Any) (Removed)
* Content(Binary)
...
|
    N/A
|
      UnAppliedPaymentAmount(String)(New);
...
|
    ...
    SyncDate_NS(String)(New);
|
      AmountWithoutTax(Number)(Modified);
