...
. Click “+” next to the name of the trigger card.
...
After completing these steps, see the xref:zuora/zuora-connecxtor-examples[Zuora Examples] section to experiment with the Zuora connector.
