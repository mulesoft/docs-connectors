...
. Complete the fields with the values you want to configure for your trigger. For more information on field values, see the xref:zuora/zuora-connector-reference.adoc[Zuora Connector Reference - Mule 4].
