...
X12 EDI Connector Version 2.1.1

The Anypoint X12 EDI Connector lets you convert X12 messages to and from DataWeave-compatible representations using lists and maps.
X12 versions 003010, 003020, 003030, 003040, 003050, 003060, 003070, 004010, 004020, 004030, 004040, 004050, 004060, 005010, 005020, 005030, 005040, 005050, and 006020 are supported with supplied schema definitions for all standard transaction sets.
Many HIPAA document versions are also supported, as listed separately in the Connector HIPAA reference page.
...
configuration to use the X12 EDI connector 4.0.0. To change the memory
...
image::x12-edi/x12-edi-general.jpg[General tab properties]
...
* Manually create or edit the list of schema definitions for the message structures to be used (which must use the same form, either X12 or HIPAA). If the list of schema definitions includes a 997 or 999 Functional Acknowledgment schema then that schema will be used to generate Functional Acknowledgments. Note - In order to be used, the Functional Acknowledgment schema type (997 or 999) must match the "Generate 999 Functional Acknowledgments" setting on the Parser tab (false for 997, true for 999).
...
image::x12-edi/x12-edi-identity.jpg[Identity tab properties]
...
image::x12-edi/x12-edi-parser.jpg[Parser tab properties]
...
image::x12-edi/x12-edi-writer.jpg[Writer tab properties]
...
image::x12-edi/x12-edi-mapping-flow.jpg[Mapping Flow Diagram]
...
If the schema definition configuration includes a 997 or 999 Functional Acknowledgmet schema then that schema will be used to generate Functional Acknowledgments. Note - In order to be used, the Functional Acknowledgment schema type (997 or 999) must match the generate999Acks Parser parameter (false for 997, true for 999).
...
image::x12-edi/x12-edi-ack-flow.jpg[Ack Flow Diagram]
