= X12 EDI - Upgrade and Migrate - Mule 4
...
. In *Available modules*, select *X12 EDI* and click *Add*.
. Click *Finish*.
. Verify that the <connector> dependency version is <latest-version> in the  file in the Mule project.
