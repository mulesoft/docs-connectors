...
----
+
In the Mule application, the spring file where the beans were defined must be referenced and in the tokenProvider attribute of the configuration, the specific bean that implements the SASTokenProvider must be referenced.
+
----
