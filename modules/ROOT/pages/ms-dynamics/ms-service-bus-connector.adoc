...
This use case retrieves the list of existing queues in a specific namespace. It returns the list in JSON format.
...
. Fill in the HTTP Listener path with the value `/servicebus`.
...
. Builds the JSON for the subscription.
. Logs the JSON.
+
