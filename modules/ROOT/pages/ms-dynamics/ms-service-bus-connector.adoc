...
+
A Spring bean reference implementing the `com.mulesoft.connectors.microsoft.servicebus.extension.api.SharedAccessSignatureProvider` interface.
+
...
This is an example of an implementation of the SasTokenProvidere :
----
package sample;
