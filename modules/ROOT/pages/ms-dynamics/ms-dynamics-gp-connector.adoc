...
Microsoft Dynamics GP Connector v2.0
...
https://www.mulesoft.com/exchange/com.mulesoft.connectors/mule-microsoft-dynamics-gp-connector/[Microsoft Dynamics GP Connector]
