...
| User Properties a| Object |  The custom user properties that should be set for this Message |  |
| JMSX Properties a| <<JmsxProperties>> |  The JMSX properties that should be set for this message |  |
