= Microsoft Dynamics AX Connector - Mule 4
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

Anypoint Connector for Microsoft Dynamics AX lets Mule apps interact with the Microsoft Dynamics AX Query Service.
...
https://www.mulesoft.com/exchange/com.mulesoft.connectors/mule-microsoft-dynamics-ax-connector/[Microsoft Dynamics AX Connector] in
