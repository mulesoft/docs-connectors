...
Configure the following equired parameters:
...
The way you troubleshoot SMTPS connection issues depends on whether or not you have two-factor set up for your Gmail account. 
