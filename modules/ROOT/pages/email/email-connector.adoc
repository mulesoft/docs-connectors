...
[[short_description]]
Anypoint Connector for Email (Email Connector) sends and retrieves email messages over the standard email protocols. Its main features include:
...
* xref:email/email-list.adoc[Listing Emails with the Email Connector]
