...
The OAuth Module is an extension to hook OAuth2 to HTTP extension connectors.

Release Notes: xref:release-notes::connector/oauth-module-release-notes.adoc[OAuth Module Release Notes] +
Exchange: https://www.mulesoft.com/exchange/org.mule.modules/mule-oauth-module/[OAuth Module]
