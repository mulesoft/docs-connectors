...
Also, if the app should behave as the *Client in the OAuth2 Dance*, then the xref:oauth/oauth-documentation.adoc[OAuth Module] should be used.
...
xref:4.1@mule4-runtime::migration-oauth2-provider.adoc[OAuth2 Provider Migration Guide]