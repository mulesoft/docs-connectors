= Copy and Move Files with the SFTP connector
...
For a complete description of the parameters, return type and errors, see the SFTP xref:sftp/sftp-documentation.adoc#createDirectory[Create Directory Operation].

== See Also

* xref:sftp/sftp-documentation.adoc#copy[SFTP Copy Operation]
* xref:sftp/sftp-documentation.adoc#move[SFTP Move Operation]
* xref:sftp/sftp-documentation.adoc#write[SFTP Write Operation]
