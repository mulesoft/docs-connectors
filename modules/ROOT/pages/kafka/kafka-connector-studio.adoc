= Use Anypoint Studio to Configure Apache Kafka - Mule 4
...
. For the Consumer connection, there are three types from which you can choose from:
+
- *Consumer PlainText Connection*, which has the following configuration fields:
+
...
+
image::kafka/kafka-consumer-studio-plaintext-connection.png[]

- *Consumer Kerberos Connection*, which has the following configuration fields:
+
* Bootstrap Server URLs +
List of host-port pairs used for establishing the initial connection to the Kafka cluster. This is the same as the `bootstrap.servers` value you must provide to Kafka clients (producer or consumer).
* Bean Reference (Optional) +
...
//TODO
+
image::kafka/kafka-consumer-studio-kerberos-connection.png[]

- *Consumer SASL/SCRAM Connection*, which has the following configuration fields:
+
* Bootstrap Server URLs +
List of host-port pairs used for establishing the initial connection to the Kafka cluster. This is the same as the `bootstrap.servers` value you must provide to Kafka clients (producer or consumer).
* Bean Reference (Optional) +
...
//TODO
+
image::kafka/kafka-consumer-studio-sasl-scram-connection.png[]
...
. For the Producer connection, there are three types from which you can choose from:
+
- *Producer PlainText Connection*, which has the following configuration fields:
+
* Bootstrap Server URLs +
List of host-port pairs used for establishing the initial connection to the Kafka cluster. This is the same as the `bootstrap.servers` value you must provide to Kafka clients (producer or consumer).
* Bean Reference (Optional) +
URLs that the consumer can use to connect to the Kafka cluster.
+
image::kafka/kafka-producer-studio-plaintext-connection.png[]

- *Producer Kerberos Connection*, which has the following configuration fields:
+
* Bootstrap Server URLs +
List of host-port pairs used for establishing the initial connection to the Kafka cluster. This is the same as the `bootstrap.servers` value you must provide to Kafka clients (producer or consumer).
* Bean Reference (Optional) +
...
//TODO
+
image::kafka/kafka-producer-studio-kerberos-connection.png[]

- *Producer SASL/SCRAM Connection*, which has the following configuration fields:
+
* Bootstrap Server URLs +
List of host-port pairs used for establishing the initial connection to the Kafka cluster. This is the same as the `bootstrap.servers` value you must provide to Kafka clients (producer or consumer).
* Bean Reference (Optional) +
...
//TODO
+
image::kafka/kafka-producer-studio-sasl-scram-connection.png[]
