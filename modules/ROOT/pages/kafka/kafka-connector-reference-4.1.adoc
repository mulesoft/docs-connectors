...
<<consumer-config_consumer-sasl-gssapi-connection, Consumer SASL Kerberos Connection>> | The connection types to provide to this configuration. | | x
