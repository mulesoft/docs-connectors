...
image::kafka/kafka-producer-studio-flow.png[Apache Kafka Connector Producer flow in Studio]
...
image::kafka/kafka-consumer-studio-flow.png[Apache Kafka Connector Consumer flow in Studio]
