...
This example shows how to use two Kafka operations, *Publish* and *Consume*, to publish a message to Kafka and then retrieve it.
...
image::kafka/kafka-producer-studio-flow.png[Kafka Connector Producer flow in Studio]
...
+
*Is the previous line correct and in the right place for the procedure?*
+
...
.Create a flow like this one to retrieve a message from Kafka.
