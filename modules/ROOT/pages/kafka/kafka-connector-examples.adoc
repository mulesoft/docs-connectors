...
This example shows how to use two Anypoint Connector for Apache Kafka (Kafka Connector) operations, *Publish* and *Consume*, to publish a message to Kafka and then retrieve it.
