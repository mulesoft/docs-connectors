...
* New operations with new parameters +
...
Before you perform the upgrade, you must create a backup of your files, data, and configuration in case you need to revert to the previous version.
