...
== Discover and Add Connectors to Projects
...
. To download the connect for use in Studio, click *Download* from the right menu. You must be logged into Anypoint Platform to download a connector.
+
...
When you are working in a Design Center project, you can add a connector directly to the project:
...
=== [[import-downloaded-connector-studio]]Import a Downloaded Connector into a Studio Project
...
Follow the directions in the connector's User Guide for configuring the connector in Design Center or Studio.
...
Follow the instructions on the landing page of the associated connector to set up and run the example.
