...
To configure a reconnection strategy for a connector, use the *Advanced* sub-tab in the global element configuration *General* tab.
...
image::introduction/intro-config-overview-reconnection-strategy.png[Reconnection strategy example]
