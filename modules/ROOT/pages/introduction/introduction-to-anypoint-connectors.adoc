...
For information about locating connectors in Exchange, see <<introduction/intro-use-exchange.adoc#discover-add-connectors,Discover and Add Connectors to Flow Designer and Studio Projects>>.
...
For information about locating and using templates, see <<introduction/intro-use-exchange#discover-add-templates.adoc,Discover and Add Templates to Flow Designer or Studio>>.
...
For information about locating and using examples, see <<introduction/intro-use-exchange.adoc#discover-add-examples,Discover and Add Examples to Studio>>.
