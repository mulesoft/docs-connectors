...
For more information about the HTTP Listener and the Scheduler component, see xref:http/http-connector.adoc[HTTP Connector User Guide] and xref:mule-runtime::scheduler-concept.adoc[Scheduler Endpoint (Trigger)].
