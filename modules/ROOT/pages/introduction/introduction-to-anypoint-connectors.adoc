...
For information about locating and using templates, see <<introduction/intro-use-exchange.adoc#discover-add-templates,Discover and Add Templates to Flow Designer or Studio>>.
