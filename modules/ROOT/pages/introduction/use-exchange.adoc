...
+
The system downloads the connector as a `.jar` file. For instructions on adding this file to Studio, see <<import-downloaded-connector-studio.adoc, Import a Downloaded Connector into Studio>>.
...
[[import-downloaded-connector-studio]]
=== Import a Downloaded Connector into a Studio
...
[[add-connector-to-studio-project]]
=== Add a Connector Directly to a Studio Project
