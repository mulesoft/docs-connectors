...
To access assets in your own organization's Exchange, you must have the appropriate permission.
...
. From your Studio project, click the Exchange icon *(X)* in the upper-left of the Studio taskbar.
