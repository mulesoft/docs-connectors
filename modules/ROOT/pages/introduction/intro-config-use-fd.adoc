...
. Follow the procedure described in <<configure-trigger,Configure the Trigger>>.
...
The default CloudHub connection uses host 0.0.0.0 and port 8081. To use this connection, click outside of the trigger card to close it.
...
+
NOTE: Depending on the connector you are working with, the step order might vary.
+
