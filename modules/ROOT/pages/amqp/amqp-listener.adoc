...
By default, the AMQP listener will receive messages from every node in a clustered environment. As in other sources, this can be modified using the `primaryNodeOnly` attribute.
