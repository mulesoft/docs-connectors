...
| Binding Routing Key| String | Defines the routing key to use in the binding to the exchange. (v1.4.0 and later. 1.6.0 does not have this feature, please use 1.6.2.) |  | 
|===
