...
image::veevavault/veevavault-connector-get-audit-details-audit-types.png[image,width=299,height=106]
...
image::veevavault/veevavault-connector-create-object-records-object-name.png[image,width=323,height=246]
...
image::veevavault/veevavault-connector-get-picklists-name.png[image,width=293,height=249]
...
image:veevavault/veevavault-connector-invoke-rest-api-method.png[image,width=419,height=91]

| `GET` |X
|Path |String | 
The URI Path for where to send the request

image:veevavault/veevavault-connector-invoke-rest-api-path.png[image,width=625,height=31]
...
image:veevavault/veevavault-connector-invoke-rest-api-headers.png[image,width=616,height=126]
...
image:veevavault/veevavault-connector-invoke-rest-api-uri-parameters.png[image,width=640,height=128]
...
image:veevavault/veevavault-connector-invoke-rest-api-query-parameters.png[image,width=640,height=126]
