...
Create documents creates documents on vault using the document metadata provided in CSV or JSON format.
...
* xref:veevavault/veevavault-connector-get-started.adoc[VeevaVault Connector]
* xref:veevavault/veevavault-connector-release-notes.adoc[VeevaVault Connector Release Notes]