...
|===
|*Field* |*Description*
|*Picklist Name* a|Click the refresh icon (image:veevavault/veevavault-connector-refresh-icon.png[VeevaVault refresh icon, 5%, 5%]) to retrieve picklists from the vault. Select a picklist name from the list to retrieve picklist values.
|*Input* |N/A
|*Output* a|
