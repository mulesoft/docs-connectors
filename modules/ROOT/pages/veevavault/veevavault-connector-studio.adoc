= Veeva Vault Connector Configuration for Studio - Mule 4
...
You can add the connector to your Anypoint Studio Mule project in two ways: 
...
In Studio, access Exchange to obtain Veeva Vault Connector and add it to your Mule project. 

. In Studio, create a Mule project.
. Click the Exchange icon *(X)* in the upper-left of the Studio task bar.
. In Exchange, click *Login* and supply your Anypoint Platform username and password.
. In Exchange, search for "Veeva".
. Select *Veeva Vault Connector - Mule 4* and click *Add to project*.
. Follow the prompts to install the connector.

=== Add the Connector Using the Mule Palette View

Access Exchange from the Mule Palette view to add Veeva Vault Connector to the Mule project. 
...
After configuring Veeva Vault Connector for use in Studio, see the xref:veevavault/veevavault-connector-config-topics.adoc[Additional Configuration Information] topic for more configuration steps.
