...
For information about compatibility and fixed issues, see xref:release-notes::connector/veevavault-release-notes-mule-4.adoc[Veeva Vault Connector Release Notes].
