...
doc:id="ac21fdf2-9117-4201-a595-907e4dd1ea12">
        <ee:message>
            <ee:set-payload>
                <![CDATA[%dw 2.0
...
payload map ( payload01 , indexOfPayload01 ) -> {
    ...
    <db:bulk-insert doc:name=__"Bulk insert"
doc:id="e8dd307e-40db-42bb-b82a-b72f6b235d00" config-ref="Database_Config">
...
In this Mule flow you validate a Spark message triggered from the vault. 
