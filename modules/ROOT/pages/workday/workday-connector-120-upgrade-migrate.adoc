...
* Operations return headers as Attributes.
* Source changed (has new name and alias) 


== Changes in Connection Types

* Timeouts were splited into Value and Time Unit fields.
* Read timeout added to workday configuration.

== Changed Operations, Parameters, and Return Types

* The possibility of read timeout override on opration/source level.
