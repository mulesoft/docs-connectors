...
Anypoint Connector for Workday provides two real-world finance examples that enable you to see how the Workday Connector
works in Anypoint Design Center’s Flow Designer.
...
+
//image::workday/http-listener-add-fund-example.png[]
+
...
----
+
//image::workday/tranform-dataweave-add-fund-example.png[]
+
...
+
//image::workday/workday-operation-with-content.png[]
+
