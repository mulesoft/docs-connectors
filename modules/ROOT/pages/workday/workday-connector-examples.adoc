...
* Make a Position Request in Workday
...
. Create a Mule application as a Design Center or Studio 7 Mule project (we are using Design Center in this walkthrough). 
+
