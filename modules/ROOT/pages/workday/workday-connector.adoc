...
The common use case for Workday connector is starting any of Workday's standard operations. xref:workday/workday-connector-examples.adoc[Example] use cases include creting a position request in Workday or adding a fund to the financial management service.
