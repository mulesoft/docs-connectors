...
Workday Connector Version 11.0.0

The Anypoint Connector for Workday (Workday Connector) provides access to standard Workday operations.
...
The common use case for Workday Connector is starting any of Workday's standard operations. xref:workday/workday-connector-examples.adoc[Example] use cases include creating a position request in Workday or adding a fund to the financial management service.
