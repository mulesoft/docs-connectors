...
* *On New Objects* - Start your app when an object is created in Workday. 
* *HTTP Listener* - Start your app using a browser or a command such as `curl`.
* *Scheduler* - Start your app at timed intervals.
...
Each Workday operation has separate fields in Anypoint Studio that may be required. For more information, see 
the xref:workday/workday-reference.adoc[Connector Reference].

The topic that follows provides additional information about configuring Workday for use in Studio.
