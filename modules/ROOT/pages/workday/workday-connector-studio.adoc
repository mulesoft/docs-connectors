...
To test a connection to a Workday instance, you need permission to use the Workday web services you want to access.
See the Workday documentation for more information.
