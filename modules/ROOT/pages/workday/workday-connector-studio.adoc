...
IMPORTANT: In order to test connection for Workday connector, you will need to have a permission for the *Get_Degrees* operation in the *Performance_Management* web service.
