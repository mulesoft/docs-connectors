...
+
. Select *Click here to set it up* to set the required fields for the https://community.workday.com/sites/default/files/file-hosting/productionapi/operations/index.html[Operation], *User Name*, *Password*,
