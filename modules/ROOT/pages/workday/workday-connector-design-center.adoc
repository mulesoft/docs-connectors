...
A trigger starts your app. Workday Connector provides the Modified Object Trigger operation that starts your app when a object is created or updated in Workday. Alternatively, you can use the HTTP Listener operation to start your app from a browser
