...
and xref:servicenow/servicenow-connector-examples.adoc[Examples] topics. The xref:servicenow/servicenow-connector-examples.adoc[Examples] topic provides one or more use cases for using the connector.
...
xref:servicenow/servicenow-connector-examples.adoc[Example] use case includes getting a ServiceNow incident record.
...
xref:servicenow/servicenow-connector-design-center.adoc[Design Center] or xref:mule-servicenow-connector/servicenow-connector-studio.adoc[Anypoint Studio].
