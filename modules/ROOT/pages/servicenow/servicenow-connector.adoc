...
see xref:servicenow/servicenow-connector-studio.adoc[Studio Configuration].
* Power user
+
...
After you complete the prerequisites and experiment with templates and examples, you are ready to create an app with xref:servicenow/servicenow-connector-studio.adoc[Anypoint Studio].
