...
`getrecords`
====
image::servicenow/servicenow-listener.png[Servicenow listener]
+
...
+
image::servicenow/servicenow-metadata-without-reference-values.png[Servicenow metadata for studio 7.5.0]
+
