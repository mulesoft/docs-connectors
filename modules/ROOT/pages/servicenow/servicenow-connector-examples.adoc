...
== Example: Retrieve a ServiceNow Incident Record
...
+
. In your `Invoke` operation in Design Center, click  *Map* for the `Body` field and click the `Script` tab at the bottom of the *Body* window.

. Paste a transformation script as in this example:
+
----
%dw 2.0
...
== Example: Retrieve Records from a ServiceNow Incident Table
...
== Example: Retrieve ServiceNow Incident Table Keys
