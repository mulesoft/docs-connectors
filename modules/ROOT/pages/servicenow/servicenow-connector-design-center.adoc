...
the xref:servicenow/servicenow-connector-reference.adoc[ServiceNow Connector Technical Reference]. 
...
. You can't use ServiceNow connector's operation as an input source trigger. You can use *HTTP* or a *Scheduler* instead.
