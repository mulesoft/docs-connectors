...
For information on field values, see the xref:servicenow/servicenow-connector-reference.adoc[ServiceNow Connector Reference].
...
=== Add a ServiceNow Connector as a Component
