...
* Inbound: WebSockets created when the Mule application listens for incoming connections.
+
In this scenario, an external system connects to an endpoint exposed by the Mule application.
+
* Outbound: WebSockets created when the Mule application connects to an external system.
+
...
<TBD when the other topics are finished>
