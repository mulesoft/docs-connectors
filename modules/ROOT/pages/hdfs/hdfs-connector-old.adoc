...
Hadoop (HDFS) Connector v6.0

Anypoint Connector for the Hadoop Distributed File System (HDFS) (Hadoop HDFS Connector) is used as a bidirectional gateway between Mule applications and HDFS.
