...
Mule converts RELEASE to the latest version. To set a specific version, view https://www.mulesoft.com/exchange/com.mulesoft.connectors/mule-marketo-connector/[Anypoint Exchange] and click *Dependency Snippetes*.
...
image::marketo/marketo-dc-rest-config.png[]
