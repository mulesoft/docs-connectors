...
* xref:anypoint-mq/2.x/anypoint-mq-connector.adoc[Anypoint MQ 2.x] and xref:anypoint-mq/3.x/anypoint-mq-connector.adoc[Anypoint MQ 3.x]
* xref:as2/as2-connector.adoc[AS2]
...
xref:salesforce/salesforce-b2c-commerce-cloud-connector.adoc[Salesforce B2C Commerce Cloud],
