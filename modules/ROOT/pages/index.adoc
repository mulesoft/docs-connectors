...
Anypoint Connectors facilitate integrations with third-party APIs. Modules are extensions to the Mule runtime that you can use when building a Mule application. See xref:4.2@::mule-runtime/mule-app-tutorial.adoc[Mule App Development Tutorial] for information on adding a connector to a sample Mule app.
...
* xref:sap/sap-connector.adoc[SAP],
xref:sap/sap-s4hana-cloud-connector.adoc[SAP S4/HANA Cloud],
