...
== New Template Connectors

*  xref:amazon/amazon-s3-connector-get-started.adoc[Amazon S3]
*  xref:kafka/kafka-connector-get-started.adoc[Kafka]
*  xref:mongodb/mongodb-connector-get-started.adoc[MongoDB]
*  xref:redis/redis-connector-get-started.adoc[Redis]
*  xref:salesforce/salesforce-connector-get-started.adoc[Salesforce]
*  xref:sap/sap-connector-get-started.adoc[SAP]
