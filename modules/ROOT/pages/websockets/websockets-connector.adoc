...
Release Notes: xref:release-notes::connector/websocket-connector-release-notes.adoc[WebSocket Connector Release Notes]
...
* xref:websocket/websocket-connector-key-concepts.adoc[WebSockets Connector Key Concepts]
