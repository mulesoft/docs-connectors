= WebSockets Connection Management Components
...
The Send operation allows you to send a message through a web socket identified by its socket ID after a connection is established. This operation can be used for both inbound and outbound web socket instances.
...
* xref:websockets/websockets-connector-managing-groups.adoc[Manage Groups]
