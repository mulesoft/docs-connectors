= WebSockets Configuration Information - Mule 4
...
In case of a WebSockets client, you can set up a trust store by directly referencing the <tls:context> in the `tlsConfig` property.
...
Now that you have completed configuration, you can try out the WebSockets xref:websocket/websocket-connector-examples.adoc[Examples].

== See Also

* https://help.mulesoft.com[MuleSoft Help Center]
* xref:4.1@mule-runtime::tls-configuration.adoc[Configure TLS with Key Stores and Trust Stores]
* xref:websockets/websocket-connector.adoc[WebSockets Connector]
* xref:websockets/websocketss-connector-cloudhub.adoc[WebSocket Connector in VPC]
* xref:websocketss/websocket-connector-xml-maven.adoc[WebSocket XML and Maven]
