...
In case of a web socket client, you can set up a truststore by directly referencing the `<tls:context>` in the `tlsConfig` property.
...
// * xref:4.2@mule-runtime::tls-configuration.adoc[Configure TLS with Keystores and Truststores]
