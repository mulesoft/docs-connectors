...
see the xref:websockets/websockets-connector-config-topics.adoc[Configuration Topics] for more configuration ideas.

== See Also

* https://help.mulesoft.com[MuleSoft Help Center]
* xref:websockets/websockets-connector.adoc[WebSockets Connector]
* xref:websockets/websockets-connector-xml-maven.adoc[XML and Maven Configuration]
