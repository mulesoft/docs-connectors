...
The difference between a WebSocket and a traditional Socket (TCP or UDP), is that this full duplex protocol is built on top of existing HTTP infrastructure, making it easy to reuse infrastructure already in place for traditional HTTP.
...
* xref:websockets/websockets-connector-studio.adoc[WebSockets in Studio]
* xref:websockets/websockets-connector-examples.adoc[WebSockets Examples]

== See Also

* https://forums.mulesoft.com[MuleSoft Forum]
* https://support.mulesoft.com/s/knowledge[Knowledge Base Articles]
* xref:websockets/websockets-connector-design-center.adoc[Design Center] or
* xref:websockets/websockets-connector-studio.adoc[Anypoint Studio].