...
image::as2-configuration-1.png[AS2_CONFIGURATION_1]
...
image::as2-sender-flow-demo.png[AS2_SENDER_FLOW_DEMO]

[use-case-2]
== Example of a Receive Source Use Case

image::as2-receive-flow-demo.png[AS2_RECEIVE_FLOW_DEMO]
