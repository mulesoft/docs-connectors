= AS2 Connector - Design Center Configuration - Mule 4
...
the xref:as2-connector/as2-connector-connector-reference.adoc[AS2 Connector Connector Reference].
...
. In *Select a component*, search for the AS2 Connector Connector.
