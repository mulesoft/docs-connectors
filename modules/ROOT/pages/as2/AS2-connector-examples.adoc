...
. Place the connector in your flow as applicable for your needs.
...
** The Boolean required to configure if the process if it should fail or if the receipt status is not processed.

. If you choose to request an asynchronous receipt, you need to configure the `MDN Listener`.

=== Configure an MDN Listener

Place the connector’s `MDN Listener` as a source in your flow as applicable for your needs and reference the global config defined here.
