...
Java Module MuleSoft Extension, used to invoke Java code.

Release Notes: https://docs.mulesoft.com/release-notes/connector/java-module.adoc[Java Module Release Notes] 
