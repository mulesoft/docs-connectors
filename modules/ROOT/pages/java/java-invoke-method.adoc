...
the classes must be exported; otherwise, execution fails with a JAVA:CLASS_NOT_FOUND error. See xref:4.2@mule-runtime::how-to-export-resources.adoc[how to export resources].
====
