...
In Studio, you can write or load a Java package into a project, then configure
Java operations within one or more a flows and run the Mule app in which the
operations reside.
