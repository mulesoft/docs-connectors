...
In this example, you set up two flows in a Mule app. The process involves:
...
* Running the Mule app to execute New and Invoke operations in Studio.
...
* *Constructor*: `Hello()`
+
Do not click *_fx_* for the *Constructor* setting.
+
...
and then provide the following configuration:
+
