...
_calculateTax(Double , Integer)_ method which takes _price_ and _percentAdditionalTax_
...
For the method parameters, you can also specify the full package name, for example
`constructor="Person(java.lang.Double, java.lang.Integer)"`. Of course, this is not needed, but it can
