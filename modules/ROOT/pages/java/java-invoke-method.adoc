...
Note that in Studio, the Java module provides DataSense for metadata
...
[[studio_example]]
== Example: Use of New and Invoke in Studio

In Studio, you can write or load a Java package, then configure Java operations
within one or more a flows and run the Mule app in which the operations
reside.
