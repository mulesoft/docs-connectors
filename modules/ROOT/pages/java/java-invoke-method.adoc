...
== Compiling Java Code and Imported Java Classes

To compile your custom Java in `src/main/java`, you need to set the `-parameters` compiler flag. For example, in the POM file for your Mule
app in Anypoint Studio, you can set the `<parameters/>` element to `true`,
like this:
...
If you are importing pre-compiled Java classes, you also need to compile them using `-parameters`, or you will need to use `arg0`, `arg1`, and so on.
