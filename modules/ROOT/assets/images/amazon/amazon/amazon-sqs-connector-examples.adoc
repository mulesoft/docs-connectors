...
. In the Mule Palette, search for *Transform Message* and drag the component to the right of the *Listener*.
. In the *Transform Message* configuration, add this metadata data to the *Output* section:
+
...
. In the Mule Palette, search for *Amazon SQS* and select the *Send message* operation.
+
