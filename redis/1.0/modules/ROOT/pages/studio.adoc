= Use Studio to Configure Redis Connector 1.0 - Mule 4
...
include::connectors::partial$t-studio-create-project-partial.adoc[]
////
[[create-mule-project]]
...
include::connectors::partial$t-studio-add-connector-intro-partial.adoc[]
////
...
include::connectors::partial$t-studio-add-connector-op-intro-partial.adoc[]
////
...
include::connectors::partial$t-studio-additional-fields-partial.adoc[]
////
...
include::connectors::partial$t-studio-view-app-log-partial.adoc[]
////
[[view-app-log]]
== View the App Log
...
include::connectors::partial$t-studio-next-step-partial.adoc[]
////
...
include::connectors::partial$t-studio-see-also-partial.adoc[]
