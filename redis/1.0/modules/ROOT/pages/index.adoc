...
* support-category - Connector support category. For example, Select or Premium.
...
For information about configuring authentication types, see xref:{loc-connector-name}connector-studio.adoc#configure-global-element[Configure a Global Element for the Connector].
