...
If you are new to configuring connectors in Studio, see xref:connectors::introduction/intro-config-use-studio.adoc[Use Studio to Configure a Connector]. If, after reading this topic, you need additional information about the connector fields, see the xref:{partial-path}-reference.adoc[{connector-name} Connector Reference].
////
...
. In *Add Modules to Project*, type `<lc-connector-name>` in the search field.
...
include::connectors::partial$t-studio-partial.adoc[tags=configure-a-source]
