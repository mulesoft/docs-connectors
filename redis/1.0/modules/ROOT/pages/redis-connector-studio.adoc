...
* {startcount} - numbered list restart number. For example, 5.
////
...
////
If the connector supports TLS, add this partial and the line that assigns a value to the startcont variable:
////
