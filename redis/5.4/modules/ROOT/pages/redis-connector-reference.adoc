...
[NOTE]
====
Redis Connector does not support clustered connections on Redis Enterprise Active-Active databases. To connect to one of the Redis Enterprise active-active clusters, non-clustered connection should be used in Jedis. However, the connection is only made to the specified node.

The Redis connector does not support clustered sharded connections.
====
