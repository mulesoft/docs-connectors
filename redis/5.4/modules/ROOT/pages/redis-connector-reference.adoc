...
Starting with Redis Connector 5.4.5 the *Entry TTL* set on the object store for periods exceeding 24 days now have the correct value for the new object store keys created.
