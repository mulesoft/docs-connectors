= Use Studio to Configure {connector-name} Connector <version> - Mule 4
...
After you configure a global element and connection information, configure the other fields for the {connector-name} Connector.
////
