...
//* In the *Extension Configuration* field, select `Redis__Configuration` or any other configuration that you configured. *I don't see this field.*
...
+
. In the *Mule Palette* view, search for *payload* and drag the *Set Payload* component to the right of *Set Value for Key into Redis*.
+
