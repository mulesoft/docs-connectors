...
However, **enabling this flag explicitly moves the Bouncy Castle FIPS provider out of FIPS-approved mode**.
...
* MuleSoft **does not recommend or support** the use of this property for running PGP Encrypt operations in FIPS environments.
...
[IMPORTANT]
====
**Java 11+ (includes Java 17, 21, and later)**
