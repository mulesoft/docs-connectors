...
| PGP Encrypt | Not Supported | OpenPGP limitation in FIPS environments
...
PGP Encrypt doesn't work in FIPS environments due to a limitation of OpenPGP when running in FIPS mode. This limitation exists regardless of how the keyring is generated, whether with GPG 2.0 and lower, GPG 2.1 and higher, or BC-FIPS. 
