...
:page-aliases: mule-runtime::cryptography-jce.adoc
...
+
image::crypto-jce-password.png["A palette menu for adding password-based encryption modules in a cryptographic flow"]
. In the operation configuration window, set the *Algorithm*, *Password* *Password salt* and *Iteration count* properties:
+git s
image::crypto-jce-setting.png["Configuration settings for JCE encrypt PBE with algorithm, password, password salt, iteration options"]
