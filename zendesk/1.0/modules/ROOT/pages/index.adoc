...
+
For example, when a new user is created or updated in Zendesk, a corresponding record is created or updated in Salesforce.
+
* Integrating Stripe with Zendesk to automate actions
+
For example, when a user is created in Zendesk based on a customer request, the user is created in Stripe to track future purchases and subscriptions.
+
