= Amazon Secrets Manager Properties Provider 1.2 
...
* Route AWS Secrets Manager and AWS STS calls through custom endpoints, such as an AWS VPC interface endpoint (AWS PrivateLink) or a local testing service such as LocalStack.
