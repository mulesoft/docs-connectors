...
| Custom Endpoint URL a| String |  Optional override for the AWS Secrets Manager service endpoint URL. Use for LocalStack or AWS VPC interface endpoints. When unset, Mule uses the default regional AWS endpoint. |  |
...
| STS Endpoint URL a| String |  Optional override for the AWS STS service endpoint URL. Use for LocalStack or AWS VPC interface endpoints. When unset, Mule uses the regional AWS STS endpoint. This override is independent of the endpoint in the basic connection. |  |
|===
