...
* Microsoft Dynamics Nav Connector cannnot be used in CloudHub 2.0 due to the fact that the underlying CXF library requires a JDK for generating schema classes.
