= Microsoft Dynamics NAV Connector 2.1 
...
* https://learn.microsoft.com/en-us/previous-versions/dynamicsnav-2015/dd355316(v=nav.80)?redirectedfrom=MSDN[Published Page Service information]
* https://learn.microsoft.com/en-us/previous-versions/dynamicsnav-2016/dd355036(v=nav.90)?redirectedfrom=MSDN[Microsoft Dynamics NAV Web Services site]
