= Upgrading and Migrating Microsoft Dynamics NAV Connector to Version 3.0 - Mule 4
...
To support Microsoft Dynamics NAV Connector in CloudHub 2.0, the client must provide SOAP requests in raw XML format instead of using plain old java object.
