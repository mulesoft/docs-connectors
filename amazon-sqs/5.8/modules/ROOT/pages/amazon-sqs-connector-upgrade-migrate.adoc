= Upgrade Amazon SQS Connector to Version 5.8 - Mule 4
...
Amazon SQS Connector now supports mananging large messages with payloads up to 2 GB, which is beneficial when your application requires storing large amounts of data in queues. This is also useful because you do not need to repeatedly create queues that will be inactive.
