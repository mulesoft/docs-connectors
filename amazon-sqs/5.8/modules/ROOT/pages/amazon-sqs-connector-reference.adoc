...
| Queue Url a| String |  Permissions will be added to the queue represented by this URL. This parameter is optional, and if you do not specify `queueUrl`, you must specify the Default Global Queue URL at the configuration level. |  | 
