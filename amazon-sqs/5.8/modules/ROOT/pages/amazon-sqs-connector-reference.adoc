= Amazon SQS Connector 5.8 Reference 
...
| Queue Url a| String | URL of the queue in which to receive messages |  |
...
| Message Id a| String | An element containing the message ID of the message sent to the queue. For more information, see https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-queue-message-identifiers.html[Amazon SQS Queue and Message Identifiers]. |  |
|===
