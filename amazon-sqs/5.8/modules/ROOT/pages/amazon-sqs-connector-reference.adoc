...
[%header,cols="20s,10a,55a,10a,5a"]
|===
| Name | Type | Description | Default Value | Required
...
|MaximumMessageSize | Number |The limit of how many bytes a message can contain before Amazon SQS rejects it. Valid values: An integer from 1,024 bytes (1 KiB) to 262,144 bytes (256 KiB). | 262,144 (256 KiB) |
|MessageRetentionPeriod | Number |The length of time, in seconds, for which Amazon SQS retains a message. Valid values: An integer from 60 seconds (1 minute) to 1,209,600 seconds (14 days) | 345,600 (4 days) |
...
|VisibilityTimeout | Number | The visibility timeout for the queue, in seconds. Valid values: An integer from 0 to 43,200 (12 hours) | 30 |The ID of an AWS-managed customer master key (CMK) for Amazon SQS or a custom CMK. | |
|
