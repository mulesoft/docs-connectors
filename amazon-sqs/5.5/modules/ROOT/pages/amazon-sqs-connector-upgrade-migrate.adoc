...
. When the application contains *Receive Message* source, choose whether application should run on single or multiple nodes by checking the *Primary node only* box which is placed in the *Advanced tab*.
