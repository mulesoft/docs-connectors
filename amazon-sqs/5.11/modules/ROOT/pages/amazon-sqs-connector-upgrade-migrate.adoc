= Upgrading and Migrating Amazon SQS Connector to 5.11 

Upgrade Anypoint Connector for Amazon SQS to 5.11 to improve and optimize the performance of your projects using long polling, multithreading, and more control over the polling parameters.
