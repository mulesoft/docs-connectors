= Amazon SQS Connector 5.11 Additional Configuration Information 
...
For more information about queue types, see https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/standard-queues.html[AWS SQS Standard Queues] and https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/[AWS SQS FIFO Queues].
...
* *Edit Inline*
+
image::amazon-sqs-studio-large-payload-support.png["Large Payload Support configuration"]
