...
To make sure the connector works correctly when…grant API permissions to perform Amazon SQS actions. Refer to Amazon SQS API permissions: Actions and resources for the configuration.
