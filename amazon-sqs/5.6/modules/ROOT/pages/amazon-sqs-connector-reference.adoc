= Amazon SQS Connector 5.6 Reference - Mule 4
...
| Queue Url a| String |  |  |
| Primary Node Only a| Boolean |  Whether this source should only execute on the primary node when in a cluster. | DEFAULT_ALL_NODES |
