...
In order to test connection you need to specify `Test Queue Arn` field in the configuration. If the field is not specified the test connection is not perfomed and the console displays a warning.
