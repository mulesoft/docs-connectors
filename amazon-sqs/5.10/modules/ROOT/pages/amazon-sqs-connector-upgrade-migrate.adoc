= Upgrade Amazon SQS Connector to 5.10 - Mule 4
...
Amazon SQS Connector now supports the addition of an SQS endpoint, which you can use for Amazon Virtual Private Cloud (VPC).
