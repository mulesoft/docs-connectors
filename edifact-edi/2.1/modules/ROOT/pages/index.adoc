...
|useSuppliedValues="false" |Use values from supplied data for control segment identifiers (UNB/UNZ segments). The default behavior is to always generate control numbers when writing, this allows you to instead use values you have chosen.
|===
