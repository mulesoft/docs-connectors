...
| Use Supplied Values | Boolean | Whether to generate control numbers when writing or use supplied values for control-segment information such as control numbers. The default is to always generate control numbers when writing. | false |
|===
