...
| Interchange control number key | String | Whether to allow users to specify the Interchange control number key name, giving flexibility on setting this at a configuration level| NONE |
| Message control number key | String | Whether to allow users to specify the Message control number key name, giving flexibility on setting this at a configuration level| NONE |
|===
