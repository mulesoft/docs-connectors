...
| Use Supplied Values | Boolean | Whether to use supplied values for control segment information (control numbers, in particular).The default behavior is to always generate control numbers when writing. | false |
|===
