...
| Mule application sender/receive ID (UNG2.1/UNG3.1) | String a|  Identification for Mule in the exchange (UNG segment). This value is used in combination with the value of the *Mule application sender/receive ID qualifier (UNG2.2/UNG3.2)* field, and if one field is set, the other must also be set.
{sp}+
{sp}+
If set, this value affects both send and receive message handling:
...
| Mule application sender/receive ID qualifier (UNG2.2/UNG3.2) | String a|  Identification qualifier for Mule in the exchange (UNG segment). This value is used in combination with the value of the *Mule application sender/receive ID (UNG2.1/UNG3.1)* field, and if one field is set, the other must also be set.
{sp}+
{sp}+
If set, this value affects both send and receive message handling:
...
| Partner application sender/receiver ID (UNG2.1/UNG3.1) | String a|  Identification for the partner in the exchange (UNG segment). This value is used in combination with the value of the *Partner application sender/receiver ID qualifier (UNG2.2/UNG3.2)* field, and if one field is set, the other must also be set.
{sp}+
{sp}+
If set, this value affects both send and receive message handling:
...
| Parter application sender/receiver ID qualifier (UNG2.2/UNG3.2) | String a|  Identification qualifier for the partner in the exchange (UNG segment). This value is used in combination with the value of the *Partner application sender/receiver ID (UNG2.1/UNG3.1)* field, and if one field is set, the other must also be set.
{sp}+
{sp}+
If set, this value affects both send and receive message handling:
