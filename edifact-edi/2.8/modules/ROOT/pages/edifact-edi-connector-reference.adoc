= EDIFACT EDI Connector 2.8 Reference - Mule 4
...
//Application sender/receive ID (UNG2.1/UNG3.1)
| Application sender/receive ID (UNG2.1/UNG3.1) | String a|  Identification for Mule in the exchange (UNG segment). This value is used in combination with the value of the *Application sender/receive ID qualifier (UNG2.2/UNG3.2)* field, and if one field is set, the other must also be set.
{sp}+
{sp}+
If set, this value affects both send and receive message handling:
...
//Application sender/receive ID qualifier (UNG2.2/UNG3.2)
| Application sender/receive ID qualifier (UNG2.2/UNG3.2) | String a|  Identification qualifier for Mule in the exchange (UNG segment). This value is used in combination with the value of the *Application sender/receive ID (UNG2.1/UNG3.1)* field, and if one field is set, the other must also be set.
{sp}+
{sp}+
If set, this value affects both send and receive message handling:
...
//Application sender/receiver ID (UNG2.1/UNG3.1)
| Application sender/receiver ID (UNG2.1/UNG3.1) | String a|  Identification for the partner in the exchange (UNG segment). This value is used in combination with the value of the *Application sender/receiver ID qualifier (UNG2.2/UNG3.2)* field, and if one field is set, the other must also be set.
{sp}+
{sp}+
If set, this value affects both send and receive message handling:
...
//Application sender/receiver ID qualifier (UNG2.2/UNG3.2)
| Application sender/receiver ID qualifier (UNG2.2/UNG3.2) | String a|  Identification qualifier for the partner in the exchange (UNG segment). This value is used in combination with the value of the *Application sender/receiver ID (UNG2.1/UNG3.1)* field, and if one field is set, the other must also be set.
{sp}+
{sp}+
If set, this value affects both send and receive message handling.
...
| Use Functional Groups | Boolean a| Group message version inside groups envelopes (UNG - UNE):

* true
+
Group messages into UNG-UNE Segments
* false
+
Write all messages in the same interchange.
