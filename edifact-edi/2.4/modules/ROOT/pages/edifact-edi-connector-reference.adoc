= EDIFACT EDI Connector 2.4 Reference - Mule 4
...
| Timezone offset| String | Time zone to which to convert output dates. This field accepts only values compliant with ISO 8601 (which are UTC-based), for example, `-01:00`, `+0100`, `-0130`, `+05:00`, `-05`.

If you don't specify a value for this field, the output date is formatted in the local time zone. | |
