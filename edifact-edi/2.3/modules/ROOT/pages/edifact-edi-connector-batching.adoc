...
For EDI messages that are not time-sensitive, such as invoice and payment remittances, you can use the Batch operation to merge multiple individual messages into a single interchange and then send the interchange to your trading partners.
