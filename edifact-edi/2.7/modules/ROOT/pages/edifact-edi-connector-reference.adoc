...
+
In either case, the error is reported in CONTRL functional acknowledgments. |  true |
| Enforce segment repeats | Boolean |  Enforce segment repetition count limits in a message:
...
|Enforce code set validations | Boolean | If `true`, enforces code set validations, as defined in the EDIFACT schemas.| false |
