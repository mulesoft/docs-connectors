...
* true
+
The connector rejects received messages that contains characters that the syntax level does not allow.
+
* false
+
...
* true
+
The connector rejects received messages that contains characters not allowed by the syntax level.
+
* false
+
...
false
+
The connector does not use *Segment line ending* value at the end of the last line in the segment.| false |
|===
