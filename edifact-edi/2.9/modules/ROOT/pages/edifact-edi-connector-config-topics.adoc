= EDIFACT EDI Connector 2.9 Configuring Schemas - Mule 4
...
|lockMechanism="AUTO" "RUNTIME_LOCK_MANAGER" "OBJECT_STORE" |Determine the mechanism used to manage locks for control number sequencing.
|===
