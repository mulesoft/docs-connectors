= Use Anypoint Studio to Configure EDIFACT EDI Connector 2.2 - Mule 4
...
| Interchange control number key | The key-value pair of the interchange control key and interchange control number.| NONE |
| Message control number key | The key-value pair of the message control key and message control number.| NONE |
|===
