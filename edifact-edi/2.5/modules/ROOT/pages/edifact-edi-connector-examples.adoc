= EDIFACT EDI Connector 2.5 Examples - Mule 4

The following examples show how to read, validate, and write EDI messages. In addition, you can send functional and interchange acknowledgements to your trading partners.
