...
. After you complete the proper authorization steps, the web page automatically redirects to the path you configured inside the *Callback Path* field, for example `/oauth2callback`. +
