...
To configure OAuth 2.0 client credentials:
...
+
// image::dynamics-oauth-
// connection.png[Global element
// configuration for OAuth Connection]
...
To configure OAuth 2.0 client credentials Authentication, enter the following information on the *General* tab of the *Global Element Properties* screen:
