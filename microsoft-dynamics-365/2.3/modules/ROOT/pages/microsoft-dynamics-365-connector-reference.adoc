...
[NOTE]
----
The Microsoft Dynamics 365 Connector input sources (listeners) use Object Store to save watermarks. You may experience limitations that are specific to the Object Store implementation you are using (Anypoint Object Store V2 or Mule Object Store), so you must configure the object store to suit your needs. +
