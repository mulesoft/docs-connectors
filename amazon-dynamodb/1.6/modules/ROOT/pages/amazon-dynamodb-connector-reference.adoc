= Amazon DynamoDB Connector 1.6 Reference 
...
| Custom STS Endpoint a| String |  Sets a custom service endpoint. Useful when a non-standard service endpoint is required, such as a VPC endpoint. The custom STS endpoint might not work if `DefaultAWSCredentialsProviderChain` is used. Instead, use AWS environment variables such as `AWS_STS_REGIONAL_ENDPOINTS`, `AWS_REGION`, and `AWS_ENDPOINT_URL`. |  | 
...
* DYNAMODB:AUTHORIZATION_NOT_FOUND
...
For information, see the https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_BatchGetItem.html[Amazon DynamoDB API Reference] for this operation.
...
For information, see the https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_CreateTable.html[Amazon DynamoDB API Reference] for this operation.
...
** OLD_IMAGE
** NEW_AND_OLD_IMAGES
** KEYS_ONLY |  Specifies the information that a database stream captures and writes when you modify an item in the table. |  |
...
For information, see the https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_DeleteTable.html[Amazon DynamoDB API Reference] for this operation.
...
For information, see the https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_DescribeTable.html[Amazon DynamoDB API Reference] for this operation.
...
For information, see the https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_GetItem.html[Amazon DynamoDB API Reference] for this operation.
...
For information, see the https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_ListTables.html[Amazon DynamoDB API Reference] for this operation.
...
For information, see the https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_Query.html[Amazon DynamoDB API Reference] for this operation.
...
For information, see the https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_UpdateTable.html[Amazon DynamoDB API Reference] for this operation.
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Shard Iterator a| String | A shard iterator that was retrieved from a previous *Get Shard Iterator* operation. |  | x
| Streaming Strategy a| * <<repeatable-in-memory-iterable>>
* <<repeatable-file-store-iterable>>
* non-repeatable-iterable |  Configure to use repeatable streams. |  |
| Target Variable a| String |  The name of a variable to store the operation's output. |  |
...
| Configuration | String | The name of the configuration to use. | | x
| Shard Id a| String |  |  | x
| Shard Iterator Type a| String | Specifies how to use the shard iterator. |  | x
