= Using Anypoint Studio to Configure Amazon DynamoDB Connector 
...
|External ID | Enter the unique identifier provided by the target account administrator. 
...
image::amazon-dynamodb-role-authentication.png["Role option selected in the Connection field"]
