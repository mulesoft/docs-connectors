...
:page-aliases: 3.8@mule-runtime::siebel-bo-apidoc.adoc
...
|
id fields  | +++<a href="http://docs.oracle.com/javase/7/docs/api/java/util/List.html">List</a><<a href="http://docs.oracle.com/javase/7/docs/api/java/lang/String.html">String</a>>+++ | +++list of fields to be taken as identifiers of the record to analyze if it should be created or not+++ |  | {nbsp}
