...
This document assumes you are familiar with Mule, xref:3.7@mule-runtime::anypoint-connectors.adoc[Anypoint Connectors], and xref:5.x@studio::index.adoc[Anypoint Studio Essentials]. To increase your familiarity with Studio,
consider completing one or more xref:5.x@studio::basic-studio-tutorial.adoc[Basic Studio Tutorials]. Further,
