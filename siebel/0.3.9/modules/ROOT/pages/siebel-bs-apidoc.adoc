...
:page-aliases: 3.9@mule-runtime::siebel-bs-apidoc.adoc
...
https://www.mulesoft.com/exchange/org.mule.modules/mule-module-siebel-businessservice/[Oracle Siebel Connector Business Services Connector on Exchange]
