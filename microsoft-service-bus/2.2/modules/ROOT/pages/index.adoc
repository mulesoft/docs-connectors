= Microsoft Service Bus Connector 2.2 
:page-aliases: connectors::ms-service-bus/ms-service-bus-connector.adoc, connectors::ms-dynamics/ms-service-bus-connector.adoc, connectors::ms-service-bus-connector.adoc
...
image::ms-service-bus-studio-1.png["Microsoft Service Bus connector global elements properies config window on General tab"]
...
image::ms-service-bus-flow.png["Studio flow for retrieving a list of existing queues"]
...
. Use the PowerShell cmdlet https://learn.microsoft.com/en-us/previous-versions/azure/jj248762(v=azure.10)?redirectedfrom=MSDN[Get-SBAutoGeneratedCA] to download the certificate locally in the machine running the Windows Service Bus. +
...
image::ms-service-bus-demo-1.png["Studio flows for the Windows Service Bus AMQP use case"]
...
image::ms-service-bus-demo-2.png["Studio flows for Windows Service Bus Management use case"]
