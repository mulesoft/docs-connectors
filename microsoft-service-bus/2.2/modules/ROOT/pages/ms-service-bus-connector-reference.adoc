...
|===
| Name | Type | Description | Default Value | Required
| Read Timeout a| Number |  The amount of time that the client will wait for a response before it times out. 0 specifies that the client will wait indefinitely. |  60000 |
