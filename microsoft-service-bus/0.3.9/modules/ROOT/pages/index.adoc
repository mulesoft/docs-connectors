...
|*Enable DataSense* |If you intend to employ the Microsoft Service Bus connector in conjunction with an Anypoint DataMapper to map and transform data, you can make use of Anypoint Studio's xref:studio::datasense-concept.adoc[] functionality. You can enable DataSense as part of configuring the global element.
|===
+
. Windows Service Bus:
+
