...
* `KexAlgorithms`: Specifies comma separated list of Key Exchange algos
* `Ciphers`: Specifies the comma separated list of symmetric Ciphers
* `HostKeyAlgorithms`: Specifies comma separated list of Host Key Signature algos
* `MACs`: Specifies comma separated list of Message Authentication Codes

User only needs to define the keys in the file, required to override, defaults will be taken for others.
|  |
|===
