...
* SFTP:KEY_EXCHANGE_FAILED
 ...
 The app tried to make ssh connection to the server, but failed in the key exchange step. Failure may occur during the negotiation or later steps in key exchange.
