...
When using the `APPEND` write mode, SFTP Connector overwrites the existing file instead of appending data to it, or the operation fails with a generic error.
