...
IMPORTANT: Avoid storing private keys in your source code repository. For production, use xref:mule-runtime::secure-configuration-properties.adoc[secure configuration properties] or a secrets manager.
...
. Set *Identity file* to reference your PEM file using the `${app.home}` property, for example `${app.home}/keys/private.pem`. Place the PEM file in your project's `src/main/resources/keys` folder.
...
<sftp:config name="SFTP_Config" doc:name="SFTP Config" >
		<sftp:connection host="sftp.host.com" username="sftp username" password="sftp password" identityFile="${app.home}/keys/private.pem" passphrase="passwordfile" >
