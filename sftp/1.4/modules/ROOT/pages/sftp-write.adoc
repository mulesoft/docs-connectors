...
The Anypoint Connector for SFTP (SFTP Connector) *Write* operation writes content into the given path on demand.
...
.Write operation configuration with Content field
