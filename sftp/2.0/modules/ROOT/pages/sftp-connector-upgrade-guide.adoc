= Upgrade and Migrate SFTP Connector to Version 2.0  
...
* If the application has Bouncy Castle jars in the classpath, then the connector may alter the providers list by registering BC providers automatically.
