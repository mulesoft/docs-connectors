...
The *On New Or Updated File* source ignores files with empty attributes list returned. This can occurs because an SFTP server does not have MDTM enabled or returns an error during the file listing.
