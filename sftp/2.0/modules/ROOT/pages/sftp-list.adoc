...
[source,xml,linenums]
----
<sftp:list-and-get doc:name="List" config-ref="SFTP_Config" directoryPath="~/dropFolder"/>
----
...
----
<flow name="list">
  <sftp:list-and-get directoryPath="~/dropFolder" />
  <foreach>
    <choice>
...
http://www.mulesoft.org/schema/mule/os http://www.mulesoft.org/schema/mule/os/current/mule-os.xsd">
	...
	<flow name="poll">
	  ...
	  <sftp:list-and-get directoryPath="/config/dropFolder" config-ref="SFTP_Config"/>
...
[source,xml,linenums]
----
<sftp:list-and-get doc:name="List" config-ref="SFTP_Config" directoryPath="/upload">
...
<sftp:matcher name="smallFileMatcher" maxSize="100" />
      ...
      <sftp:list-and-get path="~/smallfiles" matcher="smallFileMatcher" />
      ...
</flow>
----
