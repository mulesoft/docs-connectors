...
[NOTE]
For automatic polling, use the SFTP xref:sftp-on-new-file.adoc[On New or Updated File] operation that enables you to optionally set post-processing options to automatically move or delete files.
