...
Anypoint Connector for SFTP (SFTP Connector) can read a file at any point in the flow, unlike in Mule 3, where the transport reads only files as a result of inbound endpoint polling.
