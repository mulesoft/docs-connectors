...
The Write operation fails by default if you set non-existent directories in the *Path* parameter. Therefore, you can set the *Crete parent directories* parameter to `True (Default)` to automatically create any missing directories.
