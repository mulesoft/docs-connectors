...
Many integrations require connecting to different servers based on an specific condition, such as:
...
To accomplish this example, create the Mule application, configure HTTP, File and SFTP global configuration elements, and run and test the application with curl commands:
