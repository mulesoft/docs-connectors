...
:page-aliases: 3.8@mule-runtime::sftp-connector.adoc
...
* Mule 3.8 and newer accepts SSH known_hosts files. For more information, see the xref:3.8@mule-runtime::sftp-transport-reference.adoc[SFTP Transport Reference].
...
* See the xref:3.8@mule-runtime::sftp-transport-reference.adoc[SFTP Transport Reference] for details on setting the properties for an SFTP endpoint using an XML editor.
