...
* OVERWRITE
+
If the file to be written already exists, then it should be overwritten.
* APPEND
+
If the file to be written already exists, then the content should be appended to that file.
* CUSTOM_APPEND
+
If the file to be written using the `CUSTOM` write strategy already exists, then the content should be appended to that file.
* CREATE_NEW 
+
A new file should be created and an error should be raised if the file already exists.
