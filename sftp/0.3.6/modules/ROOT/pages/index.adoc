...
* See the xref:3.6@mule-runtime::sftp-transport-reference.adoc[SFTP Transport Reference] for details on setting the properties for an SFTP endpoint using an XML editor.
