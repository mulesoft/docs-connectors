= SFTP Connector
:page-aliases: 3.5@mule-runtime::sftp-connector.adoc
...
* [SFTP Connector on Exchange]
* xref:3.5@mule-runtime::sftp-transport-reference.adoc[SFTP Transport Reference] for details on setting the properties for an SFTP endpoint using an XML editor.
