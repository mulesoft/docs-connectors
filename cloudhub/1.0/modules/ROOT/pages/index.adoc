...
NOTE: CloudHub Connector is supported only on CloudHub 1.0. CloudHub Connector isn't supported on CloudHub 2.0 or Runtime Fabric. For more information about feature comparison, see xref:cloudhub-2::ch2-features.adoc[].
