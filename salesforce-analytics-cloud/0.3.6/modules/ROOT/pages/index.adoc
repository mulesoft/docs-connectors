...
Refer to documentation on xref:3.6@mule-runtime::batch-processing.adoc[Batch Processor] and xref:6.x@studio::datamapper-user-guide-and-reference.adoc[Data Mapper] for in-depth information about these Mule elements.
...
* Learn about the xref:6.x@studio::datamapper-user-guide-and-reference.adoc[DataMapper] transformer.
