= Salesforce Einstein Analytics Connector 3.5 Reference - Mule 4
...
** MINUTES
** HOURS
** DAYS |  +++A TimeUnit which qualifies the #readTimeout+++ |  +++MILLISECONDS+++ | 
...
** MINUTES
** HOURS
** DAYS |  +++A TimeUnit which qualifies the #connectionTimeout+++ |  +++MILLISECONDS+++ | 
