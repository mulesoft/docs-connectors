...
+
** Type +
Type of the records to be inserted. You need to upload a JSON file representing the schema of the dataset to create.
** Records +
...
* Principal +
Salesforce username that you want to use
...
Consumer key for the Salesforce connected app.
* Keystore File +
Path to the keystore used to sign data during authentication. NOTE: Only the Java keystore format is allowed.
* Store Password +
Keystore password.
* Principal +
...
The Keystore is the path to the keystore used to sign data during authentication. This example shows how to generate a JKS file.
