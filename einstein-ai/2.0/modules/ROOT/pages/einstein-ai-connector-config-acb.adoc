= Using Anypoint Code Builder to Configure Einstein AI Connector 2.0 
...
[source,xml]
----
<ms-einstein-ai:config name="name">
  <ms-einstein-ai:oauth-client-credentials-connection>
    <ms-einstein-ai:oauth-client-credentials clientId="#[]" clientSecret="#[]"/>
  </ms-einstein-ai:oauth-client-credentials-connection>
