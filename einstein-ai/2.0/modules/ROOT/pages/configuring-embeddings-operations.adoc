= Configuring Embedding Operations for Einstein AI Connector 2.0
...
* *Prompt*
+
Plain text prompt to send to the LLM. This field is required.
* *Input Stream*
+
...
* *Input Stream*
+
Document content to ingest into the vector database. This field defaults to `#[payload]`.
. In *Additional properties*, select:
* *Model API Name*
+
Name of the API model that interacts with the LLM.
