...
include::connectors::partial$einstein-ai-connector-config.adoc[tags=embedding-configs]
...
* xref:einstein-ai-chain-connector-reference.adoc[Einstein AI Connector Reference]
