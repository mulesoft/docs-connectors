...
[source,xml]
----
<mac-einstein:config configType="Environment Variables" filePath="-" llmType="OPENAI" modelName="gpt-4o" name="Einstein_AI_Config">
</mac-einstein:config>
----
+
...
----
 <http:listener-config basePath="/path" name="HTTP-Listener-config">
  ...
  <mac-einstein:config configType="Environment Variables" filePath="-" llmType="OPENAI" modelName="gpt-4o" name="Einstein_AI_Config"></mac-einstein:config>
