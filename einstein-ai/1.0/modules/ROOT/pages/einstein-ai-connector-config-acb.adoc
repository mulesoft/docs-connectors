...
[source,xml]
----
<ms-einstein-ai:config name="Einstein_Config1" doc:name="Einstein Config" doc:id="4f8dc8e3-aad0-4040-9d22-89527cc83d3a" >
		<ms-einstein:oauth-client-credentials-connection >
			<ms-einstein:oauth-client-credentials clientId="clientid" clientSecret="clientsecret" />
		</ms-einstein:oauth-client-credentials-connection>
...
----
 <http:listener-config basePath="/path" name="HTTP-Listener-config">
  ...
  <ms-einstein-ai:config configType="Environment Variables" filePath="-" llmType="OPENAI" modelName="gpt-4o" name="Einstein_AI_Config"></ms-einstein-ai:config>
