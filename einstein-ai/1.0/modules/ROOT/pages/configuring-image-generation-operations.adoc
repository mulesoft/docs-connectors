...
The *Image read* operation reads and interprets an image based on a prompt. Currently, Einstein AI Connector supports only OpenAI Image Models.
...
The *Image generate* operation generates an image based on a prompt sent to the LLM. Currently, Einstein AI Connector supports only OpenAI Image Models.
