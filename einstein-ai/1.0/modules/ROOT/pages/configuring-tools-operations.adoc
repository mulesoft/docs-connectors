= Configuring Tools Operations for Einstein AI Connector 1.0

Use the *Tools use AI service* operation to create autonomous agents that can use external tools whenever a prompt can't be answered directly by the AI model. 
