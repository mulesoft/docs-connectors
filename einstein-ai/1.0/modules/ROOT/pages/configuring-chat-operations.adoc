...
The *Chat generate from messages* operation is a prompt request operation to the configured LLM, with provided messages. It uses a plain text prompt as input and responds with a plain text answer.
