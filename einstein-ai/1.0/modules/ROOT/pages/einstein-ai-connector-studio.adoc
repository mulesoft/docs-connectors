= Using Anypoint Studio to Configure Einstein AI Connector 1.0 - Mule 4
...
. In *Mule Palette*, select *Einstein AI Connector* and then select the operation to add.
+
image:einstein-ai-palette-operations.png["Mule palette in Studio with Einstein AI selected and all of the connector's operations listed"]
...
+
image:einstein-ai-config-studio.png["Global Element Properties window with configuration fields filled out for the Environment Variables configuration type"]
