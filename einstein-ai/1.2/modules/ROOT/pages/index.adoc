= Einstein AI Connector 1.2 - Mule 4
...
To configure the connector, you must create a Connected App in Salesforce. For more information, see https://developer.salesforce.com/docs/einstein/genai/guide/models-api.html[Models API Developer Guide].
