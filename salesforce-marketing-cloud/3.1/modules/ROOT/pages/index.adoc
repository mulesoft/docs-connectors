...
is parsed and transformed into an XML object before it is sent. Because of this, any other filter
that is not included in the table above or any other SQL syntax features, such as 
