= Salesforce Marketing Cloud Connector 5.0 Examples 

These examples show several Mule flows for Salesforce Marketing Cloud Connector: 
...
This example uses these operations:
