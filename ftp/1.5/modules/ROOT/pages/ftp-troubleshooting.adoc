= Troubleshoot FTP Connector - Mule 4
...
* Try to replicate the issue using a FTP client, for example, Cyberduck or Filezilla. If the issue also occurs with these clients, then it is likely that the issue is not related to the Mule app.
