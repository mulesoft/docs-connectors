...
* *Timestamp since* +
Files created before this date are rejected. _Any timezone specification in this value will be ignored and the Mule server’s timezone will be used instead._
* *Timestamp until* +
Files created after this date are rejected. _Any timezone specification in this value will be ignored and the Mule server’s timezone will be used instead._
