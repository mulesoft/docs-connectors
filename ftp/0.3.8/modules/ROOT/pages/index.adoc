...
:page-aliases: 3.8@mule-runtime::ftp-connector.adoc
...
* See the xref:3.8@mule-runtime::ftp-transport-reference.adoc[FTP Transport Reference] for details on setting the properties for an FTP endpoint using an XML editor.
