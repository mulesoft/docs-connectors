...
- Mule Enterprise Edition is needed for this properties provider to work. The following repository and their associated credentials need to be added in the maven settings.
