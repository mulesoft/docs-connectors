= Azure Key Vault Properties Provider 1.0 
...
Connectors can use the Azure Key Vault Properties Provider in their configurations. Here's an example of MongoDB Connector using Azure Key Vault Properties Provider in the MongoDB connection type configuration.
