...
Connectors can use the Azure Key Vault Properties Provider in their configurations. Here is an example of MongoDB Connector using Azure Key Vault Properties Provider in the MongoDB connection type configuration.
