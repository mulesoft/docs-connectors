...
|======================
| Field | Type | Description | Default Value | Required
| Message Group Id a| String | Token that specifies where a message belongs to. |  | x
| Message Deduplication Id a| String | Token for deduplication of messages. It is mandatory when deduplication is not set in the topic level. |  |
|======================
