= Upgrade Amazon SNS Connector to Version 4.7
...
* Added support for *FIFO (first in first out) Topic*, which together with *Amazon SQS FIFO queues* provide strict message ordering and message deduplication.
