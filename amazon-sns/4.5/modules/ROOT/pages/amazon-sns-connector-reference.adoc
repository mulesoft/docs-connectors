= Amazon SNS 4.5 Connector Reference



Amazon SNS Connector Version 4.5.0
...
| Host a| String |  The optional proxy host that has protocol information. For example, `https://localhost` or `http://localhost`. |  |
| Port a| Number |  The optional proxy port, which can't be null when the proxy host is present. |  |
