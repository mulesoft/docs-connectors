= Snowflake Connector 1.1 Examples - Mule 4
...
This example shows how to use the *On Table Row* source to return rows of a table based on a watermark.
...
http://www.mulesoft.org/schema/mule/db http://www.mulesoft.org/schema/mule/db/current/mule-db.xsd">
	...
	<flow name="listener-flow" doc:id="f15e3877-7a95-454a-b262-0b5ccb14e279" >
		<snowflake:row-listener doc:name="Row Listener" doc:id="7152b633-3195-4b84-833f-c70e8555cd1c" config-ref="Snowflake_Config" table="USERS" watermarkColumn="CREATION_DATE" idColumn="ID" since="2021-12-14 11:00:00.000">
			<scheduling-strategy >
				<fixed-frequency />
			</scheduling-strategy>
		</snowflake:row-listener>
		<ee:transform doc:name="Transform Message" doc:id="9a21c05b-8dee-4acc-9c71-7fbcbc066c45" >
			<ee:message >
...
payload]]></ee:set-payload>
		...
		<logger level="INFO" doc:name="Logger" doc:id="dedaa282-2311-46c6-8344-68ebca5adeff" message="#[payload]"/>
	</flow>
</mule>
----
...
. Save the project.
. From a web browser, test the application by entering `http://localhost:8081/listener`.
