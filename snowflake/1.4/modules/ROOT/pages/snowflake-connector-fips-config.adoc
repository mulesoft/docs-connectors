...
For more information on obtaining the FIPS-certified driver, see the https://docs.snowflake.com/en/developer-guide/jdbc/jdbc[Snowflake JDBC Driver documentation].
====
