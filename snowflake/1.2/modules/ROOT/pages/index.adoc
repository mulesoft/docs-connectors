...
- Basic Snowflake Connection: Connect to Snowflake via user and password.
- Key-pair Snowflake Connection: Connect to snowflake using encrypted or unencrypted private keys.
