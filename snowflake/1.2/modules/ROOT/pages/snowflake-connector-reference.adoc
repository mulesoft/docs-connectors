...
Refer to Snowflake documentation on how to configure: https://docs.snowflake.com/en/user-guide/key-pair-auth#configuring-key-pair-authentication[configure key-pair authentication]. 
