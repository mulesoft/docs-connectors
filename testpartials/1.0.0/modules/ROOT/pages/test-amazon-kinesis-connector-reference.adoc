= Test Amazon Amazon Kinesis Data Streams Connector 1.0 Reference - Mule 4
...
* xref:test-amazon-kinesis-connector-reference.adoc[Amazon Kinesis ConnectorReference]
