= AS2 Connector Reference 6.0 - Mule 4
...
|  The security level required for any AS2 Listener using this config for all incoming messages. Should the security requirement not be met, an error MDN response shall result. |  |
