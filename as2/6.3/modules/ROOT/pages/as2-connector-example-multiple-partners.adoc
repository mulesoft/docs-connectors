...
** The *Listener Mode* field must be set to *Shared mode* and details are specified for the additional partner.
** The *Partner config* section of this tab, which is highlighted in the following screenshot, must be left blank or the connector returns errors:
+ 
