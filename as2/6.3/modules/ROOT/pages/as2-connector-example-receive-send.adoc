...
image::as2-connector-example-listener-flow.png[AS2 Receive AS2 Messages App Flow]
...
image::as2-connector-example-sync-flow.png[AS2 Send Synchronous MDN App Flow]
...
=== XML for the Sending Synchronous MDNs Example
...
image::as2-connector-example-async-flow.png[AS2 Send Asynchronous MDN App Flow]

== XML for Sending Asynchronous MDNs Example
