...
+
. Test the app by opening `+http://localhost:8081/+` from a browser or an app like Postman and adding the required credentials.
+
...
`Mule is up and kicking`
+
. Test the app by opening `+http://as2-send:8082/sendSyncFlow+` from a browser or an app like Postman.
+
