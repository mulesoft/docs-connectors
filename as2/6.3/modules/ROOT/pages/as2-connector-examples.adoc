...
=== Listening for AS2 Messages

The following flow listens for AS2 messages:

image::as2-connector-example-send-mdn-2.png[Flow for receiving and forwarding AS2 messages]
