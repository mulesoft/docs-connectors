...
+
To implement this feature, a new tab named *Partners* was added to the *As 2 listener* and *As 2 mdn listener* global elements. This tab contains fields that were were moved from the *Partner Config* section of the *Geneneral* tab, as well as some new fields.
+
...
=======
* It is possible to configure a single AS2 listener endpoint to receive messages from multiple partners using the *Shared listener mode* option.
* It is possible to pass custom headers on outbound AS2 messages in *Send with Sync MDN* and *Send with Async MDN* operations.
>>>>>>> 78044fc445b4b68d184c2d60dd298f04c83e319f
