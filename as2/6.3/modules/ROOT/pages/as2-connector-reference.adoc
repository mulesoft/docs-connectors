...
[NOTE]
====
Asynchronous MDNs are automatically sent from the AS2 connector to the receipt URL provided in the inbound transmission. If the receipt URL is inaccessible, the inbound AS2 message is not processed.
====
