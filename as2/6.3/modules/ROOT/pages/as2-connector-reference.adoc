...
| Listener Mode| 'Dedicated mode' or 'Shared mode' |  If 'Dedicated mode' is selected, check 'Partner config' (mandatory) and then provide the information related to the Partner Config. If 'Shared mode' is selected, uncheck 'Partner config' (mandatory) and then create each by one the Partners |  | x

| Dedicated mode - Partner Config - AS2 Partner Name a| String |  AS2 system identifier used for AS2-From and AS2-To headers. |  | x
| Dedicated mode - Partner Config - x509 Alias a| String |  Certificate or private key alias in the keystore. Required if using signing or encryption. |  |
| Dedicated mode - Partner Config - email a| String |  Email address used as HTTP 'From' header when sending. |  | x

| Shared mode - Partners - AS2 Partner Name a| String |  AS2 system identifier used for AS2-From and AS2-To headers. |  | x
| Shared mode - Partners - x509 Alias a| String |  Certificate or private key alias in the keystore. Required if using signing or encryption. |  |
| Shared mode - Partners - email a| String |  Email address used as HTTP 'From' header when sending. |  | x
| Shared mode - Inbound Request Authentication a| One of:
* <<AS2BasicAuthentication>> |  Authentication method to use for verifying the incoming HTTP request. |  |
|===
...
| MDN Listener Mode| 'Mdn dedicated mode' or 'Mdn shared mode' |  If 'Mdn Dedicated mode' is selected, check 'Partner config' (mandatory) and then provide the information related to the Partner Config. If 'Mdn shared mode' is selected, uncheck 'Partner config' (mandatory) and then create each by one the Partners |  | x

| Mdn dedicated mode - Partner Config - AS2 Partner Name a| String |  AS2 system identifier used for AS2-From and AS2-To headers. |  | x
| Mdn dedicated mode - Partner Config - x509 Alias a| String |  Certificate or private key alias in the keystore. Required if using signing or encryption. |  |
| Mdn dedicated mode - Partner Config - email a| String |  Email address used as HTTP 'From' header when sending. |  | x

| Mdn shared mode - Partners - AS2 Partner Name a| String |  AS2 system identifier used for AS2-From and AS2-To headers. |  | x
| Mdn shared mode - Partners - x509 Alias a| String |  Certificate or private key alias in the keystore. Required if using signing or encryption. |  |
| Mdn shared mode - Partners - email a| String |  Email address used as HTTP 'From' header when sending. |  | x
|===
...
| Custom headers | String |  It allows to add custom keys to be sent on outbound AS2 messages. |  |
| Custom headers - Name | String |  The name of the key that will be sent on outbound AS2 message with format "Name" |  |
| Custom headers - Value | String |  The content of the key that will be sent on outbound AS2 message with format "Value" |  |
|===
