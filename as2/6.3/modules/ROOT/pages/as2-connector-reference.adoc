...
| Custom headers | String |  It allows to add custom keys to be sent on outbound AS2 messages.
                             ...
                             * Name: the name of the key that will be sent on outbound AS2 message with format "Name"
                             * Value: the content of the key that will be sent on outbound AS2 message with format "Value" |  |
|===
