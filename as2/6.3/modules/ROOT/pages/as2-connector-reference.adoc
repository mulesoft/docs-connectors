...
| Dedicated mode - Partner Config - Partners a| Enumeration, one of:
...
+
If you select *Dedicated mode*, check *Partner config* (mandatory) and configure the partner using the MDN dedicated mode fields in this table.
+
* Shared Mode
+
