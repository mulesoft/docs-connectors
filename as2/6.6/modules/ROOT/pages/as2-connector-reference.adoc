...
| MDN Partner Config - x509 Alias For MDN Signature|String|Certificate key alias in the keystore if using a different certificate for MDN signature validation||
| Self config - AS2 Partner Name a| String |  AS2 system identifier (used for AS2-From and AS2-To headers) |  | x
