...
AS2 Connector 6.8 contains the following changes:
Additional validations are now performed on the keystore and the algorithm usage to address reported security vulnerabilities.
