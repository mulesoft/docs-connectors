...
* The *Check duplicated messages* field enables you to check if a message was already processed.
* The *Store time-to-live* field enables you to define the number of days that the message will be stored.

Both of these fields are on the listener *General* tab.
