...
AS2 Connector 6.5 contains new functionality that enables you to check for duplicate incoming messages when using the *As 2 listener* source. To support this new functionality, the release contains the following new global configuration elements:
