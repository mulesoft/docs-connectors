...
Anypoint Connector for AS2 (AS2 Connector) enables AS2 Connector enables trading partners to transmit and receive AS2 messages that contain EDI-X12, EDIFACT, XML, or binary payloads.
