...
. Or click *Create global element*, and then click the plus icon next to Global Elements.
...
For configuration instructions for other security modes, see xref:as2-connector::as2-connector-upgrade-migrate.adoc#configure-external-libraries[Configure External Libraries].
