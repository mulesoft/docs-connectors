...
image::as2-connector-upgrade-fips140-2-config.png["The Connector Configuration Global Element and the configurations for FIPS 140-2 security mode"]
...
image::as2-connector-upgrade-fips140-3-config.png["The Connector Configuration Global Element and the configurations for FIPS 140-3 security mode"]
