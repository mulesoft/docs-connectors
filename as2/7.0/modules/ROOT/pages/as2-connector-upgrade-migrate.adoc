...
image::as2-connector-upgrade-fips140-2-config.png["The Connector Configuration Global Element and the configurations for using the FIPS 140-2 security mode"]
