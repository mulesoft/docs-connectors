...
* <<send-with-synchronous-mdn,Send with Sync MDN>>
+
Send an AS2 message and receive a synchronous MDN in response to the AS2 message.
+
* <<send-with-asynchronous-mdn,Send with Async MDN>>
+
Send an AS2 message and receive an asynchronous MDN in response to the AS2 message.
