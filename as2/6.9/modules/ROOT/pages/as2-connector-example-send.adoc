...
The MDN is omitted from the logs because it's routed to the `receiptDeliveryUrl` as shown in the xref:as2-connector-example-receiveing-mdn-messages.adoc[Receiving AS2 MDNs] example.
----
== See Also
