...
You can now send AS2 requests to the endpoint configured in the <<receiving-messages,Receiving AS2 Messages>> example. With the example running, you can observe the message sent by the *Send with Sync MDN* operation.
