...
When your trading partner is using an *AS 2 Listener* (for example, the <<receiving-messages,Receiving AS2 Messages>> example in this page), the listener’s MDN mode controls when a synchronous MDN is returned:
