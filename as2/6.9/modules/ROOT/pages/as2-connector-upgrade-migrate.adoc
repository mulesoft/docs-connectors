= Upgrading and Migrating AS2 Connector to Version 6.x 
...
The connector now supports MDN Signatures that are Base64-encoded and have lines that exceed 76 characters.

=== 6.8

Additional validations are now performed on the keystore and algorithm usage to address reported security vulnerabilities.
