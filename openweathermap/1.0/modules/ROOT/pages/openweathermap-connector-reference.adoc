= OpenWeatherMap Connector 1.0 Reference
...
|Name a| String | Name for this configuration. Connectors reference the configuration with this name. | | x
...
|===
| Name | Type | Description | Default Value | Required
| apiKey a| String | API key used to authenticate requests to the OpenWeatherMap API. | | x
| baseUri a| String | Base URI for the OpenWeatherMap API endpoint. | | x
...
|===
| Name | Type | Description | Default Value | Required
| Configuration a| String | Name of the configuration to use. | | x
| lat a| Number | Latitude coordinate of the location. | | x
| lon a| Number | Longitude coordinate of the location. | | x
| units a| Enumeration, one of:

** standard
** metric
** imperial | Temperature units for the response. | |
| lang a| String | Language code for the response text. | |
...
* OPENWEATHERMAP:BAD_REQUEST
* OPENWEATHERMAP:CLIENT_ERROR
* OPENWEATHERMAP:CONNECTIVITY
* OPENWEATHERMAP:FORBIDDEN
* OPENWEATHERMAP:NOT_FOUND
* OPENWEATHERMAP:SECURITY
* OPENWEATHERMAP:SERVER_ERROR
* OPENWEATHERMAP:TIMEOUT
* OPENWEATHERMAP:TOO_MANY_REQUESTS
* OPENWEATHERMAP:UNAUTHORIZED

[[GetTimestampData]]
== Get Timestamp Data
`<openweathermap:get-timestamp-data>`
...
| lat a| Number | Latitude coordinate of the location. | | x
| lon a| Number | Longitude coordinate of the location. | | x
| Unix Timestamp | Number | Timestamp (Unix time, UTC time zone). Data is available from January 1st, 1979 till 4 days ahead. | | x
| units a| Enumeration, one of:
...
`<openweathermap:get-weather-overview>`
...
| Target a| String | Target error type to map to. | | x
|===
