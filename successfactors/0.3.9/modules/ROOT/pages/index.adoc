...
+
image::success-factors-global-element.png["Global element properties window"]
+
...
image::list-flow.png["List entities flow"]

The connector itself does not require any additional configuration, apart from the operation to select:

image::list-flow-connector-config.png["List entities operation properties window"]
...
image::describe-flow.png["Describe entities flow"]
...
image::describe-flow-connector-config.png["Describe entities operation properties window"]
...
image::query-flow.png["Query flow"]
...
image::query-flow-query-builder.png["Query builder window for query flow with fields selected"]

You can leave the page size at the default value.

image::query-flow-connector-config.png["Query operation properties window"]
...
image::upsert-flow.png["Upsert flow"]
...
image::upsert-flow-connector-config.png["Upsert operation properties window"]
...
image::update-flow.png["Update flow"]
...
image::insert-flow.png["Insert flow"]
...
image::sfc-insert-flow-connector-config.png["Insert operation properties window"]
...
image::delete-flow.png["Delete flow"]
...
image::delete-flow-connector-config.png["Delete flow properties window"]
...
image::dataweave-payload.png["DataWeave payload"]
