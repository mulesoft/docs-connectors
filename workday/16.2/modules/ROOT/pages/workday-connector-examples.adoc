= Workday Connector 16.2 Examples - Mule 4
...
image:workday-select-listener.png["Listener component selected in Mule palette"]
+
...
image::workday-http-props.png["Listener configuration in properties window"]
...
image::workday-select-transform.png["Transform Message component selected in Mule palette"]
+
