...
* For more information on Workday v25.0 API, refer to the https://community.workday.com/custom/developer/API/versions/v25.0/index.html[Workday API documentation].
* Workday v25.0 https://community.workday.com/current/wsrelnotes[Release Notes] (Requires Workday Community login)
