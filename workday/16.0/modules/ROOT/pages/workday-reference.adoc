...
Invokes the ACA Partner Integrations web service supporting Federal and State reporting operations for ACA partners and vendor integrations that report customer ACA data.
