...
To configure an *On New Objects* source:

. In the *Mule Palette* view, select *Workday > On New Objects*.
. Drag *On New Objects* source to the Studio canvas.
. On the *On New Objects* configuration screen, optionally change the value of the *Display Name* field.
