= Workday Connector 16.6 Reference 
...
| Authorization Url a| String |  Service provider's authorization endpoint URL. |  `\https://impl.workday.com/wday/authgwy/<tenantName>/authorize` | 
