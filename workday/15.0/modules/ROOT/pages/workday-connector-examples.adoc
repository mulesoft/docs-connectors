= Workday Connector 15.0 Examples - Mule 4
...
+
Ensure that the value for the *Operation* field is available as a menu item. The values become available once the connector loads the metadata for them. Do not type the value manually.
+
