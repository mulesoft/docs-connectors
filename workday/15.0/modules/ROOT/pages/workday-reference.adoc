= Workday Connector 15.0 Reference - Mule 4
...
** CANONICAL_XML_1_0
** CANONICAL_XML_1_1
** EXCLUSIVE_XML_CANONICALIZATION_1_0 |  The c14n (canonicalization) algorithm to use. |  EXCLUSIVE_XML_CANONICALIZATION_1_0 |
|======================
...
| Headers a| Any |  headers included in the request |  | {nbsp}
...
Operation to invoke Metadata Translations Web Service. Import Metadata Translations using EIB.
...
Web service operations designed for the interaction with Org Studio Setup Data.
...
| Streaming Strategy a| * <<repeatable-in-memory-stream>>
* <<repeatable-file-store-stream>>
* <<non-repeatable-stream>> |  Configures how Mule processes streams. The deafult is to use repeatable streams. |  |
| Response Timeout a| Number |  Time to wait for a response. |  |
| Response Timeout Unit a| Enumeration, one of:
