= Upgrade to Workday Connector 13.x - Mule 4
...
* Changed the name of the `Configuration Version 34` to `Configuration`.
* Changed the name of the `Basic authentication api v 34` connection type to `Basic authentication`.
