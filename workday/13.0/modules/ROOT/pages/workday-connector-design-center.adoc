...
A trigger starts your app. Workday Connector provides the *On Modified Objects* trigger that starts your app when an object is created, modified, or deleted in Workday. Alternatively, you can use:
