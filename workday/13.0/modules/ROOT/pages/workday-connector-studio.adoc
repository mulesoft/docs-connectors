...
|Digest Algorithm |Enter the digest algorithm to use.
...
After you configure a global element for Workday Connector, configure the the other required fields for the connector, as described in the xref:connectors::workday-reference.adoc[Workday Connector Reference].
