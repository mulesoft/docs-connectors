...
| Access Type a| String | Access type. |  `offline` | 
| Prompt a| String | Asks for user consent even if the user is already logged in. |  `consent` |
...
Sends the specified message to the recipients in the To, Cc, and Bcc headers. This operation makes an HTTP POST request to the /gmail/v1/users/{userId}/messages/send endpoint and returns the email ID of the sent message.
...
| Name | Type | Description | Default Value | Required
| Configuration | String | Name of the configuration to use. | | x
| Recipients a| Array of String |  Email addresses of the recipients. |  | x
| Subject a| String |  Subject of the email. |  | x
| Body a| String |  |  | x
| Attachment list a| Array of <<EmailAttachment>> | Attachment list. |  |
| Config Ref a| ConfigurationProvider |  Name of the configuration used to execute this component. |  | x
| Streaming Strategy a| * <<RepeatableInMemoryStream>>
* <<RepeatableFileStoreStream>>
...
Configures the email attachment type.

[%header,cols="20s,25a,30a,15a,10a"]
|===
| Field | Type | Description | Default Value | Required
| Content a| Binary | Content of the email attachment. |  | 
| Filetype a| String | File type of the email attachment. |  | 
| Id a| String | ID of the email attachment. |  | 
| Name a| String | Name of the email attachment. |  | 
| Size a| String | Size of the email attachment.  |  | 
|===
