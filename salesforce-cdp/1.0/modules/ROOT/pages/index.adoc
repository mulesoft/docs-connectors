...
For information about configuring authentication types, see xref:salesforce-cdp-connector-studio.adoc[Use Studio to Configure Salesforce Data Cloud Connector].
