...
image::upsert-flow.png[Salesforce CDP Upsert Flow Diagram - (Listener - Logger - Upsert Objects - Response Logger)]
...
+
** Authenticates based on your choice of either JWT or username and password.
** Receives the connector name, object name, and job operation. You can find the job operations in the *Resources* page.
