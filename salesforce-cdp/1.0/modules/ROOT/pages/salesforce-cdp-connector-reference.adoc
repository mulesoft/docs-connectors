...
| Source API name a| String |  Name of Ingestion source API to work with |  | x
...
Insert Objects This operation makes an HTTP POST request to the /ingest/connectors/{connector-name}/{object-name} endpoint
