= Salesforce Data Cloud Connector 1.3 Examples - Mule 4
...
image::get-job-bulk.png["Salesforce Data Cloud List Jobs flow with Listener, List Jobs, and Logger"]
...
This Mule flow shows how to retrieve all bulk jobs. Refer to the https://developer.salesforce.com/docs/data/data-cloud-ref/guide/c360a-api-get-all-jobs.html[Salesforce API docs].
...
image::list-jobs-bulk.png["Salesforce Data Cloud Get Job flow with Listener, List Jobs, and Logger"]
