= Salesforce Data Cloud Connector 1.3 
...
To use Salesforce Data Cloud Connector, you must first set up the Ingestion API. For more information, refer to https://docs.mulesoft.com/salesforce-data-cloud-connector/latest/[Connect MuleSoft with Data Cloud]. 
