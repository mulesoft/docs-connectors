= Using Anypoint Studio to Configure Salesforce Data Cloud Connector 1.2 - Mule 4
...
image::salesforce-sdc-studio-oauth-jwt.png[OAuth JWT is selected in the Connection field and the authentication fields are completed on the *General* tab.]
...
image::salesforce-sdc-studio-oauth-user-pass.png[OAuth Username Password is selected in the Connection field and the authentication fields are completed on the *General* tab.]
