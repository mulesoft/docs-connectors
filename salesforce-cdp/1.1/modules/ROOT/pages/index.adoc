...
To use Salesforce CDP Connector, you must first set up the Ingestion API. For more information, refer to https://docs.mulesoft.com/salesforce-data-cloud-connector/latest/[Connect MuleSoft with Customer Data Platform]. 
