...
This Mule flow shows how to query the Salesforce CDP data lake across data model, lake, unified, and linked objects. See the https://developer.salesforce.com/docs/atlas.en-us.c360a_api.meta/c360a_api/c360a_api_query.htm[Salesforce CDP API Developer Guide] for usage and further details.
...
This Mule flow shows how to retrieve the metadata including the dimensions and filters for a calculated insight. See the https://developer.salesforce.com/docs/atlas.en-us.c360a_api.meta/c360a_api/c360a_api_insights_meta_ci_name.htm[Salesforce CDP API Developer Guide] for usage and further details.
...
This Mule flow shows how to retrieve the list of data model objects, their fields, and category. See the https://developer.salesforce.com/docs/atlas.en-us.c360a_api.meta/c360a_api/c360a_api_profile_meta.htm[Salesforce CDP API Developer Guide] for usage and further details.
...
This Mule flow shows how to retrieve the metadata for a data model object. See the https://developer.salesforce.com/docs/atlas.en-us.c360a_api.meta/c360a_api/c360a_api_profile_meta_dmname.htm[Salesforce CDP API Developer Guide] for usage and further details.
...
This Mule flow shows how to retrieve data model object records based on search filters. See the https://developer.salesforce.com/docs/atlas.en-us.c360a_api.meta/c360a_api/c360a_api_profile_dmname.htm[Salesforce CDP API Developer Guide] for usage and further details.
...
This Mule flow shows how to retrieve data model object records based on search indexes and filters. See the https://developer.salesforce.com/docs/atlas.en-us.c360a_api.meta/c360a_api/c360a_api_profile_dmname_id.htm[Salesforce CDP API Developer Guide] for usage and further details.
...
This Mule flow shows how to retrieve data model object records along with child data model object records based on indexes and search filters. See the https://developer.salesforce.com/docs/atlas.en-us.c360a_api.meta/c360a_api/c360a_api_profile_dmname_id_child_dmname.htm[Salesforce CDP API Developer Guide] for usage and further details.
...
This Mule flow shows how to retrieve data model object records and a computed view based on indexes and search filters. See the https://developer.salesforce.com/docs/atlas.en-us.c360a_api.meta/c360a_api/c360a_api_profile_dmname_id_ci_ci_name.htm[Salesforce CDP API Developer Guide] for usage and further details.
