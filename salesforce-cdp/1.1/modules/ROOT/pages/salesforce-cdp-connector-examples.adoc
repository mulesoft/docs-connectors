...
This Mule flow shows how to query the Salesforce CDP data lake across data model, lake, unified, and linked objects. Refer to the https://developer.salesforce.com/docs/atlas.en-us.c360a_api.meta/c360a_api/c360a_api_query.htm[Salesforce CDP API Developer Guide] for usage and further details.
