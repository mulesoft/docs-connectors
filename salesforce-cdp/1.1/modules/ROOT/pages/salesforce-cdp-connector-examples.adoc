= Salesforce CDP Connector 1.1 Examples 
...
This Mule flow shows how to create a bulk job, which uploads data to a Salesforce CDP Ingestion API object. Refer to the https://developer.salesforce.com/docs/data/data-cloud-int/references/data-cloud-ingestionapi-ref/c360-a-api-create-a-job.html[Salesforce API docs].
...
This Mule flow shows how to upload data for inserting to or deleting from a Salesforce CDP Ingestion API object specified by the job ID. Refer to the https://developer.salesforce.com/docs/data/data-cloud-int/references/data-cloud-ingestionapi-ref/c360-a-api-upload-job-data.html[Salesforce API docs].
...
This Mule flow shows how to retrieve the list of data model objects and their fields and category. Refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/c360a-api-profile-meta.html[Salesforce CDP API Developer Guide] for usage and further details.
...
This Mule flow shows how to retrieve the metadata for a data model object. Refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/c360a-api-profile-meta-dmname.html[Salesforce CDP API Developer Guide] for usage and further details.
...
This Mule flow shows how to retrieve data model object records based on search filters. Refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/c360a-api-profile-dmname.html[Salesforce CDP API Developer Guide] for usage and further details.
...
This Mule flow shows how to retrieve data model object records and a computed view based on indexes and search filters. Refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/c360a-api-profile-dmname-id-ci-ci-name.html[Salesforce CDP API Developer Guide] for usage and further details.
...
. Verify you have https://help.salesforce.com/s/articleView?id=data.c360_a_create_streaming_insight.htm&type=5[created a Streaming Insight].
. Verify you https://help.salesforce.com/s/articleView?id=data.c360_a_data_actions.htm&type=5[created a Data Action Target] with an Action Target Type of `Webhook`.
. Verify you https://help.salesforce.com/s/articleView?id=data.c360_a_data_actions.htm&type=5[created a Data Action] that uses the Data Action Target and that runs on a condition against your streaming Calculated Insight.
. Save the project.
