...
Creates new records or updates existing records in Salesforce Data 360. This operation makes an HTTP POST request to the /ingest/connectors/{connector-name}/{object-name} endpoint.
