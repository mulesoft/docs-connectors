= Salesforce Data Cloud Connector 1.5 - Additional Configuration Information
...
. Go to your Mule workspace and open the terminal or shell application for your operating system. 
. Enter this command:
+
[source]
----
