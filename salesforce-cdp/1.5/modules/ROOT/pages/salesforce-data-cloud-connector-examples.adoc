= Salesforce Data Cloud Connector 1.5 Examples 
...
This Mule flow shows how to insert data via the streaming API to an object's endpoint. Refer to the https://developer.salesforce.com/docs/data/data-cloud-int/references/data-cloud-ingestionapi-ref/c360-a-api-insert-records.html[Salesforce API docs].
...
image::object-insert-flow.png["Salesforce Data Cloud Connector Insert flow with Listener, Logger, Insert Objects, and Response Logger"]
...
. https://developer.salesforce.com/docs/data/data-cloud-int/guide/c360-a-connect-an-ingestion-source.html[Verify that your connector is configured.]
. Save the project.
...
This Mule flow shows how to query data from Data 360 using a custom SOQL query. Refer to the https://developer.salesforce.com/docs/atlas.en-us.soql_sosl.meta/soql_sosl/sforce_api_calls_soql.htm[Salesforce SOQL docs].
...
image::query-flow.png["Salesforce Data Cloud Connector Query flow with Listener, Logger, Query, and Response Logger"]
...
This Mule flow shows how to send an initial query. Use this flow before <<Query v2 - Get Next Batch>>. For more information about the Query v2 API, refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/c360a-api-query-v2.html[Data 360 Reference Guide].
...
image::query-v2-flow.png["Salesforce Data Cloud Connector Query v2 flow with Listener, Logger, Set Variable, Query v2, and Flow Reference"]
...
This Mule flow shows how to page through the results using the `nextBatchId` forward only cursor for Salesforce Data 360. Use this flow after <<Query v2>>. For more information about the Query v2 Get Next Batch API, refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/c360a-api-get-query-v2.html[Data 360 Reference Guide].
...
image::query-v2-get-next-batch.png["Salesforce Data Cloud Connector Query v2 Get Next Batch flow with Listener, Logger, Set Variable, Query v2 Get Next Batch, and Flow Reference"]
...
This Mule flow shows how to delete data via the streaming API using an object's endpoint. Refer to the https://developer.salesforce.com/docs/data/data-cloud-int/references/data-cloud-ingestionapi-ref/c360-a-api-delete-records.html[Salesforce API docs].
...
image::delete-flow.png["Salesforce Data Cloud Connector Delete flow with Listener, Logger, Delete Objects, and Response Logger"]
...
This Mule flow shows how to create a bulk job, which uploads data to a Salesforce Data 360 Ingestion API object. Refer to the https://developer.salesforce.com/docs/data/data-cloud-int/references/data-cloud-ingestionapi-ref/c360-a-api-create-a-job.html[Salesforce API docs].
...
image::create-job-bulk.png["Salesforce Data Cloud Connector Create Job flow with Listener, Create Job, and Logger"]
...
This Mule flow shows how to upload data for inserting to or deleting from a Salesforce Data 360 Ingestion API object specified by the job ID. Refer to the https://developer.salesforce.com/docs/data/data-cloud-int/references/data-cloud-ingestionapi-ref/c360-a-api-upload-job-data.html[Salesforce API docs].
...
image::upload-job-data-bulk.png["Salesforce Data Cloud Connector Upload Job flow with Listener, Read, Set Payload, Upload Job Data, and Logger"]
...
This Mule flow shows how to update the status of the specified job ID so that the job is closed. After a job is closed, it is queued for processing https://developer.salesforce.com/docs/data/data-cloud-int/references/data-cloud-ingestionapi-ref/c360-a-api-close-or-abort-a-job.html[Salesforce API docs].
...
image::close-job-bulk.png["Salesforce Data Cloud Connector Close Job flow with Listener, Close Job, and Logger"]
...
This Mule flow shows how to update the status of the specified job ID so that the job is aborted. After a job is aborted, it will not be queued for processing https://developer.salesforce.com/docs/data/data-cloud-int/references/data-cloud-ingestionapi-ref/c360-a-api-close-or-abort-a-job.html[Salesforce API docs].
...
image::abort-job-bulk.png["Salesforce Data Cloud Connector Abort Job flow with Listener, Abort Job, and Logger"]
...
This Mule flow shows how to retrieve the current status of the specified job ID. Refer to the https://developer.salesforce.com/docs/data/data-cloud-int/references/data-cloud-ingestionapi-ref/c360-a-api-get-job-info.html[Salesforce API docs].
...
image::get-job-bulk.png["Salesforce Data Cloud Connector Get Job flow with Listener, Get Job, and Logger"]
...
This Mule flow shows how to retrieve all bulk jobs. Refer to the https://developer.salesforce.com/docs/data/data-cloud-int/references/data-cloud-ingestionapi-ref/c360-a-api-get-all-jobs.html[Salesforce API docs].
...
image::list-jobs-bulk.png["Salesforce Data Cloud Connector List Jobs flow with Listener, List Jobs, and Logger"]
...
. https://developer.salesforce.com/docs/data/data-cloud-int/guide/c360-a-connect-an-ingestion-source.html[Verify that your connector is configured.]
. Save the project.
. <<Create Job - Bulk API, Create a job>>.
. Test the flow by sending a `GET` to
`localhost:8081/jobs/get/`.
...
In order to delete a job, a job must have a state of `UploadComplete`, `JobComplete`, `Aborted`, or `Failed`. Refer to the https://developer.salesforce.com/docs/data/data-cloud-int/references/data-cloud-ingestionapi-ref/c360-a-api-delete-a-job.html[Salesforce API docs].
...
image::delete-job-bulk.png["Salesforce Data Cloud Connector Delete Job flow with Listener, Delete Job, and Logger"]
...
image::insights-list-metadata.png["Salesforce Data Cloud Connector Insights List Metadata flow with Listener and Insights List Metadata"]
...
This Mule flow shows how to retrieve the metadata, including the dimensions and filters for a calculated insight. Refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/c360a-api-insights-meta-ci-name.html[Salesforce Data 360 API Developer Guide] for usage and further details.
...
image::insights-get-metadata.png["Salesforce Data Cloud Connector Insights Get Metadata flow with Listener and Insights Get Metadata"]
...
image::insights-get-insights.png["Salesforce Data Cloud Connector Insights Get Insights flow with Listener and Insights Get Insights"]
...
This Mule flow shows how to retrieve the list of data model objects and their fields and category. Refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/c360a-api-profile-meta.html[Salesforce Data 360 API Developer Guide] for usage and further details.
...
image::profile-list-metadata.png["Salesforce Data Cloud Connector Profile List Metadata flow with Listener and Profile List Metadata"]
...
This Mule flow shows how to retrieve the metadata for a data model object. Refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/c360a-api-profile-meta-dmname.html[Salesforce Data 360 API Developer Guide] for usage and further details.
...
image::profile-get-metadata.png["Salesforce Data Cloud Connector Profile Get Metadata flow with Listener and Profile Get Metadata"]
...
This Mule flow shows how to retrieve data model object records based on search filters. Refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/c360a-api-profile-dmname.html[Salesforce Data 360 API Developer Guide] for usage and further details.
...
image::profile-search-records.png["Salesforce Data Cloud Connector Profile Search Records flow with Listener and Profile Search Records"]
...
This Mule flow shows how to retrieve data model object records based on search indexes and filters. Refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/c360a-api-profile-dmname-id.html[Salesforce Data 360 API Developer Guide] for usage and further details.
...
image::profile-search-records-by-id.png["Salesforce Data Cloud Connector Profile Search Records By Id flow with Listener and Profile Search Records By Id"]
...
image::profile-search-records-with-child-records.png["Salesforce Data Cloud Connector Profile Search Records With Child Records flow with Listener and Profile Search Records With Child Records"]
...
This Mule flow shows how to retrieve data model object records and a computed view based on indexes and search filters. Refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/c360a-api-profile-dmname-id-ci-ci-name.html[Salesforce Data 360 API Developer Guide] for usage and further details.
...
image::profile-search-records-with-insight.png["Salesforce Data Cloud Connector Profile Search Records With Insight flow with Listener and Profile Search Records With Insight"]
...
This Mule flow submits a SQL query against the Data 360 data lake. Submit the query in `ASYNC` mode to receive a query ID that the other Query v3 flows use, or in `ADAPTIVE` mode to receive rows in the same response when the query finishes quickly. For more information, refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/[Data 360 Reference Guide].
...
image::query-v3-flow.png["Salesforce Data Cloud Connector Query v3 flow with Listener, Logger, Query v3, and Response Logger"]
...
This Mule flow polls the execution status of a query submitted by <<Query v3>>. Poll until `completionStatus` is `RESULTS_PRODUCED` or `FINISHED`, then retrieve the results with <<Query v3 - Get Rows>> or <<Query v3 - Get Chunk>>. For more information, refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/[Data 360 Reference Guide].
...
image::query-v3-get-status.png["Salesforce Data Cloud Connector Query v3 Get Status flow with Listener, Logger, Query v3 Get Status, and Response Logger"]
...
This Mule flow pages through the results of a completed query with an offset and limit. Use this flow after <<Query v3>>. For large result sets, use <<Query v3 - Get Chunk>> instead. For more information, refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/[Data 360 Reference Guide].
...
image::query-v3-get-rows.png["Salesforce Data Cloud Connector Query v3 Get Rows flow with Listener, Logger, Query v3 Get Rows, and Response Logger"]
...
This Mule flow retrieves a chunk of a completed query result. Reading by chunk is the preferred way to consume a large result set because the service determines the chunk boundaries and streams each chunk. Chunk IDs are zero-indexed. For more information, refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/[Data 360 Reference Guide].
...
image::query-v3-get-chunk.png["Salesforce Data Cloud Connector Query v3 Get Chunk flow with Listener, Logger, Query v3 Get Chunk, and Response Logger"]
...
This Mule flow retrieves a query result schema without fetching rows. Use it to inspect the column names, types, and nullability before reading a large result set. For more information, refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/[Data 360 Reference Guide].
...
image::query-v3-get-metadata.png["Salesforce Data Cloud Connector Query v3 Get Metadata flow with Listener, Logger, Query v3 Get Metadata, and Response Logger"]
...
This Mule flow cancels a query and frees the server resources it holds. Cancel a query when its results are no longer needed, for example, if the requesting client has timed out. For more information, refer to the https://developer.salesforce.com/docs/data/data-cloud-query-guide/references/data-cloud-query-api-reference/[Data 360 Reference Guide].
...
image::query-v3-cancel.png["Salesforce Data Cloud Connector Query v3 Cancel flow with Listener, Logger, Query v3 Cancel, and Response Logger"]
...
This Mule flow shows how to create a webhook that logs its payload when triggered by a Data Action. Refer to the https://help.salesforce.com/s/articleView?id=data.c360_a_data_actions.htm&type=5[Salesforce Data Action docs].
...
image::data-action-webhook.png["Salesforce Data Cloud Connector Data Action Webhook flow with Data Cloud Connector Data Action Webhook and Logger Log Payload"]
...
. https://help.salesforce.com/s/articleView?id=data.c360_a_create_streaming_insight.htm&type=5[Create a Streaming Insight].
. https://help.salesforce.com/s/articleView?id=data.c360_a_data_actions.htm&type=5[Create a Data Action Target] with an Action Target Type of `Webhook`.
. https://help.salesforce.com/s/articleView?id=data.c360_a_data_actions.htm&type=5[Create a Data Action] that uses the Data Action Target and runs on a condition against your streaming Calculated Insight.
