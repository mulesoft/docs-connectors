...
The AMQP connector is available as a Studio plugin. View the https://anypoint.mulesoft.com/exchange/?type=connector&search=amqp[AMQP connector in Anypoint Exchange]. Connector installation information is available at xref:3.7@mule-runtime::anypoint-connectors.adoc[Anypoint Connectors].
