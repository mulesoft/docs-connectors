...
:page-aliases: 3.5@mule-runtime::amqp-connector-reference.adoc
...
*Required*: no +
*Default*: none
|`exchangeType` |The type of exchange to be declared. For more information on each type, see RabbitMQ's https://www.rabbitmq.com/tutorials/amqp-concepts.html[AMQP Concepts].
