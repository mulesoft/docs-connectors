...
| useSNI | Boolean | Whether Server Name Indication is needed to be used in the ClientHello Message. |  `false` | x
| useSasl | Boolean | Whether SASL (EXTERNAL) Auth mechanism is used (No username or password required). |  `false` | x
