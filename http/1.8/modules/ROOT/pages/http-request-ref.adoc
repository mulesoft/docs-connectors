...
[NOTE]
Currently, the Connectivity Testing feature is supported in XML view mode only. The feature will support Studio UI view mode, in the next Anypoint Studio release.
