...
Configure this system property when starting Mule by adding: +
 ...
 The default value of this property depends on the Mule runtime version. For Mule 4.4 and lower, the property defaults to `false`. For Mule 4.5 and later, the property defaults to `true`.
