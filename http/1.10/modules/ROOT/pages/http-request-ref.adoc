...
Configure this system property when starting Mule by adding: +
 ...
 The default value of this property depends on Mule Runtime version:
 - Until Mule Runtime 4.4, the property defaults to `false`.
 - Since Mule Runtime 4.5, the property defaults to `true`.
