...
|Enable Datasense |The *Enable DataSense* checkbox allows Studio to use xref:6.x@studio::datasense.adoc[DataSense] to expose metadata from the RAML file and interact with it on other elements in Studio.
|===
