...
:page-aliases: connectors::http/http-consume-web-service.adoc, connectors::http/http-basic-auth-task.adoc, connectors::http/http-create-https-listener.adoc,  connectors::http/http-trigger-app-from-browser.adoc
