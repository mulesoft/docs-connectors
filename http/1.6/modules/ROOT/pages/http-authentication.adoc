...
image::http-oauth-authentication.png[Configure Authorization code grant type authentication]
+
. Click *OK*.
. Save your Mule app.
...
image::authentication-in-http-requests-4.png[Github Authorize application page]
+
