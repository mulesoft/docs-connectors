...
If you are not familiar with how to use message attributes, please read https://docs.mulesoft.com/mule-runtime/4.4/intro-mule-message[about message attributes] first.
