...
|===
| UI Field | Description 
| Output MIME type |Defines the format of the request.
| Parameters |Adds additional parameters to the request.
...
|Output MIME type | Defines the format of the request.
| Parameters |Adds additional parameters to the request. 
| Output encoding | Select the encoding to transform the data to.
