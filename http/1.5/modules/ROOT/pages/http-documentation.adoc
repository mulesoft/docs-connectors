...
|===
| Field | Type | Description | Default Value | Required
| Url a| String | URL of the Origins, from which the browser is permitted to load resources. |  | x
| Access Control Max Age a| Number | The amount of time (in seconds) that the results of a preflight request can be cached. |  | x
| Allowed Methods a| Array of <<Method>> | Indicates which HTTP methods are permitted while accessing the resource(s) from the origin. |  |
| Allowed Headers a| Array of <<Header>> | In preflight requests, indicates the HTTP headers that can be used during the actual request. |  |
...
|===
| Field | Type | Description | Default Value | Required
| Method Name a| String | The HTTP method name. |  | x
|===
...
|===
| Field | Type | Description | Default Value | Required
| Header Name a| String | The HTTP header name. |  | x
|===
