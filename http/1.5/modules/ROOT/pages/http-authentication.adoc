...
* *Authorization URL*
+
https://docs.github.com/en/rest/oauth/#web-application-flow[Provided by GitHub], this URL redirects the user request from the Mule client app to the Authorization URL of the GitHub authentication server.
+
* *Token URL*
+
