...
When you need to access resources on behalf of several users, the correct method is to use SDK Connectors instead of using the HTTP Connector in conjunction with the OAuth module.
