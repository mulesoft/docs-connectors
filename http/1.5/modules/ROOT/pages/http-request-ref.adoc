...
To get a detailed overview of an HTTP response body when an exception is thrown during an HTTP request call, review the following xref:mule-runtime::mule-error-concept.adoc#http-response-error[example] in the Mule Errors documentation.
