...
And lastly, you can configure a set of parameters to test the connection without needing to configure and trigger a request operation. To see the details, refer to the xref:http-request-connectivity-test.adoc[HTTP Requester Config Connectivity Testing] documentation.
