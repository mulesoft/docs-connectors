...
In the previous example, if you press the `Test Connection...` button in the global configuration window, HTTP Connector sends a POST request to `http://localhost:80/testPath?Key1=Value1&Key2=Value2`.
