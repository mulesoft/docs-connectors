...
|User agent | Enter the request user-agent header.
|Referrer | Enter the request referrer header.
...
|User agent | Enter the browser user-agent override.
|Referrer | Enter the Referrer header for navigations.
|===
