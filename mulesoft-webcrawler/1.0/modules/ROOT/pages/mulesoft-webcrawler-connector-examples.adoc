...
| `GET /api/page` | *Get Page Content* | Single-page fetch. Returns the rendered content in the requested `outputFormat` (`HTML`, `TEXT`, or `MARKDOWN`).
| `GET /api/sitemap` | *Get SiteMap* | Crawls to the specified `depth`. `restrictToPath=true` keeps the crawl under the base URL's path.
|===
...
http://www.mulesoft.org/schema/mule/ee/core http://www.mulesoft.org/schema/mule/ee/core/current/mule-ee.xsd">
  ...
  <ms-webcrawler:config name="HTTP_Configuration" doc:name="WebCrawler HTTP">
    <ms-webcrawler:http-connection baseUrl="${webcrawler.baseUrl}" browserUserAgent="${webcrawler.userAgent}"/>
  ...
  <ms-webcrawler:config name="WebDriver_Configuration" doc:name="WebCrawler WebDriver">
    <ms-webcrawler:web-driver-connection baseUrl="${webcrawler.baseUrl}" browserUserAgent="${webcrawler.userAgent}" remoteBrowserUrl="${webcrawler.webDriverUrl}"/>
  </ms-webcrawler:config>
