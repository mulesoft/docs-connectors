...
* *Remote WebDriver*
+
Users can deploy the remote browser application from Anypoint Exchange to CloudHub, or leverage an existing remote browser infrastructure already available within their environment, given it is available and accessible from the Mule application.
