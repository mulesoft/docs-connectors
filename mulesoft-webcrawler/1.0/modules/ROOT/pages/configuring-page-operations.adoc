...
The *Get Page Elements* operation fetches analytical data about a web page including word count, element or tag counts (H1–H5, DIV, P), link structures (internal, external, reference), and image links. Use these insights to customize subsequent crawling operations.
